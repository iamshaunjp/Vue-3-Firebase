...
class J {
    ...
    start(t, e) {
        ...
        const r = () => {
            ...
            O("FirebaseCredentialsProvider", "Auth detected"), this.auth = t, this.auth.addAuthTokenListener(this.o), 
            r();
        };
        this.t.onInit((t => o(t))), 
        ...
        setTimeout((() => {
            if (!this.auth) {
                ...
                O("FirebaseCredentialsProvider", "Auth not yet detected"), i.resolve(), i = new W);
            }
        }), 0), r();
    }
    getToken() {
        ...
        this.i !== t ? (O("FirebaseCredentialsProvider", "getToken aborted due to token change."), 
 ...
 */ class Y {
    constructor(t, e, n) {
        this.h = t, this.l = e, this.m = n, this.type = "FirstParty", this.user = C.FIRST_PARTY;
    }
    get authHeaders() {
        const t = {
...
class rt {
     ...
     *     date.
     */    static fromDate(t) {
        return rt.fromMillis(t.getTime());
    }
    /**
    ...
    _compareTo(t) {
        return this.seconds === t.seconds ? nt(this.nanoseconds, t.nanoseconds) : nt(this.seconds, t.seconds);
    }
    /**
 ...
 */ class wt {
    ...
    isEqual(t) {
        return st(this.fields, t.fields, ((t, e) => t.isEqual(e)));
    }
}
 ...
 */
    ...
    compareTo(t) {
        return nt(this.binaryString, t.binaryString);
    }
    isEqual(t) {
...
/** Converts the possible Proto types for Blobs into a ByteString. */ function Et(t) {
    return "string" == typeof t ? gt.fromBase64String(t) : gt.fromUint8Array(t);
}
 ...
 */ class Vt {
    ...
    static fromPath(t) {
        return new Vt(lt.fromString(t));
    }
    static fromName(t) {
        return new Vt(lt.fromString(t).popFirst(5));
    }
...
/** Extracts the backend's type order for the provided value. */ function St(t) {
    return "nullValue" in t ? 0 /* NullValue */ : "booleanValue" in t ? 1 /* BooleanValue */ : "integerValue" in t || "doubleValue" in t ? 2 /* NumberValue */ : "timestampValue" in t ? 3 /* TimestampValue */ : "stringValue" in t ? 5 /* StringValue */ : "bytesValue" in t ? 6 /* BlobValue */ : "referenceValue" in t ? 7 /* RefValue */ : "geoPointValue" in t ? 8 /* GeoPointValue */ : "arrayValue" in t ? 9 /* ArrayValue */ : "mapValue" in t ? It(t) ? 4 /* ServerTimestampValue */ : 10 /* ObjectValue */ : B();
}
    ...
    switch (n) {
      ...
      case 3 /* TimestampValue */ :
        return function(t, e) {
            ...
            const n = pt(t.timestampValue), s = pt(e.timestampValue);
      ...
      case 2 /* NumberValue */ :
        return function(t, e) {
            ...
            if ("doubleValue" in t && "doubleValue" in e) {
                ...
                return n === s ? Pt(n) === Pt(s) : isNaN(n) && isNaN(s);
            }
            return !1;
        }(t, e);

      case 9 /* ArrayValue */ :
        return st(t.arrayValue.values || [], e.arrayValue.values || [], Dt);

      case 10 /* ObjectValue */ :
        return function(t, e) {
            const n = t.mapValue.fields || {}, s = e.mapValue.fields || {};
            if (ct(n) !== ct(s)) return !1;
            for (const t in n) if (n.hasOwnProperty(t) && (void 0 === s[t] || !Dt(n[t], s[t]))) return !1;
            return !0;
        }
...
function Nt(t, e) {
    const n = St(t), s = St(e);
    if (n !== s) return nt(n, s);
    switch (n) {
      case 0 /* NullValue */ :
        return 0;

      case 1 /* BooleanValue */ :
        return nt(t.booleanValue, e.booleanValue);
      ...
      case 5 /* StringValue */ :
        return nt(t.stringValue, e.stringValue);
      ...
      case 7 /* RefValue */ :
        return function(t, e) {
            ...
            return nt(n.length, s.length);
        }(t.referenceValue, e.referenceValue);

      case 8 /* GeoPointValue */ :
        return function(t, e) {
            const n = nt(Tt(t.latitude), Tt(e.latitude));
            if (0 !== n) return n;
            return nt(Tt(t.longitude), Tt(e.longitude));
      ...
      case 10 /* ObjectValue */ :
        return function(t, e) {
            ...
            for (let t = 0; t < s.length && t < r.length; ++t) {
                const e = nt(s[t], r[t]);
                if (0 !== e) return e;
                const o = Nt(n[s[t]], i[r[t]]);
                if (0 !== o) return o;
            }
            return nt(s.length, r.length);
        }
        /**
...
function xt(t, e) {
    if ("string" == typeof t && "string" == typeof e && t.length === e.length) return nt(t, e);
    const n = pt(t), s = pt(e), i = nt(n.seconds, s.seconds);
    return 0 !== i ? i : nt(n.nanos, s.nanos);
}
...
function $t(t) {
    ...
    Vt.fromName(n).toString()) : "geoPointValue" in t ? `geo(${(e = t.geoPointValue).latitude},${e.longitude})` : "arrayValue" in t ? function(t) {
        let e = "[", n = !0;
        for (const s of t.values || []) n ? n = !1 : e += ",", e += $t(s);
        return e + "]";
    }
    /** Returns a reference value for the provided database and key. */ (t.arrayValue) : "mapValue" in t ? function(t) {
        ...
        let n = "{", s = !0;
        for (const i of e) s ? s = !1 : n += ",", n += `${i}:${$t(t.fields[i])}`;
        return n + "}";
    }(t.mapValue) : B();
    var e, n;
}
...
/** Creates a deep copy of `source`. */ function qt(t) {
    ...
    if (t.mapValue) {
        ...
        return at(t.mapValue.fields, ((t, n) => e.mapValue.fields[t] = qt(n))), e;
    }
    if (t.arrayValue) {
        const e = {
            arrayValue: {
 ...
 */ class Kt {
     ...
     */    setAll(t) {
        ...
        t.forEach(((t, i) => {
            ...
            t ? n[i.lastSegment()] = qt(t) : s.push(i.lastSegment());
        }));
 ...
 */ class Qt {
     ...
     */    static newInvalidDocument(t) {
        return new Qt(t, 0 /* INVALID */ , ot.min(), Kt.empty(), 0 /* SYNCED */);
    }
    /**
    ...
    /** Creates a new document that is known to not exist at the given version. */    static newNoDocument(t, e) {
        return new Qt(t, 2 /* NO_DOCUMENT */ , e, Kt.empty(), 0 /* SYNCED */);
    }
    /**
     ...
     */    static newUnknownDocument(t, e) {
        return new Qt(t, 3 /* UNKNOWN_DOCUMENT */ , e, Kt.empty(), 2 /* HAS_COMMITTED_MUTATIONS */);
    }
    /**
 ...
 * property.
 */ function Gt(t, e = null, n = [], s = [], i = null, r = null, o = null) {
    return new Wt(t, e, n, s, i, r, o);
}
...
function zt(t) {
    ...
    if (null === e.A) {
        ...
        null !== e.collectionGroup && (t += "|cg:" + e.collectionGroup), t += "|f:", t += e.filters.map((t => Zt(t))).join(","), 
        t += "|ob:", t += e.orderBy.map((t => function(t) {
            // TODO(b/29183165): Make this collision robust.
            return t.field.canonicalString() + t.dir;
        }(t))).join(","), bt(e.limit) || (t += "|l:", t += e.limit), e.startAt && (t += "|lb:", 
        t += ue(e.startAt)), e.endAt && (t += "|ub:", t += ue(e.endAt)), e.A = t;
    }
    return e.A;
}
...
function Ht(t) {
    ...
    t.filters.length > 0 && (e += `, filters: [${t.filters.map((t => {
        return `${(e = t).field.canonicalString()} ${e.op} ${kt(e.value)}`;
        /** Returns a debug description for `filter`. */
        var e;
        /** Filter that matches on key fields (i.e. '__name__'). */    })).join(", ")}]`), 
    bt(t.limit) || (e += ", limit: " + t.limit), t.orderBy.length > 0 && (e += `, orderBy: [${t.orderBy.map((t => function(t) {
        return `${t.field.canonicalString()} (${t.dir})`;
    }(t))).join(", ")}]`), t.startAt && (e += ", startAt: " + ue(t.startAt)), t.endAt && (e += ", endAt: " + ue(t.endAt)), 
    `Target(${e})`;
}
...
function Jt(t, e) {
    ...
    n.op !== s.op || !n.field.isEqual(s.field) || !Dt(n.value, s.value)) return !1;
    var n, s;
    return t.collectionGroup === e.collectionGroup && (!!t.path.isEqual(e.path) && (!!de(t.startAt, e.startAt) && de(t.endAt, e.endAt)));
}

function Yt(t) {
    return Vt.isDocumentKey(t.path) && null === t.collectionGroup && 0 === t.filters.length;
}
...
class Xt extends class {} {
     ...
     */    static create(t, e, n) {
        return t.isKeyField() ? "in" /* IN */ === e || "not-in" /* NOT_IN */ === e ? this.R(t, e, n) : new te(t, e, n) : "array-contains" /* ARRAY_CONTAINS */ === e ? new ie(t, n) : "in" /* IN */ === e ? new re(t, n) : "not-in" /* NOT_IN */ === e ? new oe(t, n) : "array-contains-any" /* ARRAY_CONTAINS_ANY */ === e ? new ce(t, n) : new Xt(t, e, n);
    }
    static R(t, e, n) {
    ...
    matches(t) {
        ...
        // Types do not have to match in NOT_EQUAL filters.
                return "!=" /* NOT_EQUAL */ === this.op ? null !== e && this.P(Nt(e, this.value)) : null !== e && St(this.value) === St(e) && this.P(Nt(e, this.value));
...
function Zt(t) {
    ...
    return t.field.canonicalString() + t.op.toString() + kt(t.value);
}

class te extends Xt {
    constructor(t, e, n) {
        super(t, e, n), this.key = Vt.fromName(n.referenceValue);
    }
    matches(t) {
        const e = Vt.comparator(t.key, this.key);
        return this.P(e);
    }
}

/** Filter that matches on key fields within an array. */ class ee extends Xt {
    constructor(t, e) {
        super(t, "in" /* IN */ , e), this.keys = se("in" /* IN */ , e);
    }
    matches(t) {
...
/** Filter that matches on key fields not present within an array. */ class ne extends Xt {
    constructor(t, e) {
        super(t, "not-in" /* NOT_IN */ , e), this.keys = se("not-in" /* NOT_IN */ , e);
    }
    matches(t) {
        return !this.keys.some((e => e.isEqual(t.key)));
    }
...
function se(t, e) {
    var n;
    return ((null === (n = e.arrayValue) || void 0 === n ? void 0 : n.values) || []).map((t => Vt.fromName(t.referenceValue)));
}
...
/** A Filter that implements the IN operator. */ class re extends Xt {
    constructor(t, e) {
        super(t, "in" /* IN */ , e);
    }
    matches(t) {
...
/** A Filter that implements the not-in operator. */ class oe extends Xt {
    constructor(t, e) {
...
/** A Filter that implements the array-contains-any operator. */ class ce extends Xt {
    ...
    matches(t) {
        const e = t.data.field(this.field);
        return !(!Mt(e) || !e.arrayValue.values) && e.arrayValue.values.some((t => Ct(this.value.arrayValue, t)));
    }
}
...
function ue(t) {
    // TODO(b/29183165): Make this collision robust.
    return `${t.before ? "b" : "a"}:${t.position.map((t => kt(t))).join(",")}`;
}
 ...
 */ function fe(t, e, n) {
    ...
    for (let i = 0; i < t.position.length; i++) {
        ...
        if (r.field.isKeyField()) s = Vt.comparator(Vt.fromName(o.referenceValue), n.key); else {
            s = Nt(o, n.data.field(r.field));
        }
...
/** Creates a new Query instance with the options provided. */ function _e(t, e, n, s, i, r, o, c) {
    return new we(t, e, n, s, i, r, o, c);
}
 ...
 */ function Ie(t) {
    ...
    if (null === e.V) {
        ...
        t.isKeyField() || e.V.push(new he(t)), e.V.push(new he(dt.keyField(), "asc" /* ASCENDING */)); else {
            let t = !1;
 ...
 */ function Ae(t) {
    const e = K(t);
    if (!e.S) if ("F" /* First */ === e.limitType) e.S = Gt(e.path, e.collectionGroup, Ie(e), e.filters, e.limit, e.startAt, e.endAt); else {
        ...
        // We need to swap the cursors to match the now-flipped query ordering.
                const n = e.endAt ? new ae(e.endAt.position, !e.endAt.before) : null, s = e.startAt ? new ae(e.startAt.position, !e.startAt.before) : null;
        // Now return as a LimitType.First query.
        e.S = Gt(e.path, e.collectionGroup, t, e.filters, e.limit, n, s);
    }
    return e.S;
}
...
function be(t, e) {
    return Jt(Ae(t), Ae(e)) && t.limitType === e.limitType;
}
...
function Pe(t) {
    return `${zt(Ae(t))}|lt:${t.limitType}`;
}

function ve(t) {
    return `Query(target=${Ht(Ae(t))}; limitType=${t.limitType})`;
}

/** Returns whether `doc` matches the constraints of `query`. */ function Ve(t, e) {
    return e.isFoundDocument() && function(t, e) {
        const n = e.key.path;
        return null !== t.collectionGroup ? e.key.hasCollectionId(t.collectionGroup) && t.path.isPrefixOf(n) : Vt.isDocumentKey(t.path) ? t.path.isEqual(n) : t.path.isImmediateParentOf(n);
    }
    /**
 ...
 */ (t, e) && function(t, e) {
    ...
    /** Makes sure a document is within the bounds, if provided. */ (t, e) && function(t, e) {
        if (t.startAt && !fe(t.startAt, Ie(t), e)) return !1;
        if (t.endAt && fe(t.endAt, Ie(t), e)) return !1;
        return !0;
    }
    /**
...
function De(t, e, n) {
    const s = t.field.isKeyField() ? Vt.comparator(e.key, n.key) : function(t, e, n) {
        const s = e.data.field(t), i = n.data.field(t);
        return null !== s && null !== i ? Nt(s, i) : B();
    }(t.field, e, n);
    switch (t.dir) {
      case "asc" /* ASCENDING */ :
        return s;
 ...
 * limitations under the License.
 */
/** Used to represent a field transform on a mutation. */ class ke {
    constructor() {
 ...
 */ function $e(t, e, n) {
    ...
    }(n, e) : t instanceof Le ? Be(t, e) : t instanceof Ue ? qe(t, e) : function(t, e) {
        // PORTING NOTE: Since JavaScript's integer arithmetic is limited to 53 bit
        // precision and resolves overflows by reducing precision, we do not
        // manually cap overflows at 2^63.
        const n = Fe(t, e), s = je(n) + je(t.C);
        return Ft(n) && Ft(t.C) ? Ne(s) : Ce(t.N, s);
    }(t, e);
}
 ...
 */ function Oe(t, e, n) {
    ...
    // applications.
    return t instanceof Le ? Be(t, e) : t instanceof Ue ? qe(t, e) : n;
}
 ...
 */ function Fe(t, e) {
    return t instanceof Ke ? Ft(n = e) || function(t) {
...
/** Transforms an array value via a union operation. */ class Le extends ke {
    constructor(t) {
...
function Be(t, e) {
    const n = Qe(e);
    for (const e of t.elements) n.some((t => Dt(t, e))) || n.push(e);
    return {
        arrayValue: {
            values: n
        }
...
function qe(t, e) {
    let n = Qe(e);
    for (const e of t.elements) n = n.filter((t => !Dt(t, e)));
    return {
        arrayValue: {
            values: n
        }
 ...
 * limitations under the License.
 */
/** A field path and the TransformOperation to perform upon it. */ class We {
    constructor(t, e) {
...
function Ge(t, e) {
    return t.field.isEqual(e.field) && function(t, e) {
        return t instanceof Le && e instanceof Le || t instanceof Ue && e instanceof Ue ? st(t.elements, e.elements, Dt) : t instanceof Ke && e instanceof Ke ? Dt(t.C, e.C) : t instanceof Me && e instanceof Me;
...
/** Returns true if the preconditions is valid for the given document. */ function Je(t, e) {
 ...
 */ function Xe(t, e, n) {
    t instanceof sn ? function(t, e, n) {
        ...
        i.setAll(on(t)), i.setAll(s), e.convertToFoundDocument(n.version, i).setHasCommittedMutations();
 ...
 */ function Ze(t, e, n) {
    t instanceof sn ? function(t, e, n) {
        ...
        return;
        const s = t.value.clone(), i = an(t.fieldTransforms, n, e);
        s.setAll(i), e.convertToFoundDocument(nn(e), s).setHasLocalMutations();
    }
    /**
 ...
 *    ignored.
 */ (t, e, n) : t instanceof rn ? function(t, e, n) {
        if (!Je(t.precondition, e)) return;
        const s = an(t.fieldTransforms, n, e), i = e.data;
        i.setAll(on(t)), i.setAll(s), e.convertToFoundDocument(nn(e), i).setHasLocalMutations();
    }
    /**
 ...
 */ function tn(t, e) {
    ...
    for (const s of t.fieldTransforms) {
        ...
        null != i && (null == n && (n = Kt.empty()), n.set(s.field, i));
    }
    return n || null;
}
...
function en(t, e) {
    return t.type === e.type && (!!t.key.isEqual(e.key) && (!!t.precondition.isEqual(e.precondition) && (!!function(t, e) {
        return void 0 === t && void 0 === e || !(!t || !e) && st(t, e, ((t, e) => Ge(t, e)));
 ...
 */ function nn(t) {
    return t.isFoundDocument() ? t.version : ot.min();
}
 ...
 */ function an(t, e, n) {
    ...
    for (const i of t) {
        ...
        s.set(i.field, $e(t, r, e));
    }
    return s;
}

/** A mutation that deletes the document at the given key. */ class un extends Ye {
    constructor(t, e) {
 ...
 *     Code.UNKNOWN.
 */ (dn = fn || (fn = {}))[dn.OK = 0] = "OK", dn[dn.CANCELLED = 1] = "CANCELLED", 
dn[dn.UNKNOWN = 2] = "UNKNOWN", dn[dn.INVALID_ARGUMENT = 3] = "INVALID_ARGUMENT", 
dn[dn.DEADLINE_EXCEEDED = 4] = "DEADLINE_EXCEEDED", dn[dn.NOT_FOUND = 5] = "NOT_FOUND", 
dn[dn.ALREADY_EXISTS = 6] = "ALREADY_EXISTS", dn[dn.PERMISSION_DENIED = 7] = "PERMISSION_DENIED", 
dn[dn.UNAUTHENTICATED = 16] = "UNAUTHENTICATED", dn[dn.RESOURCE_EXHAUSTED = 8] = "RESOURCE_EXHAUSTED", 
dn[dn.FAILED_PRECONDITION = 9] = "FAILED_PRECONDITION", dn[dn.ABORTED = 10] = "ABORTED", 
dn[dn.OUT_OF_RANGE = 11] = "OUT_OF_RANGE", dn[dn.UNIMPLEMENTED = 12] = "UNIMPLEMENTED", 
dn[dn.INTERNAL = 13] = "INTERNAL", dn[dn.UNAVAILABLE = 14] = "UNAVAILABLE", dn[dn.DATA_LOSS = 15] = "DATA_LOSS";
...
class mn {
    ...
    insert(t, e) {
        return new mn(this.comparator, this.root.insert(t, e, this.comparator).copy(null, null, yn.BLACK, null, null));
    }
    // Returns a copy of the map, with the specified key removed.
    remove(t) {
        return new mn(this.comparator, this.root.remove(t, this.comparator).copy(null, null, yn.BLACK, null, null));
    }
    ...
    getIterator() {
        return new gn(this.root, null, this.comparator, !1);
    }
    getIteratorFrom(t) {
        return new gn(this.root, t, this.comparator, !1);
    }
    getReverseIterator() {
        return new gn(this.root, null, this.comparator, !0);
    }
    getReverseIteratorFrom(t) {
        return new gn(this.root, t, this.comparator, !0);
    }
}
...
class yn {
    constructor(t, e, n, s, i) {
        this.key = t, this.value = e, this.color = null != n ? n : yn.RED, this.left = null != s ? s : yn.EMPTY, 
        this.right = null != i ? i : yn.EMPTY, this.size = this.left.size + 1 + this.right.size;
    }
    // Returns a copy of the current node, optionally replacing pieces of it.
    copy(t, e, n, s, i) {
        return new yn(null != t ? t : this.key, null != e ? e : this.value, null != n ? n : this.color, null != s ? s : this.left, null != i ? i : this.right);
    }
    isEmpty() {
        return !1;
    }
    ...
    removeMin() {
        if (this.left.isEmpty()) return yn.EMPTY;
        let t = this;
    ...
    remove(t, e) {
        ...
        s = s.copy(null, null, null, s.left.remove(t, e), null); else {
            ...
            0 === e(t, s.key)) {
                if (s.right.isEmpty()) return yn.EMPTY;
...
class pn {
    ...
    copy(t) {
        const e = new pn(this.comparator);
        return e.data = t, e;
    }
}
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ const En = new mn(Vt.comparator);

function In() {
    return En;
}

const An = new mn(Vt.comparator);

function Rn() {
    return An;
}

const bn = new mn(Vt.comparator);

function Pn() {
    return bn;
}

const vn = new pn(Vt.comparator);
 ...
 */ class Cn {
    ...
    static createSynthesizedRemoteEventForCurrentChange(t, e) {
        const n = new Map;
        return n.set(t, Nn.createSynthesizedTargetChangeForCurrentChange(t, e)), new Cn(ot.min(), n, Dn(), In(), Vn());
    }
}
 ...
 */ class Nn {
     ...
     */    static createSynthesizedTargetChangeForCurrentChange(t, e) {
        return new Nn(gt.EMPTY_BYTE_STRING, e, Vn(), Vn(), Vn());
    }
}
...
/** Tracks the internal state of a Watch target. */ class On {
    constructor() {
        ...
        this.L = gt.EMPTY_BYTE_STRING, this.B = !1, 
        /**
...
class Fn {
     ...
     */    ft(t) {
        ...
        if (s) {
            ...
            if (Yt(t)) if (0 === n) {
                ...
                // queries.
                const n = new Vt(t.path);
                this.ct(e, n, Qt.newNoDocument(n, ot.min()));
            } else U(1 === n); else {
                this.wt(e) !== n && (
     ...
     */    _t(t) {
        ...
        this.et.forEach(((n, s) => {
            ...
            if (i) {
                if (n.current && Yt(i.target)) {
                    ...
                    const e = new Vt(i.target.path);
                    null !== this.nt.get(e) || this.gt(s, e) || this.ct(s, e, Qt.newNoDocument(e, t));
                }
                n.K && (e.set(s, n.W()), n.G());
            }
        }));
        ...
        const s = new Cn(t, e, this.it, this.nt, n);
        return this.nt = In(), this.st = Mn(), this.it = new pn(nt), s;
    }
    /**
    ...
    ut(t) {
        let e = this.et.get(t);
        return e || (e = new On, this.et.set(t, e)), e;
    }
    yt(t) {
        let e = this.st.get(t);
        return e || (e = new pn(nt), this.st = this.st.insert(t, e)), e;
    }
    /**
...
function Wn(t) {
    return U(!!t), ot.fromTimestamp(function(t) {
        const e = pt(t);
        return new rt(e.seconds, e.nanos);
    }(t));
}
...
function Xn(t) {
    ...
    // in the local target cache.
        return 4 === e.length ? lt.emptyPath() : ts(e);
}
...
/** Creates a Document proto from key and fields (but no create/update time) */ function es(t, e, n) {
    return {
        name: Hn(t, e),
...
function ns(t, e, n) {
    const s = Jn(t, e.name), i = Wn(e.updateTime), r = new Kt({
        mapValue: {
            fields: e.fields
        }
...
function ss(t, e) {
    return "found" in e ? function(t, e) {
        ...
        const n = Jn(t, e.found.name), s = Wn(e.found.updateTime), i = new Kt({
            mapValue: {
        ...
        const n = Jn(t, e.missing), s = Wn(e.readTime);
...
function is(t, e) {
    ...
    if ("targetChange" in e) {
        ...
        const s = function(t) {
            ...
            return t.D ? (U(void 0 === e || "string" == typeof e), gt.fromBase64String(e || "")) : (U(void 0 === e || e instanceof Uint8Array), 
            gt.fromUint8Array(e || new Uint8Array));
        }(t, e.targetChange.resumeToken), o = e.targetChange.cause, c = o && function(t) {
            const e = void 0 === t.code ? j.UNKNOWN : _n(t.code);
 ...
 */ (o);
        n = new $n(s, i, r, c || null);
    } else if ("documentChange" in e) {
        e.documentChange;
        const s = e.documentChange;
        s.document, s.document.name, s.document.updateTime;
        const i = Jn(t, s.document.name), r = Wn(s.document.updateTime), o = new Kt({
            mapValue: {
                fields: s.document.fields
            }
        }), c = Qt.newFoundDocument(i, r, o), a = s.targetIds || [], u = s.removedTargetIds || [];
        n = new xn(a, u, c.key, c);
    } else if ("documentDelete" in e) {
        e.documentDelete;
        const s = e.documentDelete;
        s.document;
        const i = Jn(t, s.document), r = s.readTime ? Wn(s.readTime) : ot.min(), o = Qt.newNoDocument(i, r), c = s.removedTargetIds || [];
        n = new xn([], c, o.key, o);
        ...
        if (!("filter" in e)) return B();
        {
            ...
            const t = e.filter;
            t.targetId;
            const s = t.count || 0, i = new ln(s), r = t.targetId;
            n = new kn(r, i);
        }
    }
    return n;
...
function rs(t, e) {
    ...
    if (e instanceof sn) n = {
        update: es(t, e.key, e.value)
    }; else if (e instanceof un) n = {
        delete: Hn(t, e.key)
    }; else if (e instanceof rn) n = {
        update: es(t, e.key, e.data),
        updateMask: Es(e.fieldMask)
    }; else {
        if (!(e instanceof hn)) return B();
        n = {
            verify: Hn(t, e.key)
        };
    }
...
function os(t, e) {
    const n = e.currentDocument ? function(t) {
        return void 0 !== t.updateTime ? He.updateTime(Wn(t.updateTime)) : void 0 !== t.exists ? He.exists(t.exists) : He.none();
    }(e.currentDocument) : He.none(), s = e.updateTransforms ? e.updateTransforms.map((e => function(t, e) {
        let n = null;
        if ("setToServerValue" in e) U("REQUEST_TIME" === e.setToServerValue), n = new Me; else if ("appendMissingElements" in e) {
            const t = e.appendMissingElements.values || [];
            n = new Le(t);
        } else if ("removeAllFromArray" in e) {
            const t = e.removeAllFromArray.values || [];
            n = new Ue(t);
        } else "increment" in e ? n = new Ke(t, e.increment) : B();
        const s = dt.fromServerFormat(e.fieldPath);
        return new We(s, n);
    }(t, e))) : [];
    if (e.update) {
        e.update.name;
        const i = Jn(t, e.update.name), r = new Kt({
            mapValue: {
        ...
        if (e.updateMask) {
            const t = function(t) {
                ...
                return new wt(e.map((t => dt.fromServerFormat(t))));
            }(e.updateMask);
            return new rn(i, r, t, n, s);
        }
        return new sn(i, r, n, s);
    }
    if (e.delete) {
...
function cs(t, e) {
    return t && t.length > 0 ? (U(void 0 !== e), t.map((t => function(t, e) {
        ...
        let n = t.updateTime ? Wn(t.updateTime) : Wn(e);
        return n.isEqual(ot.min()) && (
        // The Firestore Emulator currently returns an update time of 0 for
        // deletes of non-existing documents (rather than null). This breaks the
        // test "get deleted doc while offline with source=cache" as NoDocuments
        // with version 0 are filtered by IndexedDb's RemoteDocumentCache.
        // TODO(#2149): Remove this when Emulator is fixed
        n = Wn(e)), new ze(n, t.transformResults || []);
    }(t, e)))) : [];
}

function as(t, e) {
    return {
        documents: [ Yn(t, e.path) ]
    };
}
...
function us(t, e) {
    ...
    null !== e.collectionGroup ? (n.parent = Yn(t, s), n.structuredQuery.from = [ {
        collectionId: e.collectionGroup,
        allDescendants: !0
    } ]) : (n.parent = Yn(t, s.popLast()), n.structuredQuery.from = [ {
 ...
 */ (t, e.limit);
    return null !== o && (n.structuredQuery.limit = o), e.startAt && (n.structuredQuery.startAt = ds(e.startAt)), 
    e.endAt && (n.structuredQuery.endAt = ds(e.endAt)), n;
}
...
function hs(t) {
    ...
    let a = null;
    n.startAt && (a = ws(n.startAt));
    let u = null;
    return n.endAt && (u = ws(n.endAt)), _e(e, i, o, r, c, "F" /* First */ , a, u);
}
...
function fs(t) {
    return t ? void 0 !== t.unaryFilter ? [ Ts(t) ] : void 0 !== t.fieldFilter ? [ ps(t) ] : void 0 !== t.compositeFilter ? t.compositeFilter.filters.map((t => fs(t))).reduce(((t, e) => t.concat(e))) : B() : [];
}
...
function ps(t) {
    return Xt.create(ys(t.fieldFilter.field), function(t) {
        switch (t) {
          case "EQUAL":
            return "==" /* EQUAL */;
...
function Ts(t) {
    switch (t.unaryFilter.op) {
      case "IS_NAN":
        const e = ys(t.unaryFilter.field);
        return Xt.create(e, "==" /* EQUAL */ , {
            doubleValue: NaN
        });

      case "IS_NULL":
        const n = ys(t.unaryFilter.field);
        return Xt.create(n, "==" /* EQUAL */ , {
            nullValue: "NULL_VALUE"
        });

      case "IS_NOT_NAN":
        const s = ys(t.unaryFilter.field);
        return Xt.create(s, "!=" /* NOT_EQUAL */ , {
            doubleValue: NaN
        });

      case "IS_NOT_NULL":
        const i = ys(t.unaryFilter.field);
...
function As(t) {
    let e = "";
    for (let n = 0; n < t.length; n++) e.length > 0 && (e = bs(e)), e = Rs(t.get(n), e);
    return bs(e);
}

/** Encodes a single segment of a resource path into the given result */ function Rs(t, e) {
    let n = e;
    const s = t.length;
    for (let e = 0; e < s; e++) {
        const s = t.charAt(e);
 ...
 */ function Ps(t) {
    ...
    const e = t.length;
    if (U(e >= 2), 2 === e) return U("" === t.charAt(0) && "" === t.charAt(1)), lt.emptyPath();
...
/** Name of the IndexedDb object store.  */ Ss.store = "mutationQueues", 
...
/** Name of the IndexedDb object store.  */ Ds.store = "mutations", 
/** Keys are automatically assigned via the userId, batchId properties. */
Ds.keyPath = "batchId", 
/** The index name for lookup of mutations by user. */
Ds.userMutationsIndex = "userMutationsIndex", 
/** The user mutations index is keyed by [userId, batchId] pairs. */
Ds.userMutationsKeyPath = [ "userId", "batchId" ];
...
$s.store = "remoteDocumentGlobal", $s.key = "remoteDocumentGlobalKey";
...
/** Name of the IndexedDb object store.  */ Fs.store = "targetDocuments", 
/** Keys are automatically assigned via the targetId, path properties. */
Fs.keyPath = [ "targetId", "path" ], 
/** The index name for the reverse index. */
Fs.documentTargetsIndex = "documentTargetsIndex", 
/** We also need to create the reverse index for these properties. */
Fs.documentTargetsKeyPath = [ "path", "targetId" ];
 ...
 */ Ms.key = "targetGlobalKey", Ms.store = "targetGlobal";
...
/** Name of the IndexedDb object store. */ Ls.store = "collectionParents", 
/** Keys are automatically assigned via the collectionId, parent properties. */
Ls.keyPath = [ "collectionId", "parent" ];
...
/** Name of the IndexedDb object store. */ Us.store = "bundles", Us.keyPath = "bundleId";
...
/** Name of the IndexedDb object store. */ qs.store = "namedQueries", qs.keyPath = "name";

// Visible for testing
const Ks = [ ...[ ...[ ...[ ...[ Ss.store, Ds.store, Cs.store, ks.store, Os.store, Vs.store, Ms.store, Fs.store ], Bs.store ], $s.store ], Ls.store ], Us.store, qs.store ], js = "The current tab is not in the required state to perform this operation. It might be necessary to refresh the browser tab.";
 ...
 */ class Ws {
    ...
    next(t, e) {
        return this.callbackAttached && B(), this.callbackAttached = !0, this.isDone ? this.error ? this.wrapFailure(e, this.error) : this.wrapSuccess(t, this.result) : new Ws(((n, s) => {
            this.nextCallback = e => {
    ...
    wrapSuccess(t, e) {
        return t ? this.wrapUserFunction((() => t(e))) : Ws.resolve(e);
    }
    wrapFailure(t, e) {
        return t ? this.wrapUserFunction((() => t(e))) : Ws.reject(e);
    }
    static resolve(t) {
        return new Ws(((e, n) => {
            e(t);
...
class Gs {
    constructor(t, e) {
         ...
         */
        this.Et = new W, this.transaction.oncomplete = () => {
            this.Et.resolve();
        }, this.transaction.onabort = () => {
            e.error ? this.Et.reject(new Js(t, e.error)) : this.Et.resolve();
        }, this.transaction.onerror = e => {
            const n = ei(e.target.error);
            this.Et.reject(new Js(t, n));
        };
    }
    static open(t, e, n, s) {
        try {
            return new Gs(e, t.transaction(s, n));
        } catch (t) {
            throw new Js(e, t);
        }
    }
    ...
    abort(t) {
        t && this.Et.reject(t), this.aborted || (O("SimpleDb", "Aborting transaction:", t ? t.message : "Client-initiated abort"), 
 ...
 */ class zs {
    ...
    constructor(t, e, n) {
        ...
        // log on 12.2.
        12.2 === zs.Rt(u()) && F("Firestore persistence suffers from a bug in iOS 12.2 Safari that may cause your app to stop working. See https://stackoverflow.com/q/56496296/110915 for details and a potential workaround.");
    }
    /** Deletes the specified database. */    static delete(t) {
        return O("SimpleDb", "Removing database:", t), Zs(window.indexedDB.deleteDatabase(t)).toPromise();
    }
    /** Returns true if IndexedDB is available in the current environment. */    static bt() {
        ...
        // Check the UA string to find out the browser.
                const t = u(), e = zs.Rt(t), n = 0 < e && e < 10, s = zs.vt(t), i = 0 < s && s < 4.5;
        // IE 10
     ...
     */    async Dt(t) {
        return this.db || (O("SimpleDb", "Opening database:", this.name), this.db = await new Promise(((e, n) => {
            ...
            s.onsuccess = t => {
                ...
                n(new Js(t, "Cannot upgrade IndexedDB schema while another tab is open. Close all tabs that access Firestore and reload this page to proceed."));
            }, s.onerror = e => {
                const s = e.target.error;
                "VersionError" === s.name ? n(new Q(j.FAILED_PRECONDITION, "A newer version of the Firestore SDK was previously used and so the persisted data is not compatible with the version of the SDK you are now using. The SDK will operate with persistence disabled. If you need persistence, please re-upgrade to a newer version of the SDK or else clear the persisted IndexedDB data for your app to start fresh.")) : "InvalidStateError" === s.name ? n(new Q(j.FAILED_PRECONDITION, "Unable to open an IndexedDB connection. This could be due to running in a private browsing session on a browser whose private browsing sessions do not support IndexedDB: " + s)) : n(new Js(t, s));
            }, s.onupgradeneeded = t => {
    ...
    async runTransaction(t, e, n, s) {
        ...
        for (;;) {
            ...
            try {
                ...
                const e = Gs.open(this.db, t, i ? "readonly" : "readwrite", n), r = s(e).catch((t => (
                // Abort the transaction if there was an error.
                e.abort(t), Ws.reject(t)))).toPromise();
 ...
 */ class Hs {
     ...
     */    delete() {
        return Zs(this.kt.delete());
    }
}

/** An error that wraps exceptions that thrown during IndexedDB execution. */ class Js extends Q {
    constructor(t, e) {
    ...
    Bt(t, e) {
        ...
        return new Ws(((s, i) => {
            t.onerror = t => {
                ...
                if (!i) return void s();
                const r = new Hs(i), o = e(i.primaryKey, i.value, r);
                if (o instanceof Ws) {
 ...
 */ class ii {
     ...
     */    applyToLocalView(t) {
        ...
        for (const e of this.baseMutations) e.key.isEqual(t.key) && Ze(e, t, this.localWriteTime);
        // Second, apply all user-provided mutations.
                for (const e of this.mutations) e.key.isEqual(t.key) && Ze(e, t, this.localWriteTime);
    }
    /**
     ...
     */    applyToLocalDocumentSet(t) {
        ...
        this.mutations.forEach((e => {
            ...
            // and we should remove this cast.
                        this.applyToLocalView(s), n.isValidDocument() || s.convertToNoDocument(ot.min());
        }));
    }
    keys() {
        return this.mutations.reduce(((t, e) => t.add(e.key)), Vn());
    }
    isEqual(t) {
        return this.batchId === t.batchId && st(this.mutations, t.mutations, ((t, e) => en(t, e))) && st(this.baseMutations, t.baseMutations, ((t, e) => en(t, e)));
    }
}

/** The result of applying a mutation batch to the backend. */ class ri {
    constructor(t, e, n, 
    /**
...
/** Decodes a remote document from storage locally to a Document. */ function ai(t, e) {
    if (e.document) return ns(t.Wt, e.document, !!e.hasCommittedMutations);
    if (e.noDocument) {
        const t = Vt.fromSegments(e.noDocument.path), n = di(e.noDocument.readTime), s = Qt.newNoDocument(t, n);
        return e.hasCommittedMutations ? s.setHasCommittedMutations() : s;
    }
    if (e.unknownDocument) {
        const t = Vt.fromSegments(e.unknownDocument.path), n = di(e.unknownDocument.version);
        return Qt.newUnknownDocument(t, n);
    }
    return B();
}

/** Encodes a document for storage locally. */ function ui(t, e, n) {
    const s = hi(n), i = e.key.path.popLast().toArray();
    if (e.isFoundDocument()) {
        const n = function(t, e) {
            return {
                name: Hn(t, e.key),
                fields: e.data.value.mapValue.fields,
                updateTime: Kn(t, e.version.toTimestamp())
            };
    ...
    if (e.isNoDocument()) {
        const t = e.key.path.toArray(), n = fi(e.version), r = e.hasCommittedMutations;
        return new ks(
        /* unknownDocument= */ null, new Ns(t, n), 
        /* document= */ null, r, s, i);
    }
    if (e.isUnknownDocument()) {
        const t = e.key.path.toArray(), n = fi(e.version);
        return new ks(new xs(t, n), 
        /* noDocument= */ null, 
        /* document= */ null, 
...
function li(t) {
    const e = new rt(t[0], t[1]);
    return ot.fromTimestamp(e);
}
...
function di(t) {
    const e = new rt(t.seconds, t.nanoseconds);
    return ot.fromTimestamp(e);
}
...
function wi(t, e) {
    const n = (e.baseMutations || []).map((e => os(t.Wt, e)));
    ...
    const s = e.mutations.map((e => os(t.Wt, e))), i = rt.fromMillis(e.localWriteTimeMs);
    return new ii(e.batchId, i, n, s);
}

/** Decodes a DbTarget into TargetData */ function _i(t) {
    const e = di(t.readTime), n = void 0 !== t.lastLimboFreeSnapshotVersion ? di(t.lastLimboFreeSnapshotVersion) : ot.min();
    let s;
    var i;
    return void 0 !== t.query.documents ? (U(1 === (i = t.query).documents.length), 
    s = Ae(me(Xn(i.documents[0])))) : s = function(t) {
        return Ae(hs(t));
    }(t.query), new oi(s, t.targetId, 0 /* Listen */ , t.lastListenSequenceNumber, e, n, gt.fromBase64String(t.resumeToken));
}

/** Encodes TargetData into a DbTarget for storage locally. */ function mi(t, e) {
    const n = fi(e.snapshotVersion), s = fi(e.lastLimboFreeSnapshotVersion);
    let i;
    i = Yt(e.target) ? as(t.Wt, e.target) : us(t.Wt, e.target);
    // We can't store the resumeToken as a ByteString in IndexedDb, so we
    // convert it to a base64 string for storage.
        const r = e.resumeToken.toBase64();
    // lastListenSequenceNumber is always 0 until we do real GC.
        return new Os(e.targetId, zt(e.target), n, r, e.sequenceNumber, s, i);
}
 ...
 */ function pi(t) {
    return si(t, Us.store);
}

/**
 * Helper to get a typed SimpleDbStore for the namedQueries object store.
 */ function Ti(t) {
    return si(t, qs.store);
}
 ...
 */ class Ei {
    ...
    addToCollectionParentIndex(t, e) {
        return this.Gt.add(e), Ws.resolve();
    }
    getCollectionParents(t, e) {
        return Ws.resolve(this.Gt.getEntries(e));
    }
}
 ...
 */ class Ii {
    ...
    add(t) {
        const e = t.lastSegment(), n = t.popLast(), s = this.index[e] || new pn(lt.comparator), i = !s.has(n);
    ...
    getEntries(t) {
        return (this.index[t] || new pn(lt.comparator)).toArray();
    }
}
 ...
 */ class Ai {
    ...
    getCollectionParents(t, e) {
        const n = [], s = IDBKeyRange.bound([ e, "" ], [ it(e), "" ], 
        /*lowerOpen=*/ !1, 
        /*upperOpen=*/ !0);
        return Ri(t).Lt(s).next((t => {
            for (const s of t) {
...
class Pi {
    ...
    static withCacheSize(t) {
        return new Pi(t, Pi.DEFAULT_COLLECTION_PERCENTILE, Pi.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT);
    }
}
 ...
 */
function vi(t, e, n) {
    const s = t.store(Ds.store), i = t.store(Cs.store), r = [], o = IDBKeyRange.only(n.batchId);
    let c = 0;
    const a = s.Kt({
        range: o
    }, ((t, e, n) => (c++, n.delete())));
 ...
 * limitations under the License.
 */
/** A mutation queue for a specific user, backed by IndexedDB. */ Pi.DEFAULT_COLLECTION_PERCENTILE = 10, 
Pi.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT = 1e3, Pi.DEFAULT = new Pi(41943040, Pi.DEFAULT_COLLECTION_PERCENTILE, Pi.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT), 
...
class Si {
    ...
    addMutationBatch(t, e, n, s) {
        ...
        return r.add({}).next((o => {
            U("number" == typeof o);
            const c = new ii(o, e, n, s), a = function(t, e, n) {
                const s = n.baseMutations.map((e => rs(t.Wt, e))), i = n.mutations.map((e => rs(t.Wt, e)));
                return new Ds(e, n.batchId, n.localWriteTime.toMillis(), s, i);
            }(this.N, this.userId, c), u = [];
            let h = new pn(((t, e) => nt(t.canonicalString(), e.canonicalString())));
            for (const t of s) {
                const e = Cs.key(this.userId, t.key.path, o);
                h = h.add(t.key.path.popLast()), u.push(r.put(a)), u.push(i.put(e, Cs.PLACEHOLDER));
            }
            return h.forEach((e => {
    ...
    lookupMutationBatch(t, e) {
        return Ci(t).get(e).next((t => t ? (U(t.userId === this.userId), wi(this.N, t)) : null));
    }
    /**
    ...
    // PORTING NOTE: Multi-tab only.
    Xt(t, e) {
        return this.Jt[e] ? Ws.resolve(this.Jt[e]) : this.lookupMutationBatch(t, e).next((t => {
            if (t) {
                const n = t.keys();
    ...
    getNextMutationBatchAfterBatchId(t, e) {
        ...
        return Ci(t).Kt({
            ...
            e.userId === this.userId && (U(e.batchId >= n), i = wi(this.N, e)), s.done();
        })).next((() => i));
    }
    ...
    getAllMutationBatches(t) {
        ...
        return Ci(t).Lt(Ds.userMutationsIndex, e).next((t => t.map((t => wi(this.N, t)))));
    }
    getAllMutationBatchesAffectingDocumentKey(t, e) {
        ...
        return Ni(t).Kt({
            ...
            return Ci(t).get(a).next((t => {
                if (!t) throw B();
                U(t.userId === this.userId), i.push(wi(this.N, t));
            }));
            r.done();
        })).next((() => i));
    }
    getAllMutationBatchesAffectingDocumentKeys(t, e) {
        ...
        const s = [];
        return e.forEach((e => {
            const i = Cs.prefixForPath(this.userId, e.path), r = IDBKeyRange.lowerBound(i), o = Ni(t).Kt({
                range: r
            }, ((t, s, i) => {
                const [r, o, c] = t, a = Ps(o);
                // Only consider rows matching exactly the specific key of
                // interest. Note that because we order by path first, and we
                // order terminators before path separators, we'll encounter all
                // the index rows for documentKey contiguously. In particular, all
    ...
    Zt(t, e) {
        ...
        return e.forEach((e => {
            s.push(Ci(t).get(e).next((t => {
                if (null === t) throw B();
                U(t.userId === this.userId), n.push(wi(this.N, t));
            })));
        })), Ws.waitFor(s).next((() => n));
    }
    removeMutationBatch(t, e) {
        return vi(t.Qt, this.userId, e).next((n => (t.addOnCommittedListener((() => {
            this.te(e.batchId);
        })), Ws.forEach(n, (e => this.referenceDelegate.markPotentiallyOrphaned(t, e))))));
    }
    /**
    ...
    ee(t) {
        return xi(t).get(this.userId).next((t => t || new Ss(this.userId, -1, 
        /*lastStreamToken=*/ "")));
    }
}
 ...
 */
function Ci(t) {
    return si(t, Ds.store);
}

/**
 * Helper to get a typed SimpleDbStore for the mutationQueues object store.
 */ function Ni(t) {
    return si(t, Cs.store);
}

/**
 * Helper to get a typed SimpleDbStore for the mutationQueues object store.
 */ function xi(t) {
    return si(t, Ss.store);
}
 ...
 */ class $i {
    ...
    allocateTargetId(t) {
        return this.re(t).next((e => {
            const n = new ki(e.highestTargetId);
            return e.highestTargetId = n.next(), this.oe(t, e).next((() => e.highestTargetId));
        }));
    }
    getLastRemoteSnapshotVersion(t) {
        return this.re(t).next((t => ot.fromTimestamp(new rt(t.lastRemoteSnapshotVersion.seconds, t.lastRemoteSnapshotVersion.nanoseconds))));
    }
    ...
    removeTargetData(t, e) {
        return this.removeMatchingKeysForTargetId(t, e.targetId).next((() => Oi(t).delete(e.targetId))).next((() => this.re(t))).next((e => (U(e.targetCount > 0), 
    ...
    re(t) {
        return Fi(t).get(Ms.key).next((t => (U(null !== t), t)));
    }
    oe(t, e) {
        return Fi(t).put(Ms.key, e);
    }
    ce(t, e) {
        return Oi(t).put(mi(this.N, e));
    }
    /**
    ...
    getTargetData(t, e) {
        ...
        const n = zt(e), s = IDBKeyRange.bound([ n, Number.NEGATIVE_INFINITY ], [ n, Number.POSITIVE_INFINITY ]);
        let i = null;
        return Oi(t).Kt({
            range: s,
    ...
    addMatchingKeys(t, e, n) {
        ...
        return e.forEach((e => {
            const r = As(e.path);
            s.push(i.put(new Fs(n, r))), s.push(this.referenceDelegate.addReference(t, n, e));
        })), Ws.waitFor(s);
    }
    removeMatchingKeys(t, e, n) {
        ...
        return Ws.forEach(e, (e => {
            const i = As(e.path);
            return Ws.waitFor([ s.delete([ n, i ]), this.referenceDelegate.removeReference(t, n, e) ]);
        }));
    }
    ...
    getMatchingKeysForTargetId(t, e) {
        ...
        return s.Kt({
            ...
            const s = Ps(t[1]), r = new Vt(s);
            i = i.add(r);
        })).next((() => i));
    }
    containsKey(t, e) {
        const n = As(e.path), s = IDBKeyRange.bound([ n ], [ it(n) ], 
        /*lowerOpen=*/ !1, 
        /*upperOpen=*/ !0);
        let i = 0;
        return Mi(t).Kt({
            index: Fs.documentTargetsIndex,
            qt: !0,
            range: s
        }, (([t, e], n, s) => {
    ...
    // PORTING NOTE: Multi-tab only.
    Tt(t, e) {
        return Oi(t).get(e).next((t => t ? _i(t) : null));
    }
}
 ...
 */ function Oi(t) {
    return si(t, Os.store);
}

/**
 * Helper to get a typed SimpleDbStore for the target globals object store.
 */ function Fi(t) {
    return si(t, Ms.store);
}

/**
 * Helper to get a typed SimpleDbStore for the document target object store.
 */ function Mi(t) {
    return si(t, Fs.store);
}
 ...
 */ async function Li(t) {
    if (t.code !== j.FAILED_PRECONDITION || t.message !== js) throw t;
 ...
 */ class Ui {
    constructor(t) {
        this.ue = t, this.buffer = new pn(Bi), this.he = 0;
    }
    le() {
        return ++this.he;
    }
 ...
 */ class qi {
    ...
    _e(t) {
        ...
        O("LruGarbageCollector", `Garbage collection scheduled in ${e}ms`), this.we = this.asyncQueue.enqueueAfterDelay("lru_garbage_collection" /* LruGarbageCollection */ , e, (async () => {
            this.we = null, this.de = !0;
            try {
                await t.collectGarbage(this.garbageCollector);
            } catch (t) {
                Ys(t) ? O("LruGarbageCollector", "Ignoring IndexedDB error during garbage collection: ", t) : await Li(t);
            }
            await this._e(t);
        }));
    }
...
/** Implements the steps for LRU garbage collection. */ class Ki {
    ...
    collect(t, e) {
        ...
        Ws.resolve(bi)) : this.getCacheSize(t).next((n => n < this.params.cacheSizeCollectionThreshold ? (O("LruGarbageCollector", `Garbage collection skipped; Cache size ${n} is lower than threshold ${this.params.cacheSizeCollectionThreshold}`), 
        bi) : this.pe(t, e)));
    }
    getCacheSize(t) {
...
class ji {
     ...
     */    Ie(t, e) {
        return function(t, e) {
            let n = !1;
            return xi(t).jt((s => Di(t, s, e).next((t => (t && (n = !0), Ws.resolve(!t)))))).next((() => n));
        }(t, e);
    }
    removeOrphanedDocuments(t, e) {
        ...
        return this.Ee(t, ((r, o) => {
            if (o <= e) {
                const e = this.Ie(t, r).next((e => {
                    ...
                    // removing them.
                    return i++, n.getEntry(t, r).next((() => (n.removeEntry(r), Mi(t).delete([ 0, As(r.path) ]))));
                }));
                s.push(e);
            }
        })).next((() => Ws.waitFor(s))).next((() => n.apply(t))).next((() => i));
    }
    removeTarget(t, e) {
 ...
 */ class Gi {
    constructor() {
        ...
        this.changes = new Wi((t => t.toString()), ((t, e) => t.isEqual(e))), this.changesApplied = !1;
    }
    getReadTime(t) {
        const e = this.changes.get(t);
        return e ? e.readTime : ot.min();
    }
    /**
     ...
     */    getEntry(t, e) {
        ...
        return void 0 !== n ? Ws.resolve(n.document) : this.getFromCache(t, e);
    }
    /**
 ...
 */ class zi {
    ...
    getEntry(t, e) {
        return Yi(t).get(Xi(e)).next((t => this.Re(e, t)));
    }
    /**
     ...
     */    ve(t, e) {
        let n = In(), s = new mn(Vt.comparator);
        return this.Pe(t, e, ((t, e) => {
            const i = this.Re(t, e);
            n = n.insert(t, i), s = s.insert(t, Vi(e));
        })).next((() => ({
            documents: n,
            Ve: s
        })));
    ...
    Pe(t, e, n) {
        if (e.isEmpty()) return Ws.resolve();
        const s = IDBKeyRange.bound(e.first().path.toArray(), e.last().path.toArray()), i = e.getIterator();
        let r = i.getNext();
        return Yi(t).Kt({
            range: s
        }, ((t, e, s) => {
            const o = Vt.fromSegments(t);
            // Go through keys not found in cache.
                        for (;r && Vt.comparator(r, o) < 0; ) n(r, null), r = i.getNext();
            r && r.isEqual(o) && (
            // Key found in cache.
    ...
    getDocumentsMatchingQuery(t, e, n) {
        ...
        return Yi(t).Kt(r, ((t, n, r) => {
            ...
            const o = ai(this.N, n);
            e.path.isPrefixOf(o.key.path) ? Ve(e, o) && (s = s.insert(o.key, o)) : r.done();
        })).next((() => s));
    }
    newChangeBuffer(t) {
        return new Hi(this, !!t && t.trackRemovals);
    }
    getSize(t) {
        return this.getMetadata(t).next((t => t.byteSize));
    }
    getMetadata(t) {
        return Ji(t).get($s.key).next((t => (U(!!t), t)));
    }
    Ae(t, e) {
        return Ji(t).put($s.key, e);
    }
    /**
     ...
     */    Re(t, e) {
        if (e) {
            ...
            // `getNewDocumentChanges()`
                        if (!(t.isNoDocument() && t.version.isEqual(ot.min()))) return t;
        }
...
class Hi extends Gi {
    ...
    constructor(t, e) {
        ...
        this.De = new Wi((t => t.toString()), ((t, e) => t.isEqual(e)));
    }
    applyChanges(t) {
        const e = [];
        let n = 0, s = new pn(((t, e) => nt(t.canonicalString(), e.canonicalString())));
        return this.changes.forEach(((i, r) => {
            const o = this.De.get(i);
            if (r.document.isValidDocument()) {
                const c = ui(this.Se.N, r.document, this.getReadTime(i));
 ...
 * limitations under the License.
 */
/** Performs database creation and schema upgrades. */ class Zi {
    constructor(t) {
        this.N = t;
    }
    /**
     ...
     */    Ct(t, e, n, s) {
        U(n < s && n >= 0 && s <= 11);
        const i = new Gs("createOrUpgrade", e);
        n < 1 && s >= 1 && (function(t) {
            ...
            t.createObjectStore(Ds.store, {
                keyPath: Ds.keyPath,
                autoIncrement: !0
            }).createIndex(Ds.userMutationsIndex, Ds.userMutationsKeyPath, {
                unique: !0
 ...
 */ (t), tr(t), function(t) {
        ...
        0 !== n && (!function(t) {
            t.deleteObjectStore(Fs.store), t.deleteObjectStore(Os.store), t.deleteObjectStore(Ms.store);
        }(t), tr(t)), r = r.next((() => 
        /**
 ...
 */
        function(t) {
            const e = t.store(Ms.store), n = new Ms(
            /*highestTargetId=*/ 0, 
            /*lastListenSequenceNumber=*/ 0, ot.min().toTimestamp(), 
            /*targetCount=*/ 0);
            return e.put(Ms.key, n);
        }
        /**
 ...
 */ (i)))), n < 4 && s >= 4 && (0 !== n && (
        ...
        r = r.next((() => function(t, e) {
            return e.store(Ds.store).Lt().next((n => {
                t.deleteObjectStore(Ds.store);
                t.createObjectStore(Ds.store, {
                    keyPath: Ds.keyPath,
                    autoIncrement: !0
                }).createIndex(Ds.userMutationsIndex, Ds.userMutationsKeyPath, {
                ...
                const s = e.store(Ds.store), i = n.map((t => s.put(t)));
                return Ws.waitFor(i);
            }));
        }(t, i)))), r = r.next((() => {
            !function(t) {
 ...
 */ (t);
    ...
    Ne(t) {
        let e = 0;
        return t.store(ks.store).Kt(((t, n) => {
            e += Vi(n);
        })).next((() => {
            const n = new $s(e);
            return t.store($s.store).put($s.key, n);
        }));
    }
    Ce(t) {
        const e = t.store(Ss.store), n = t.store(Ds.store);
        return e.Lt().next((e => Ws.forEach(e, (e => {
            const s = IDBKeyRange.bound([ e.userId, -1 ], [ e.userId, e.lastAcknowledgedBatchId ]);
            return n.Lt(Ds.userMutationsIndex, s).next((n => Ws.forEach(n, (n => {
                U(n.userId === e.userId);
                const s = wi(this.N, n);
     ...
     */    xe(t) {
        const e = t.store(Fs.store), n = t.store(ks.store);
        return t.store(Ms.store).get(Ms.key).next((t => {
            const s = [];
            return n.Kt(((n, i) => {
                const r = new lt(n), o = function(t) {
                    return [ 0, As(t) ];
                }(r);
                s.push(e.get(o).next((n => n ? Ws.resolve() : (n => e.put(new Fs(0, As(n), t.highestListenSequenceNumber)))(r))));
            })).next((() => Ws.waitFor(s)));
        }));
    }
    ke(t, e) {
        ...
        const n = e.store(Ls.store), s = new Ii, i = t => {
            if (s.add(t)) {
        ...
        return e.store(ks.store).Kt({
            qt: !0
        }, ((t, e) => {
            const n = new lt(t);
            return i(n.popLast());
        })).next((() => e.store(Cs.store).Kt({
            qt: !0
        }, (([t, e, n], s) => {
            const r = Ps(e);
            return i(r.popLast());
...
function tr(t) {
    t.createObjectStore(Fs.store, {
        keyPath: Fs.keyPath
    }).createIndex(Fs.documentTargetsIndex, Fs.documentTargetsKeyPath, {
        unique: !0
    });
...
class nr {
    ...
    u) {
        ...
        this.Qe = t => Promise.resolve(), !nr.bt()) throw new Q(j.UNIMPLEMENTED, "This platform is either missing IndexedDB or is known to have an incomplete implementation. Offline persistence has been disabled.");
        this.referenceDelegate = new ji(this, s), this.We = e + "main", this.N = new ci(c), 
        this.Ge = new zs(this.We, 11, new Zi(this.N)), this.ze = new $i(this.referenceDelegate, this.N), 
        this.Ht = new Ai, this.He = function(t, e) {
            return new zi(t, e);
        }
        /**
 ...
 */
        ...
        (this.N, this.Ht), this.Je = new yi, this.window && this.window.localStorage ? this.Ye = this.window.localStorage : (this.Ye = null, 
     ...
     */    start() {
        ...
        return this.Xe().then((() => {
            ...
            throw new Q(j.FAILED_PRECONDITION, er);
     ...
     * primary lease.
     */    Xe() {
        return this.runTransaction("updateClientMetadataAndTryBecomePrimary", "readwrite", (t => ir(t).put(new Bs(this.clientId, Date.now(), this.networkEnabled, this.inForeground)).next((() => {
    ...
    sn(t) {
        return sr(t).get(Vs.key).next((t => Ws.resolve(this.an(t))));
    }
    un(t) {
        return ir(t).delete(this.clientId);
    }
    /**
     ...
     */    rn(t) {
        if (this.Me) return Ws.resolve(!0);
        return sr(t).get(Vs.key).next((e => {
            ...
            return !(!this.networkEnabled || !this.inForeground) || ir(t).Lt().next((t => void 0 === this.fn(t, 5e3).find((t => {
    ...
    async shutdown() {
        ...
        await this.Ge.runTransaction("shutdown", "readwrite", [ Vs.store, Bs.store ], (t => {
            const e = new ni(t, Z.T);
     ...
     * PORTING NOTE: This is only used for Web multi-tab.
     */    pn() {
        return this.runTransaction("getActiveClients", "readonly", (t => ir(t).Lt().next((t => this.fn(t, 18e5).map((t => t.clientId))))));
    }
    get started() {
        return this.Be;
    }
    ...
    runTransaction(t, e, n) {
        ...
        // are the only reader/writer.
                return this.Ge.runTransaction(t, s, Ks, (s => (i = new ni(s, this.Le ? this.Le.next() : Z.T), 
        "readwrite-primary" === e ? this.sn(i).next((t => !!t || this.rn(i))).next((e => {
            ...
            this.Oe.enqueueRetryable((() => this.Qe(!1))), new Q(j.FAILED_PRECONDITION, js);
            return n(i);
    ...
    // be turned off.
    Tn(t) {
        return sr(t).get(Vs.key).next((t => {
            if (null !== t && this.ln(t.leaseTimestampMs, 5e3) && !this.wn(t.ownerId) && !this.an(t) && !(this.Me || this.allowTabSynchronization && t.allowTabSynchronization)) throw new Q(j.FAILED_PRECONDITION, er);
        }));
    }
    /**
     ...
     */    cn(t) {
        const e = new Vs(this.clientId, this.allowTabSynchronization, Date.now());
        return sr(t).put(Vs.key, e);
    }
    static bt() {
        return zs.bt();
    }
    /** Checks the primary lease and removes it if we are the current primary. */    on(t) {
        const e = sr(t);
        return e.get(Vs.key).next((t => this.an(t) ? (O("IndexedDbPersistence", "Releasing primary lease."), 
        e.delete(Vs.key)) : Ws.resolve()));
    }
     ...
     */    tn() {
        ...
        "function" == typeof (null === (t = this.window) || void 0 === t ? void 0 : t.addEventListener) && (this.Ue = () => {
            ...
            this._n(), l() && navigator.appVersion.match("Version/14") && 
 ...
 */ function sr(t) {
    return si(t, Vs.store);
}

/**
 * Helper to get a typed SimpleDbStore for the client metadata object store.
 */ function ir(t) {
    return si(t, Bs.store);
}
 ...
 */
        return function(t) {
            return Vt.isDocumentKey(t.path) && null === t.collectionGroup && 0 === t.filters.length;
        }(e) ? this.Vn(t, e.path) : Ee(e) ? this.Sn(t, e, n) : this.Dn(t, e, n);
    }
    Vn(t, e) {
        // Just do a simple document lookup.
        return this.An(t, new Vt(e)).next((t => {
            let e = Rn();
    ...
    Sn(t, e, n) {
        ...
        let i = Rn();
        return this.Ht.getCollectionParents(t, s).next((r => Ws.forEach(r, (r => {
            const o = function(t, e) {
                return new we(e, 
 ...
 */ (e, r.child(s));
    ...
    Dn(t, e, n) {
        ...
        this.Cn(t, i, s).next((t => {
            ...
            for (const t of i) for (const e of t.mutations) {
                ...
                i = Qt.newInvalidDocument(n), s = s.insert(n, i)), Ze(e, i, t.localWriteTime), i.isFoundDocument() || (s = s.remove(n));
            }
        }))))).next((() => (
    ...
    Cn(t, e, n) {
        let s = Vn();
        for (const t of e) for (const e of t.mutations) e instanceof rn && null === n.get(e.key) && (s = s.add(e.key));
        let i = n;
 ...
 */ class ar {
 ...
 // do nothing
        ...
        return new ar(t, e.fromCache, n, s);
    }
}
 ...
 */ class ur {
    ...
    /** Returns all local documents matching the specified query. */    getDocumentsMatchingQuery(t, e, n, s) {
        ...
        }(e) || n.isEqual(ot.min()) ? this.Fn(t, e) : this.On.Pn(t, s).next((i => {
            const r = this.Mn(e, i);
            return (ge(e) || ye(e)) && this.Ln(e.limitType, r, s, n) ? this.Fn(t, e) : (k() <= c.DEBUG && O("QueryEngine", "Re-using previous result from %s to execute query: %s", n.toString(), ve(e)), 
    ...
    Fn(t, e) {
        return k() <= c.DEBUG && O("QueryEngine", "Using full collection scan to execute query:", ve(e)), 
        this.On.getDocumentsMatchingQuery(t, e, ot.min());
    }
}
...
class hr {
    ...
    t, e, n, s) {
        ...
        this.qn = new Wi((t => zt(t)), Jt), 
        /**
         * The read time of the last entry processed by `getNewDocumentChanges()`.
         *
         * PORTING NOTE: This is only used for multi-tab synchronization.
         */
        this.Kn = ot.min(), this.In = t.getMutationQueue(n), this.jn = t.getRemoteDocumentCache(), 
        this.ze = t.getTargetCache(), this.Qn = new cr(this.jn, this.In, this.persistence.getIndexManager()), 
...
async function fr(t, e) {
    ...
    const r = await n.persistence.runTransaction("Handle user change", "readonly", (t => {
        ...
        // MutationQueue.
        i = new cr(n.jn, s, n.persistence.getIndexManager()), s.getAllMutationBatches(t)))).next((e => {
            const n = [], s = [];
 ...
 */ (c, u, e) && o.push(n.ze.updateTargetData(t, u));
        ...
        o.push(mr(t, r, e.documentUpdates, s, void 0).next((t => {
            c = t;
        }))), !s.isEqual(ot.min())) {
            const e = n.ze.getLastRemoteSnapshotVersion(t).next((e => n.ze.setTargetsMetadata(t, t.currentSequenceNumber, s)));
            o.push(e);
        }
        return Ws.waitFor(o).next((() => r.apply(t))).next((() => n.Qn.vn(t, c))).next((() => c));
    })).then((t => (n.Un = i, t)));
}
...
i) {
    ...
    return n.forEach((t => r = r.add(t))), e.getEntries(t, r).next((t => {
        ...
        return n.forEach(((n, o) => {
            ...
            // cache.
            o.isNoDocument() && o.version.isEqual(ot.min()) ? (
...
function yr(t, e) {
    ...
    return n.persistence.runTransaction("Allocate target", "readwrite", (t => {
        ...
        s = i, Ws.resolve(s)) : n.ze.allocateTargetId(t).next((i => (s = new oi(e, i, 0 /* Listen */ , t.currentSequenceNumber), 
...
async function pr(t, e, n) {
    const s = K(t), i = s.Un.get(e), r = n ? "readwrite" : "readwrite-primary";
    try {
 ...
 */ function Tr(t, e, n) {
    ...
    return s.persistence.runTransaction("Execute query", "readonly", (t => function(t, e, n) {
        const s = K(t), i = s.qn.get(n);
        return void 0 !== i ? Ws.resolve(s.Un.get(i)) : s.ze.getTargetData(e, n);
    }(s, t, Ae(e)).next((e => {
        if (e) return i = e.lastLimboFreeSnapshotVersion, s.ze.getMatchingKeysForTargetId(t, e.targetId).next((t => {
            r = t;
        }));
    })).next((() => s.Bn.getDocumentsMatchingQuery(t, e, n ? i : ot.min(), n ? r : Vn()))).next((t => ({
        documents: t,
        Gn: r
    })))));
}
...
// PORTING NOTE: Multi-Tab only.
function Er(t, e) {
    const n = K(t), s = K(n.ze), i = n.Un.get(e);
...
function Ir(t) {
    ...
    return e.persistence.runTransaction("Get new document changes", "readonly", (t => function(t, e, n) {
        const s = K(t);
        let i = In(), r = hi(n);
        const o = Yi(e), c = IDBKeyRange.lowerBound(r, !0);
        return o.Kt({
...
async function Ar(t) {
    ...
    return e.persistence.runTransaction("Synchronize last document change read time", "readonly", (t => function(t) {
        ...
        return e.Kt({
            ...
            e.readTime && (n = li(e.readTime)), s.done();
        })).next((() => n));
    }(t))).then((t => {
        e.Kn = t;
    }));
...
async function Rr(t, e, n, s) {
    ...
    const a = i.jn.newChangeBuffer({
        trackRemovals: !0
    }), u = await yr(i, function(t) {
        // It is OK that the path used for the query is not valid, because this will
        // not be read and queried.
        return Ae(me(lt.fromString(`__bundle__/docs/${t}`)));
    }(s));
    // Allocates a target to hold all document keys from the bundle, such that
    // they will not get garbage collected right away.
        return i.persistence.runTransaction("Apply bundle documents", "readwrite", (t => mr(t, a, o, ot.min(), c).next((e => (a.apply(t), 
 ...
 */ class Pr {
    ...
    getBundleMetadata(t, e) {
        return Ws.resolve(this.Yn.get(e));
    }
    saveBundleMetadata(t, e) {
    ...
    getNamedQuery(t, e) {
        return Ws.resolve(this.Xn.get(e));
    }
    saveNamedQuery(t, e) {
 ...
 */ class vr {
    constructor() {
        ...
        this.Zn = new pn(Vr.ts), 
        // A set of outstanding references to a document sorted by target id.
        this.es = new pn(Vr.ns);
    }
     ...
     * removed.
     */    cs(t) {
        const e = new Vt(new lt([])), n = new Vr(e, t), s = new Vr(e, t + 1), i = [];
    ...
    hs(t) {
        const e = new Vt(new lt([])), n = new Vr(e, t), s = new Vr(e, t + 1);
        let i = Vn();
        return this.es.forEachInRange([ n, s ], (t => {
            i = i.add(t.key);
        })), i;
    ...
    containsKey(t) {
        const e = new Vr(t, 0), n = this.Zn.firstAfterOrEqual(e);
...
class Vr {
    ...
    /** Compare by key then by ID */    static ts(t, e) {
        return Vt.comparator(t.key, e.key) || nt(t.ls, e.ls);
    }
    /** Compare by ID then by key */    static ns(t, e) {
        return nt(t.ls, e.ls) || Vt.comparator(t.key, e.key);
    }
}
 ...
 */ class Sr {
    constructor(t, e) {
        ...
        this.ds = new pn(Vr.ts);
    }
    checkEmpty(t) {
        return Ws.resolve(0 === this.In.length);
    }
    addMutationBatch(t, e, n, s) {
        const i = this.fs;
        ...
        for (const e of s) this.ds = this.ds.add(new Vr(e.key, i)), this.Ht.addToCollectionParentIndex(t, e.key.path.popLast());
        return Ws.resolve(r);
    }
    lookupMutationBatch(t, e) {
        return Ws.resolve(this.ws(e));
    }
    getNextMutationBatchAfterBatchId(t, e) {
        const n = e + 1, s = this._s(n), i = s < 0 ? 0 : s;
        // The requested batchId may still be out of range so normalize it to the
        // start of the queue.
                return Ws.resolve(this.In.length > i ? this.In[i] : null);
    }
    getHighestUnacknowledgedBatchId() {
        return Ws.resolve(0 === this.In.length ? -1 : this.fs - 1);
    }
    getAllMutationBatches(t) {
        return Ws.resolve(this.In.slice());
    }
    getAllMutationBatchesAffectingDocumentKey(t, e) {
    ...
    getAllMutationBatchesAffectingQuery(t, e) {
        ...
        let i = n;
        Vt.isDocumentKey(i) || (i = i.child(""));
        const r = new Vr(new Vt(i), 0);
    ...
    removeMutationBatch(t, e) {
        U(0 === this.ys(e.batchId, "removed")), this.In.shift();
        let n = this.ds;
    ...
    containsKey(t, e) {
        const n = new Vr(e, 0), s = this.ds.firstAfterOrEqual(n);
        return Ws.resolve(e.isEqual(s && s.key));
    }
    performConsistencyCheck(t) {
        return this.In.length, Ws.resolve();
    }
    /**
...
class Dr {
    ...
    constructor(t, e) {
        ...
        this.docs = new mn(Vt.comparator), 
    ...
    getEntry(t, e) {
        ...
        return Ws.resolve(n ? n.document.clone() : Qt.newInvalidDocument(e));
    }
    getEntries(t, e) {
        let n = In();
        return e.forEach((t => {
    ...
    getDocumentsMatchingQuery(t, e, n) {
        ...
        // the documents we need to match the query against.
                const i = new Vt(e.path.child("")), r = this.docs.getIteratorFrom(i);
        for (;r.hasNext(); ) {
            const {key: t, value: {document: i, readTime: o}} = r.getNext();
            if (!e.path.isPrefixOf(t.path)) break;
            o.compareTo(n) <= 0 || Ve(e, i) && (s = s.insert(i.key, i.clone()));
        }
        return Ws.resolve(s);
    }
    Ts(t, e) {
 ...
 */ class Nr {
    constructor(t) {
         ...
         * IDs.
         */
        this.As = new vr, this.targetCount = 0, this.Rs = ki.se();
    }
    forEachTarget(t, e) {
        return this.Es.forEach(((t, n) => e(n))), Ws.resolve();
    }
    getLastRemoteSnapshotVersion(t) {
        return Ws.resolve(this.lastRemoteSnapshotVersion);
    }
    getHighestSequenceNumber(t) {
        return Ws.resolve(this.Is);
    }
    allocateTargetId(t) {
        return this.highestTargetId = this.Rs.next(), Ws.resolve(this.highestTargetId);
    }
    setTargetsMetadata(t, e, n) {
    ...
    addTargetData(t, e) {
        return this.ce(e), this.targetCount += 1, Ws.resolve();
    }
    updateTargetData(t, e) {
        return this.ce(e), Ws.resolve();
    }
    removeTargetData(t, e) {
    ...
    addMatchingKeys(t, e, n) {
        return this.As.ss(e, n), Ws.resolve();
    }
    removeMatchingKeys(t, e, n) {
        this.As.os(e, n);
    ...
    removeMatchingKeysForTargetId(t, e) {
        return this.As.cs(e), Ws.resolve();
    }
    getMatchingKeysForTargetId(t, e) {
    ...
    containsKey(t, e) {
        return Ws.resolve(this.As.containsKey(e));
    }
}
...
class xr {
     ...
     */
    constructor(t, e) {
        this.bs = {}, this.Le = new Z(0), this.Be = !1, this.Be = !0, this.referenceDelegate = t(this), 
        this.ze = new Nr(this);
        this.Ht = new Ei, this.He = function(t, e) {
            return new Dr(t, e);
        }(this.Ht, (t => this.referenceDelegate.Ps(t))), this.N = new ci(e), this.Je = new Pr(this.N);
    }
    start() {
    ...
    getMutationQueue(t) {
        ...
        return e || (e = new Sr(this.Ht, this.referenceDelegate), this.bs[t.toKey()] = e), 
        e;
    }
    getTargetCache() {
        return this.ze;
...
class $r {
    ...
    addReference(t, e, n) {
        return this.Ds.addReference(n, e), this.xs.delete(n.toString()), Ws.resolve();
    }
    removeReference(t, e, n) {
        return this.Ds.removeReference(n, e), this.xs.add(n.toString()), Ws.resolve();
    }
    markPotentiallyOrphaned(t, e) {
        return this.xs.add(e.toString()), Ws.resolve();
    }
    removeTarget(t, e) {
    ...
    Vs(t) {
        ...
        return Ws.forEach(this.xs, (n => {
            const s = Vt.fromPath(n);
    ...
    ks(t, e) {
        return Ws.or([ () => Ws.resolve(this.Ds.containsKey(e)), () => this.persistence.getTargetCache().containsKey(t, e), () => this.persistence.Ss(t, e) ]);
    }
}
...
class Lr {
     ...
     */    static $s(t, e, n) {
        ...
        r && (i = new Q(s.error.code, s.error.message))), r ? new Lr(t, e, s.state, i) : (F("SharedClientState", `Failed to parse mutation state for ID '${e}': ${n}`), 
        null);
    }
    Os() {
        const t = {
...
class Br {
     ...
     */    static $s(t, e) {
        ...
        i && (s = new Q(n.error.code, n.error.message))), i ? new Br(t, n.state, s) : (F("SharedClientState", `Failed to parse target state for ID '${t}': ${e}`), 
        null);
    }
    Os() {
        const t = {
 ...
 */ class Ur {
     ...
     */    static $s(t, e) {
        const n = JSON.parse(e);
        let s = "object" == typeof n && n.activeTargetIds instanceof Array, i = Dn();
        for (let t = 0; s && t < n.activeTargetIds.length; ++t) s = vt(n.activeTargetIds[t]), 
        i = i.add(n.activeTargetIds[t]);
        return s ? new Ur(t, i) : (F("SharedClientState", `Failed to parse client data for instance '${t}': ${e}`), 
        null);
    }
}
 ...
 */ class qr {
     ...
     */    static $s(t) {
        ...
        return "object" == typeof e && -1 !== [ "Unknown", "Online", "Offline" ].indexOf(e.onlineState) && "string" == typeof e.clientId ? new qr(e.clientId, e.onlineState) : (F("SharedClientState", `Failed to parse online state: ${t}`), 
        null);
    }
}
 ...
 */ class jr {
    constructor(t, e, n, s, i) {
        ...
        this.qs = new mn(nt), this.started = !1, 
        /**
        ...
        const r = n.replace(/[.*+?^${}()|[\]\\]/g, "\\$&");
        this.storage = this.window.localStorage, this.currentUser = i, this.js = Or(this.persistenceKey, this.Ls), 
        this.Qs = 
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ (this.persistenceKey), this.qs = this.qs.insert(this.Ls, new Kr), this.Ws = new RegExp(`^firestore_clients_${r}_([^_]*)$`), 
    ...
    Us(t) {
        ...
        if (e.storageArea === this.storage) {
            if (O("SharedClientState", "EVENT", e.key, e.newValue), e.key === this.js) return void F("Received WebStorage notification for local change. Another client might have garbage-collected our state");
 ...
 */ (e.newValue);
                        t !== Z.T && this.sequenceNumberHandler(t);
    ...
    ei(t, e, n) {
        const s = new Lr(this.currentUser, t, e, n), i = Fr(this.persistenceKey, this.currentUser, t);
        this.setItem(i, s.Os());
    }
    ni(t) {
    ...
    ii(t, e, n) {
        const s = Mr(this.persistenceKey, t), i = new Br(t, e, n);
        this.setItem(s, i.Os());
    }
    oi() {
...
class Qr {
    constructor() {
        this.yi = new Kr, this.pi = {}, this.onlineStateHandler = null, this.sequenceNumberHandler = null;
    }
    addPendingMutation(t) {
        // No op.
    }
    ...
    start() {
        return this.yi = new Kr, Promise.resolve();
    }
    handleUserChange(t, e, n) {
        // No op.
    }
...
class {
    ...
    Li(t, e, n, s) {
        ...
        const r = {};
        return this.Ui(r, s), this.qi(t, i, r, n).then((t => (O("RestConnection", "Received: ", t), 
        t)), (e => {
     ...
     */    Ui(t, e) {
        if (t["X-Goog-Api-Client"] = "gl-js/ fire/" + N, 
    ...
    ji(t, e) {
        const n = [ this.Fi, "/", "google.firestore.v1.Firestore", "/", t, "/channel" ], s = R(), i = b(), r = {
        ...
        this.useFetchStreams && (r.xmlHttpFactory = new P({})), this.Ui(r.initMessageHeaders, e), 
        ...
        f() || d() || w() || _() || m() || g() || (r.httpHeadersOverwriteParam = "$httpHeaders");
        const o = n.join("");
        ...
        // on a closed stream
                const h = new Hr({
            vi: t => {
                u ? O("Connection", "Not sending because WebChannel is closed:", t) : (a || (O("Connection", "Opening WebChannel transport."), 
        ...
        // enough the code is exception free.
                return l(c, v.EventType.OPEN, (() => {
            u || O("Connection", "WebChannel transport opened.");
        })), l(c, v.EventType.CLOSE, (() => {
            u || (u = !0, O("Connection", "WebChannel transport closed"), h.$i());
        })), l(c, v.EventType.ERROR, (t => {
            u || (u = !0, M("Connection", "WebChannel transport errored:", t), h.$i(new Q(j.UNAVAILABLE, "The operation could not be completed")));
        })), l(c, v.EventType.MESSAGE, (t => {
            var e;
            if (!u) {
                const n = t.data[0];
                U(!!n);
 ...
 */
                    function(t) {
                        ...
                        // eslint-disable-next-line @typescript-eslint/no-explicit-any
                        const e = fn[t];
                        if (void 0 !== e) return _n(e);
                    }(t), n = i.message;
                    void 0 === e && (e = j.INTERNAL, n = "Unknown error status: " + t + " with message " + i.message), 
                    // Mark closed so no further events are propagated
                    u = !0, h.$i(new Q(e, n)), c.close();
                } else O("Connection", "WebChannel received:", n), h.Oi(n);
            }
        })), l(i, V.STAT_EVENT, (t => {
            t.stat === S.PROXY ? O("Connection", "Detected buffering proxy") : t.stat === S.NOPROXY && O("Connection", "Detected no buffering proxy");
        })), setTimeout((() => {
...
class to {
     ...
     */    Xi(t) {
        ...
        // Guard against lastAttemptTime being in the future due to a clock change.
                s > 0 && O("ExponentialBackoff", `Backing off for ${s} ms (base delay: ${this.zi} ms, delay with jitter: ${e} ms, last attempt: ${n} ms ago)`), 
     ...
     */    br(t) {
        ...
        e.database = Zn(this.N), e.addTarget = function(t, e) {
            ...
            return n = Yt(s) ? {
                ...
                query: us(t, s)
            }, n.targetId = e.targetId, e.resumeToken.approximateByteSize() > 0 ? n.resumeToken = jn(t, e.resumeToken) : e.snapshotVersion.compareTo(ot.min()) > 0 && (
 ...
 */
        ...
        O("RemoteStore", "Failed to raise snapshot:", e), await Eo(t, e);
    }
}
...
class $o {
     ...
     */    static createAndSchedule(t, e, n, s, i) {
        const r = Date.now() + n, o = new $o(t, e, r, s, i);
        return o.start(n), o;
    }
    /**
 ...
 */ function Oo(t, e) {
    if (F("AsyncQueue", `${e}: ${t}`), Ys(t)) return new Q(j.UNAVAILABLE, `${e}: ${t}`);
    throw t;
}
 ...
 */ class Fo {
    ...
    constructor(t) {
        ...
        this.comparator = t ? (e, n) => t(e, n) || Vt.comparator(e.key, n.key) : (t, e) => Vt.comparator(t.key, e.key), 
        this.keyedMap = Rn(), this.sortedSet = new mn(this.comparator);
    }
    /**
     * Returns an empty copy of the existing DocumentSet, using the same
     * comparator.
     */    static emptySet(t) {
        return new Fo(t.comparator);
    }
    has(t) {
...
class Lo {
    ...
    /** Returns a view snapshot as if all documents in the snapshot were added. */    static fromInitialDocuments(t, e, n, s) {
        ...
        })), new Lo(t, e, Fo.emptySet(e), i, n, s, 
        /* syncStateChanged= */ !0, 
 ...
 */ class Go {
     ...
     */    ro(t) {
        if (!this.options.includeMetadataChanges) {
            ...
            t = new Lo(t.query, t.docs, t.oldDocs, e, t.mutatedKeys, t.fromCache, t.syncStateChanged, 
 ...
 */ class Ho {
     ...
     */    Hn(t) {
        return t.metadata.exists ? ns(this.N, t.document, !1) : Qt.newNoDocument(this.zn(t.metadata.name), this.Jn(t.metadata.readTime));
    }
    Jn(t) {
        return Wn(t);
    }
 ...
 */ class Jo {
    constructor(t, e, n) {
        ...
        this.documents = [], this.progress = Yo(t);
    }
    /**
 ...
 */ class tc {
     ...
     */    bo(t, e) {
        ...
        const c = ge(this.query) && s.size === this.query.limit ? s.last() : null, a = ye(this.query) && s.size === this.query.limit ? s.first() : null;
        // Drop documents out to meet limit/limitToLast requirement.
        if (t.inorderTraversal(((t, e) => {
            const u = s.get(t), h = Ve(this.query, e) ? e : null, l = !!u && this.mutatedKeys.has(u.key), f = !!h && (h.hasLocalMutations || 
        ...
        })), ge(this.query) || ye(this.query)) for (;r.size > this.query.limit; ) {
            const t = ge(this.query) ? r.last() : r.first();
...
/** Tracks a limbo resolution. */ class nc {
    constructor(t) {
        this.key = t, 
        /**
...
/** Stops listening to the query. */ async function oc(t, e) {
    ...
    // No other queries are mapped to the target, clean up the query and the target.
        ...
        n.sharedClientState.isActiveQueryTarget(s.targetId) || await pr(n.localStore, s.targetId, 
        /*keepPersistedTargetData=*/ !1).then((() => {
            n.sharedClientState.clearQueryState(s.targetId), ho(n.remoteStore, s.targetId), 
            mc(n, s.targetId);
        })).catch(Li);
    } else mc(n, s.targetId), await pr(n.localStore, s.targetId, 
 ...
 */ async function cc(t, e, n) {
    ...
    try {
        const t = await function(t, e) {
            const n = K(t), s = rt.now(), i = e.reduce(((t, e) => t.add(e.key)), Vn());
            let r;
            return n.persistence.runTransaction("Locally write mutations", "readwrite", (t => n.Qn.Pn(t, i).next((i => {
                ...
                const o = [];
                for (const t of e) {
                    const e = tn(t, r.get(t.key));
                    null != e && 
                    // NOTE: The base state should only be applied if there's some
                    // existing document to override, so use a Precondition of
                    // exists=true
                    o.push(new rn(t.key, e, jt(e.value.mapValue), He.exists(!0)));
                }
 ...
 * it.
 */ (s, t.batchId, n), await Ec(s, t.changes), await Ao(s.remoteStore);
    } catch (t) {
 ...
 */ async function hc(t, e, n) {
    ...
    if (r) {
        ...
        let t = new mn(Vt.comparator);
        t = t.insert(r, Qt.newNoDocument(r, ot.min()));
        const n = Vn().add(r), i = new Cn(ot.min(), 
        /* targetChanges= */ new Map, 
        /* targetMismatches= */ new pn(nt), t, n);
        await ac(s, i), 
...
async function lc(t, e) {
    ...
    try {
        ...
        // before listen events.
                _c(n, s, /*error=*/ null), wc(n, s), n.sharedClientState.updateMutationState(s, "acknowledged"), 
        await Ec(n, t);
    } catch (t) {
        await Li(t);
    }
    ...
    try {
        const t = await function(t, e) {
            ...
            return n.persistence.runTransaction("Reject batch", "readwrite-primary", (t => {
                let s;
                return n.In.lookupMutationBatch(t, e).next((e => (U(null !== e), s = e.keys(), n.In.removeMutationBatch(t, e)))).next((() => n.In.performConsistencyCheck(t))).next((() => n.Qn.Pn(t, s)));
            }));
        }
        /**
 ...
 */ (s.localStore, e);
        ...
        // listen events.
                _c(s, e, n), wc(s, e), s.sharedClientState.updateMutationState(e, "rejected", n), 
        await Ec(s, t);
    } catch (n) {
        await Li(n);
    }
 ...
 */ async function dc(t, e) {
    const n = K(t);
    mo(n.remoteStore) || O("SyncEngine", "The network is disabled. The task returned by 'awaitPendingWrites()' will not complete until the network is enabled.");
    try {
...
async function bc(t) {
    const e = K(t);
    return Ir(e.localStore).then((t => Ec(e, t)));
}
...
async function Pc(t, e, n, s) {
    const i = K(t), r = await function(t, e) {
        const n = K(t), s = K(n.In);
        return n.persistence.runTransaction("Lookup mutation documents", "readonly", (t => s.Xt(t, e).next((e => e ? n.Qn.Pn(t, e) : Ws.resolve(null)))));
    }
    // PORTING NOTE: Multi-Tab only.
    (i.localStore, e);
    null !== r ? ("pending" === n ? 
    ...
    await Ao(i.remoteStore) : "acknowledged" === n || "rejected" === n ? (
    // NOTE: Both these methods are no-ops for batches that originated from
    // other clients.
    _c(i, e, s || null), wc(i, e), function(t, e) {
        K(K(t).In).te(e);
    }
    // PORTING NOTE: Multi-Tab only.
    (i.localStore, e)) : B(), await Ec(i, r)) : 
...
async function Vc(t, e, n) {
    ...
    for (const t of e) {
        ...
        if (n && 0 !== n.length) {
            ...
            e = await yr(s.localStore, n), await rc(s, Sc(n), t, 
            /*current=*/ !1);
        }
        i.push(e);
    }
...
// PORTING NOTE: Multi-Tab only.
function Sc(t) {
    return _e(t.path, t.collectionGroup, t.orderBy, t.filters, t.limit, "F" /* First */ , t.startAt, t.endAt);
}
...
function Dc(t) {
    const e = K(t);
    return K(K(e.localStore).persistence).pn();
}
...
async function Cc(t, e, n, s) {
    ...
    O("SyncEngine", "Ignoring unexpected query state notification."); else if (i.Fo.has(e)) switch (n) {
      ...
      case "not-current":
        {
            const t = await Ir(i.localStore), s = Cn.createSynthesizedRemoteEventForCurrentChange(e, "current" === n);
            await Ec(i, t, s);
            break;
        }

      case "rejected":
        await pr(i.localStore, e, 
        /* keepPersistedTargetData */ !0), mc(i, e, s);
        break;
...
/** Adds or removes Watch targets for queries from different tabs. */ async function Nc(t, e, n) {
    ...
    if (s.Qo) {
        for (const t of e) {
            ...
            const e = await Er(s.localStore, t), n = await yr(s.localStore, e);
            await rc(s, Sc(e), n.targetId, 
            /*current=*/ !1), uo(s.remoteStore, n);
        }
        for (const t of n) 
...
function kc(t) {
    const e = K(t);
    return e.remoteStore.remoteSyncer.applySuccessfulWrite = lc.bind(null, e), e.remoteStore.remoteSyncer.rejectFailedWrite = fc.bind(null, e), 
    e;
}
 ...
 */ class Mc extends Fc {
    ...
    Ho(t) {
        ...
        return new jr(e, t.asyncQueue, n, t.clientId, t.initialUser);
    }
}
 ...
 */ class Lc {
    async initialize(t, e) {
        ...
        /* startAsPrimary=*/ !t.synchronizeTabs), this.sharedClientState.onlineStateHandler = t => uc(this.syncEngine, t, 1 /* SharedClientState */), 
        this.remoteStore.remoteSyncer.handleCredentialChange = Ic.bind(null, this.syncEngine), 
        await No(this.remoteStore, this.syncEngine.isPrimaryClient));
    }
    createEventManager(t) {
        return new Uo;
    }
    createDatastore(t) {
        const e = Zr(t.databaseInfo.databaseId), n = (s = t.databaseInfo, new Jr(s));
        var s;
    ...
    createRemoteStore(t) {
        return e = this.localStore, n = this.datastore, s = t.asyncQueue, i = t => uc(this.syncEngine, t, 0 /* RemoteStore */), 
        r = Gr.bt() ? new Gr : new Wr, new oo(e, n, s, i, r);
        var e, n, s, i, r;
...
class Kc {
    ...
    async lookup(t) {
        ...
        const e = await async function(t, e) {
            const n = K(t), s = Zn(n.N) + "/documents", i = {
                documents: e.map((t => Hn(n.N, t)))
     ...
     */    precondition(t) {
        ...
        return !this.writtenDocs.has(t.toString()) && e ? He.updateTime(e) : He.none();
    }
    /**
...
class jc {
    ...
    wc(t) {
        if ("FirebaseError" === t.name) {
            ...
            const e = t.code;
            return "aborted" === e || "failed-precondition" === e || !wn(e);
        }
        return !1;
    }
}
...
class Qc {
     ...
     */
    e, n) {
        this.credentials = t, this.asyncQueue = e, this.databaseInfo = n, this.user = C.UNAUTHENTICATED, 
        this.clientId = et.I(), this.credentialListener = () => Promise.resolve(), this.credentials.start(e, (async t => {
...
async function Wc(t, e) {
    ...
    t.setCredentialChangeListener((async t => {
        s.isEqual(t) || (await fr(e.localStore, t), s = t);
    })), 
...
function Xc(t) {
    return Hc(t).then((t => t.remoteStore));
}

function Zc(t) {
    return Hc(t).then((t => t.syncEngine));
}

async function ta(t) {
    const e = await Hc(t), n = e.eventManager;
    return n.onListen = ic.bind(null, e.syncEngine), n.onUnlisten = oc.bind(null, e.syncEngine), 
    n;
}

/** Enables the network connection and re-enqueues all pending operations. */ function ea(t) {
...
/** Disables the network connection. Pending operations will not complete. */ function na(t) {
    return t.asyncQueue.enqueue((async () => {
        const e = await Jc(t), n = await Xc(t);
    ...
    return t.asyncQueue.enqueueAndForget((async () => function(t, e, n, s, i) {
        const r = new Uc({
            next: n => {
                // Remove query first before passing event to user to avoid
                // user actions affecting the now stale query.
                e.enqueueAndForget((() => Ko(t, o))), n.fromCache && "server" === s.source ? i.reject(new Q(j.UNAVAILABLE, 'Failed to get documents from server. (However, these documents may exist in the local cache. Run again without setting source to "server" to retrieve the cached documents.)')) : i.resolve(n);
            },
            error: t => i.reject(t)
        }), o = new Go(n, r, {
            includeMetadataChanges: !0,
 ...
 */ function aa(t, e) {
    ...
    return t.asyncQueue.enqueueAndForget((async () => {
        const s = await function(t) {
            return Hc(t).then((t => t.datastore));
        }(t);
        new jc(t.asyncQueue, s, e, n).run();
    })), n.promise;
}
...
class fa {
    ...
    isEqual(t) {
        return t instanceof fa && t.projectId === this.projectId && t.database === this.database;
    }
}
 ...
 */ function ma(t) {
    if (!Vt.isDocumentKey(t)) throw new Q(j.INVALID_ARGUMENT, `Invalid document reference. Document references must have an even number of segments, but ${t} has ${t.length}.`);
}
 ...
 */ function ga(t) {
    if (Vt.isDocumentKey(t)) throw new Q(j.INVALID_ARGUMENT, `Invalid collection reference. Collection references must have an odd number of segments, but ${t} has ${t.length}.`);
}
...
class Ea {
    constructor(t) {
        ...
        this.useFetchStreams = !!t.useFetchStreams, _a("experimentalForceLongPolling", t.experimentalForceLongPolling, "experimentalAutoDetectLongPolling", t.experimentalAutoDetectLongPolling);
    }
    isEqual(t) {
 ...
 */ class Ia {
    ...
    constructor(t, e) {
        ...
        this._settingsFrozen = !1, t instanceof fa ? this._databaseId = t : (this._app = t, 
        this._databaseId = function(t) {
            ...
            return new fa(t.options.projectId);
        }
        /**
    ...
    _setSettings(t) {
        ...
        this._settings = new Ea(t), void 0 !== t.credentials && (this._credentials = function(t) {
            ...
            switch (t.type) {
              ...
              default:
                throw new Q(j.INVALID_ARGUMENT, "makeCredentialsProvider failed due to invalid credential type");
            }
        }(t.credentials));
    }
    _getSettings() {
 ...
 */
        return function(t) {
            const e = da.get(t);
            e && (O("ComponentProvider", "Removing Datastore"), da.delete(t), e.terminate());
...
function Aa(t, e, n, s = {}) {
    var i;
    const r = (t = pa(t, Ia))._getSettings();
    ...
    t._setSettings(Object.assign(Object.assign({}, r), {
        ...
        if ("string" == typeof s.mockUserToken) e = s.mockUserToken, n = C.MOCK_USER; else {
            ...
            e = y(s.mockUserToken, null === (i = t._app) || void 0 === i ? void 0 : i.options.projectId);
            const r = s.mockUserToken.sub || s.mockUserToken.user_id;
            if (!r) throw new Q(j.INVALID_ARGUMENT, "mockUserToken must contain 'sub' or 'user_id' field!");
            n = new C(r);
        }
        t._credentials = new H(new G(e, n));
    }
}
 ...
 */ class Ra {
     ...
     */    get parent() {
        return new Pa(this.firestore, this.converter, this._key.path.popLast());
    }
    withConverter(t) {
        return new Ra(this.firestore, t, this._key);
    }
}
 ...
 */ class Pa extends ba {
     ...
     */    get parent() {
        ...
        return t.isEmpty() ? null : new Ra(this.firestore, 
        /* converter= */ null, new Vt(t));
    }
    withConverter(t) {
        return new Pa(this.firestore, t, this._path);
    }
}

function va(t, e, ...n) {
    if (t = p(t), wa("collection", "path", e), t instanceof Ia) {
        const s = lt.fromString(e, ...n);
        return ga(s), new Pa(t, /* converter= */ null, s);
    }
    {
        if (!(t instanceof Ra || t instanceof Pa)) throw new Q(j.INVALID_ARGUMENT, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
        const s = t._path.child(lt.fromString(e, ...n));
        return ga(s), new Pa(t.firestore, 
        /* converter= */ null, s);
    }
}
 ...
 */ function Va(t, e) {
    if (t = pa(t, Ia), wa("collectionGroup", "collection id", e), e.indexOf("/") >= 0) throw new Q(j.INVALID_ARGUMENT, `Invalid collection ID '${e}' passed to function collectionGroup(). Collection IDs must not contain '/'.`);
    return new ba(t, 
    /* converter= */ null, 
    /**
...
function Sa(t, e, ...n) {
    ...
    // 'undefined' and 'null'.
    1 === arguments.length && (e = et.I()), wa("doc", "path", e), t instanceof Ia) {
        const s = lt.fromString(e, ...n);
        return ma(s), new Ra(t, 
        /* converter= */ null, new Vt(s));
    }
    {
        if (!(t instanceof Ra || t instanceof Pa)) throw new Q(j.INVALID_ARGUMENT, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
        const s = t._path.child(lt.fromString(e, ...n));
        return ma(s), new Ra(t.firestore, t instanceof Pa ? t.converter : null, new Vt(s));
    }
}
 ...
 * Firestore database.
 */ function Da(t, e) {
    return t = p(t), e = p(e), (t instanceof Ra || t instanceof Pa) && (e instanceof Ra || e instanceof Pa) && (t.firestore === e.firestore && t.path === e.path && t.converter === e.converter);
}
 ...
 * Firestore database.
 */ function Ca(t, e) {
    return t = p(t), e = p(e), t instanceof ba && e instanceof ba && (t.firestore === e.firestore && be(t._query, e._query) && t.converter === e.converter);
}
...
function Ba(t) {
    ...
    const n = t._freezeSettings(), s = function(t, e, n, s) {
        return new la(t, e, n, s.host, s.ssl, s.experimentalForceLongPolling, s.experimentalAutoDetectLongPolling, s.useFetchStreams);
    }(t._databaseId, (null === (e = t._app) || void 0 === e ? void 0 : e.options.appId) || "", t._persistenceKey, n);
    t._firestoreClient = new Qc(t._credentials, t._queue, s);
}
 ...
 */ function Ua(t, e) {
    Ya(t = pa(t, Oa));
    const n = La(t), s = t._freezeSettings(), i = new Lc;
    return Ka(n, i, new Fc(i, s.cacheSizeBytes, null == e ? void 0 : e.forceOwnership));
}
 ...
 */ function qa(t) {
    Ya(t = pa(t, Oa));
    const e = La(t), n = t._freezeSettings(), s = new Lc;
    return Ka(e, s, new Mc(s, n.cacheSizeBytes));
}
 ...
 */ function Ka(t, e, n) {
    ...
    return t.asyncQueue.enqueue((async () => {
        try {
            await Wc(t, n), await Gc(t, e), s.resolve();
        } catch (t) {
            if (!
            /**
...
function ja(t) {
    ...
    return t._queue.enqueueAndForgetEvenWhileRestricted((async () => {
        try {
            await async function(t) {
                if (!zs.bt()) return Promise.resolve();
                const e = t + "main";
                await zs.delete(e);
            }(rr(t._databaseId, t._persistenceKey)), e.resolve();
        } catch (t) {
            e.reject(t);
        }
    })), e.promise;
 ...
 */ function Qa(t) {
    return function(t) {
        const e = new W;
        return t.asyncQueue.enqueueAndForget((async () => dc(await Zc(t), e))), e.promise;
    }(La(t = pa(t, Oa)));
}
 ...
 */ function Ha(t, e) {
    const n = La(t = pa(t, Oa)), s = new ka;
    return ua(n, t._databaseId, e, s), s;
}
 ...
 */ function Ja(t, e) {
    return ha(La(t = pa(t, Oa)), e).then((e => e ? new ba(t, null, e.query) : null));
}
 ...
 */ class tu {
     ...
     */    static fromBase64String(t) {
        try {
            return new tu(gt.fromBase64String(t));
        } catch (t) {
     ...
     */    static fromUint8Array(t) {
        return new tu(gt.fromUint8Array(t));
    }
    /**
 ...
 */ class nu {
     ...
     * with an underscore.
     */    _compareTo(t) {
        return nt(this._lat, t._lat) || nt(this._long, t._long);
    }
}
...
/** The result of parsing document data (e.g. for a setData call). */ class iu {
    constructor(t, e, n) {
        this.data = t, this.fieldMask = e, this.fieldTransforms = n;
    }
    toMutation(t, e) {
        return null !== this.fieldMask ? new rn(t, this.data, this.fieldMask, e, this.fieldTransforms) : new sn(t, this.data, e, this.fieldTransforms);
    }
}

/** The result of parsing "update" data (i.e. for an updateData call). */ class ru {
    constructor(t, 
...
function uu(t) {
    const e = t._freezeSettings(), n = Zr(t._databaseId);
    return new au(t._databaseId, !!e.ignoreUndefinedProperties, n);
}
...
/** Parse document data from a set() call. */ function hu(t, e, n, s, i, r = {}) {
    ...
    const c = Eu(s, o);
    let a, u;
    if (r.merge) a = new wt(o.fieldMask), u = o.fieldTransforms; else if (r.mergeFields) {
        const t = [];
        ...
        a = new wt(t), u = o.fieldTransforms.filter((t => a.covers(t.field)));
    } else a = null, u = o.fieldTransforms;
    return new iu(new Kt(c), a, u);
}
...
/** Parse update data from an update() call. */ function gu(t, e, n, s) {
    ...
    const c = new wt(r);
    return new ru(o, c, i.fieldTransforms);
}
...
/** Parse update data from a list of field/value arguments. */ function yu(t, e, n, s, i, r) {
    ...
    for (let t = c.length - 1; t >= 0; --t) if (!Vu(u, c[t])) {
        const e = c[t];
        let n = a[t];
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
    ...
    const l = new wt(u);
    return new ru(h, l, o.fieldTransforms);
}
 ...
 */ function Tu(t, e) {
    ...
    // from firestore-exp.
    t = p(t))) return Au("Unsupported field value:", e, t), Eu(t, e);
    if (t instanceof eu) 
 ...
 */ (t, e), null;
    ...
    return function(t, e) {
        ...
        if (t instanceof Date) {
            const n = rt.fromDate(t);
            return {
                timestampValue: Kn(e.N, n)
            };
        }
        if (t instanceof rt) {
            ...
            const n = new rt(t.seconds, 1e3 * Math.floor(t.nanoseconds / 1e3));
            return {
                timestampValue: Kn(e.N, n)
            };
        }
        ...
        if (t instanceof tu) return {
            bytesValue: jn(e.N, t._byteString)
        };
        if (t instanceof Ra) {
...
function Iu(t) {
    return !("object" != typeof t || null === t || t instanceof Array || t instanceof Date || t instanceof rt || t instanceof nu || t instanceof tu || t instanceof Ra || t instanceof eu);
}
 ...
 */ function Ru(t, e, n) {
    ...
    // FieldPath.
    e = p(e)) instanceof Xa) return e._internalPath;
    if ("string" == typeof e) return Pu(t, e);
 ...
 */ function Pu(t, e, n) {
    ...
    /* path= */ void 0, n);
    try {
        return new Xa(...e.split("."))._internalPath;
    } catch (s) {
...
/** Checks `haystack` if FieldPath `needle` is present. Runs in O(n). */ function Vu(t, e) {
 ...
 */ class Su {
     ...
     */    get ref() {
        return new Ra(this._firestore, this._converter, this._key);
    }
    /**
     ...
     */    data() {
        if (this._document) {
            if (this._converter) {
                ...
                const t = new Du(this._firestore, this._userDataWriter, this._key, this._document, 
                /* converter= */ null);
    ...
    get(t) {
        if (this._document) {
            const e = this._document.data.field(Cu("DocumentSnapshot.get", t));
 ...
 * Helper that calls `fromDotSeparatedString()` but wraps any error thrown.
 */ function Cu(t, e) {
    return "string" == typeof e ? Pu(t, e) : e instanceof Xa ? e._internalPath : e._delegate._internalPath;
}
 ...
 */ class xu extends Su {
     ...
     */    data(t = {}) {
        if (this._document) {
            if (this._converter) {
                // We only want to use the converter and create a new DocumentSnapshot
                // if a converter has been provided.
                const e = new ku(this._firestore, this._userDataWriter, this._key, this._document, this.metadata, 
                /* converter= */ null);
    ...
    get(t, e = {}) {
        if (this._document) {
            const n = this._document.data.field(Cu("DocumentSnapshot.get", t));
 ...
 */ class $u {
    /** @hideconstructor */
    constructor(t, e, n, s) {
        this._firestore = t, this._userDataWriter = e, this._snapshot = s, this.metadata = new Nu(s.hasPendingWrites, s.fromCache), 
        this.query = n;
    }
     ...
     */    forEach(t, e) {
        this._snapshot.docs.forEach((n => {
            t.call(e, new ku(this._firestore, this._userDataWriter, n.key, n, new Nu(this._snapshot.mutatedKeys.has(n.key), this._snapshot.fromCache), this.query.converter));
        }));
    }
    /**
        ...
        function(t, e) {
            if (t._snapshot.oldDocs.isEmpty()) {
                ...
                return t._snapshot.docChanges.map((n => ({
                    type: "added",
                    doc: new ku(t._firestore, t._userDataWriter, n.doc.key, n.doc, new Nu(t._snapshot.mutatedKeys.has(n.doc.key), t._snapshot.fromCache), t.query.converter),
                    oldIndex: -1,
                    newIndex: e++
                })));
            }
            {
                ...
                return t._snapshot.docChanges.filter((t => e || 3 /* Metadata */ !== t.type)).map((e => {
                    const s = new ku(t._firestore, t._userDataWriter, e.doc.key, e.doc, new Nu(t._snapshot.mutatedKeys.has(e.doc.key), t._snapshot.fromCache), t.query.converter);
                    let i = -1, r = -1;
 ...
 */ function Fu(t, e) {
    return t instanceof xu && e instanceof xu ? t._firestore === e._firestore && t._key.isEqual(e._key) && (null === t._document ? null === e._document : t._document.isEqual(e._document)) && t._converter === e._converter : t instanceof $u && e instanceof $u && (t._firestore === e._firestore && Ca(t.query, e.query) && t.metadata.isEqual(e.metadata) && t._snapshot.isEqual(e._snapshot));
}
 ...
 * limitations under the License.
 */ function Mu(t) {
    if (ye(t) && 0 === t.explicitOrderBy.length) throw new Q(j.UNIMPLEMENTED, "limitToLast() queries require specifying at least one orderBy() clause");
}
        ...
        const e = uu(t.firestore), n = function(t, e, n, s, i, r, o) {
            ...
            if (i.isKeyField()) {
                ...
                if ("in" /* IN */ === r || "not-in" /* NOT_IN */ === r) {
                    nh(o, r);
                    const e = [];
                    for (const n of o) e.push(eh(s, t, n));
                    c = {
                        arrayValue: {
                            values: e
                        }
            ...
            } else "in" /* IN */ !== r && "not-in" /* NOT_IN */ !== r && "array-contains-any" /* ARRAY_CONTAINS_ANY */ !== r || nh(o, r), 
            c = pu(n, e, o, 
            /* allowArrays= */ "in" /* IN */ === r || "not-in" /* NOT_IN */ === r);
            const a = Xt.create(i, r, c);
            return function(t, e) {
                if (e.v()) {
                    const n = Te(t);
 ...
 * @returns The created {@link Query}.
 */ function Wu(t) {
    return Ta("limit", t), new Qu("limit", t, "F" /* First */);
}
 ...
 * @returns The created {@link Query}.
 */ function Gu(t) {
    return Ta("limitToLast", t), new Qu("limitToLast", t, "L" /* Last */);
}
...
/** Helper function to create a bound from a document or fields */ function th(t, e, n, s) {
    if (n[0] = p(n[0]), n[0] instanceof Su) return function(t, e, n, s, i) {
        ...
        // results.
                for (const n of Ie(t)) if (n.field.isKeyField()) r.push(Ot(e, s.key)); else {
            const t = s.data.field(n.field);
            if (It(t)) throw new Q(j.INVALID_ARGUMENT, 'Invalid query. You are trying to start or end a query using a document for which the field "' + n.field + '" is an uncommitted server timestamp. (Since the value of this field is unknown, you cannot start/end a query with it.)');
            if (null === t) {
        ...
        return function(t, e, n, s, i, r) {
            ...
            for (let r = 0; r < i.length; r++) {
                ...
                if (o[r].field.isKeyField()) {
                    ...
                    if (!Ee(t) && -1 !== a.indexOf("/")) throw new Q(j.INVALID_ARGUMENT, `Invalid query. When querying a collection and ordering by FieldPath.documentId(), the value passed to ${s}() must be a plain document ID, but '${a}' contains a slash.`);
                    const n = t.path.child(lt.fromString(a));
                    if (!Vt.isDocumentKey(n)) throw new Q(j.INVALID_ARGUMENT, `Invalid query. When querying a collection group and ordering by FieldPath.documentId(), the value passed to ${s}() must result in a valid document path, but '${n}' is not because it contains an odd number of segments.`);
                    const i = new Vt(n);
                    c.push(Ot(e, i));
                } else {
                    const t = pu(n, s, a);
...
function eh(t, e, n) {
    if ("string" == typeof (n = p(n))) {
        ...
        if (!Ee(e) && -1 !== n.indexOf("/")) throw new Q(j.INVALID_ARGUMENT, `Invalid query. When querying a collection by FieldPath.documentId(), you must provide a plain document ID, but '${n}' contains a '/' character.`);
        const s = e.path.child(lt.fromString(n));
        if (!Vt.isDocumentKey(s)) throw new Q(j.INVALID_ARGUMENT, `Invalid query. When querying a collection group by FieldPath.documentId(), the value provided must result in a valid document path, but '${s}' is not because it has an odd number of segments (${s.length}).`);
        return Ot(t, new Vt(s));
    }
    if (n instanceof Ra) return Ot(t, n._key);
    throw new Q(j.INVALID_ARGUMENT, `Invalid query. When querying with FieldPath.documentId(), you must provide a valid string or a DocumentReference, but it was: ${ya(n)}.`);
}
 ...
 */ class ih {
    ...
    convertGeoPoint(t) {
        return new nu(Tt(t.latitude), Tt(t.longitude));
    }
    convertArray(t, e) {
    ...
    convertDocumentKey(t, e) {
        ...
        U(Is(n));
        const s = new fa(n.get(1), n.get(3)), i = new Vt(n.popFirst(5));
        return s.isEqual(e) || 
...
class oh extends ih {
    ...
    convertReference(t) {
        ...
        return new Ra(this.firestore, /* converter= */ null, e);
    }
}
 ...
 */ class ch {
    ...
    constructor(t, e) {
        ...
        this._dataReader = uu(t);
    }
    set(t, e, n) {
        this._verifyNotCommitted();
        const s = ah(t, this._firestore), i = rh(s.converter, e, n), r = hu(this._dataReader, "WriteBatch.set", s._key, i, null !== s.converter, n);
        return this._mutations.push(r.toMutation(s._key, He.none())), this;
    }
    update(t, e, n, ...s) {
        this._verifyNotCommitted();
        const i = ah(t, this._firestore);
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
                let r;
        return r = "string" == typeof (e = p(e)) || e instanceof Xa ? yu(this._dataReader, "WriteBatch.update", i._key, e, n, s) : gu(this._dataReader, "WriteBatch.update", i._key, e), 
        this._mutations.push(r.toMutation(i._key, He.exists(!0))), this;
    }
    /**
     ...
     */    delete(t) {
        this._verifyNotCommitted();
        const e = ah(t, this._firestore);
        return this._mutations = this._mutations.concat(new un(e._key, He.none())), this;
    }
    /**
...
function ah(t, e) {
    if ((t = p(t)).firestore !== e) throw new Q(j.INVALID_ARGUMENT, "Provided document reference is from a different Firestore instance.");
    return t;
}
...
function uh(t) {
    t = pa(t, Ra);
    const e = pa(t.firestore, Oa);
    return ia(La(e), t._key).then((n => Ah(e, t, n)));
}
 ...
 */ function lh(t) {
    t = pa(t, Ra);
    const e = pa(t.firestore, Oa), n = La(e), s = new hh(e);
    return sa(n, t._key).then((n => new xu(e, s, t._key, n, new Nu(null !== n && n.hasLocalMutations, 
 ...
 */ function dh(t) {
    t = pa(t, ba);
    const e = pa(t.firestore, Oa), n = La(e), s = new hh(e);
    return Mu(t._query), oa(n, t._query).then((n => new $u(e, s, t, n)));
}
 ...
 */ function wh(t) {
    t = pa(t, ba);
    const e = pa(t.firestore, Oa), n = La(e), s = new hh(e);
    return ra(n, t._query).then((n => new $u(e, s, t, n)));
}
 ...
 */ function _h(t) {
    ...
    return oa(n, t._query, {
        source: "server"
    }).then((n => new $u(e, s, t, n)));
}

function mh(t, e, n) {
    t = pa(t, Ra);
    const s = pa(t.firestore, Oa), i = rh(t.converter, e, n);
    return Ih(s, [ hu(uu(s), "setDoc", t._key, i, null !== t.converter, n).toMutation(t._key, He.none()) ]);
}

function gh(t, e, n, ...s) {
    t = pa(t, Ra);
    const i = pa(t.firestore, Oa), r = uu(i);
    let o;
    o = "string" == typeof (
    // For Compat types, we have to "extract" the underlying types before
    // performing validation.
    e = p(e)) || e instanceof Xa ? yu(r, "updateDoc", t._key, e, n, s) : gu(r, "updateDoc", t._key, e);
    return Ih(i, [ o.toMutation(t._key, He.exists(!0)) ]);
}
 ...
 */ function yh(t) {
    return Ih(pa(t.firestore, Oa), [ new un(t._key, He.none()) ]);
}
 ...
 */ function ph(t, e) {
    const n = pa(t.firestore, Oa), s = Sa(t), i = rh(t.converter, e);
    return Ih(n, [ hu(uu(t.firestore), "addDoc", s._key, i, null !== t.converter, {}).toMutation(s._key, He.exists(!1)) ]).then((() => s));
}
...
function Th(t, ...e) {
    ...
    let a, u, h;
    if (t instanceof Ra) u = pa(t.firestore, Oa), h = me(t._key.path), a = {
        next: n => {
            e[o] && e[o](Ah(u, t, n));
        },
        error: e[o + 1],
        ...
        const n = pa(t, ba);
        u = pa(n.firestore, Oa), h = n._query;
        const s = new hh(u);
        a = {
            next: t => {
                e[o] && e[o](new $u(u, s, n, t));
            },
            error: e[o + 1],
            complete: e[o + 2]
        }, Mu(t._query);
 ...
 */ function Ih(t, e) {
    return function(t, e) {
        const n = new W;
        return t.asyncQueue.enqueueAndForget((async () => cc(await Zc(t), e, n))), n.promise;
    }(La(t), e);
}
 ...
 */ function Ah(t, e, n) {
    const s = n.docs.get(e._key), i = new hh(t);
    return new xu(t, i, e._key, s, new Nu(n.hasPendingWrites, n.fromCache), e.converter);
}
 ...
 */ class Rh extends class {
    /** @hideconstructor */
    constructor(t, e) {
        this._firestore = t, this._transaction = e, this._dataReader = uu(t);
    }
    /**
     ...
     */    get(t) {
        const e = ah(t, this._firestore), n = new oh(this._firestore);
        return this._transaction.lookup([ e._key ]).then((t => {
            if (!t || 1 !== t.length) return B();
            const s = t[0];
            if (s.isFoundDocument()) return new Su(this._firestore, n, s.key, s, e.converter);
            if (s.isNoDocument()) return new Su(this._firestore, n, e._key, null, e.converter);
            throw B();
        }));
    }
    set(t, e, n) {
        const s = ah(t, this._firestore), i = rh(s.converter, e, n), r = hu(this._dataReader, "Transaction.set", s._key, i, null !== s.converter, n);
    ...
    update(t, e, n, ...s) {
        ...
        // performing validation.
                let r;
        return r = "string" == typeof (e = p(e)) || e instanceof Xa ? yu(this._dataReader, "Transaction.update", i._key, e, n, s) : gu(this._dataReader, "Transaction.update", i._key, e), 
     ...
     * @returns A `DocumentSnapshot` with the read data.
     */    get(t) {
        const e = ah(t, this._firestore), n = new hh(this._firestore);
        return super.get(t).then((t => new xu(this._firestore, n, e._key, t._document, new Nu(
        /* hasPendingWrites= */ !1, 
 ...
 * writes.
 */ function Ch(t) {
    return La(t = pa(t, Oa)), new ch(t, (e => Ih(t, e)));
}
