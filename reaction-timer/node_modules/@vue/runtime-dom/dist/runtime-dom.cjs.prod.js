...
function setChecked(el, { value, oldValue }, vnode) {
    ...
    if (shared.isArray(value)) {
        ...
        el.checked = shared.looseHas(value, vnode.props.value);
    }
    ...
    for (let i = 0, l = el.options.length; i < l; i++) {
        ...
        if (isMultiple) {
            if (shared.isArray(value)) {
                ...
                option.selected = shared.looseHas(value, optionValue);
            }
        }
        else {
...
// SSR vnode transforms
{
    ...
    vModelCheckbox.getSSRProps = ({ value }, vnode) => {
        if (shared.isArray(value)) {
            ...
            if (vnode.props && shared.looseHas(value, vnode.props.value)) {
                return { checked: true };
            }
        }
        else if (value) {
