...
import { SDK_VERSION as i, _registerComponent as o, registerVersion as s, _getProvider, getApp as u, _removeServiceInstance as a } from "@firebase/app";
...
import { XhrIo as S, EventType as N, ErrorCode as _, createWebChannelTransport as D, getStatEventTarget as A, FetchXmlHttpFactory as k, WebChannel as C, Event as x, Stat as L } from "@firebase/webchannel-wrapper";

var R = "@firebase/firestore", O = /** @class */ function() {
    function t(t) {
        this.uid = t;
    }
 ...
 * limitations under the License.
 */
var P = "9.4.0", F = new h("@firebase/firestore");
 ...
 */ var H = {
    ...
    return t.prototype.start = function(t, e) {
        ...
        this.o = function() {
            i.i++, i.currentUser = i.u(), u.resolve(), u = new Y, t.enqueueRetryable((function() {
        ...
        var a = function() {
            ...
            q("FirebaseCredentialsProvider", "Auth detected"), i.auth = t, i.auth.addAuthTokenListener(i.o), 
            a();
        };
        ...
        setTimeout((function() {
            if (!i.auth) {
                ...
                q("FirebaseCredentialsProvider", "Auth not yet detected"), u.resolve(), u = new Y);
            }
        }), 0), a();
        ...
        // request is outstanding.
            ...
            return t.i !== e ? (q("FirebaseCredentialsProvider", "getToken aborted due to token change."), 
 ...
 */ var at = /** @class */ function() {
     ...
     */
    e) {
        if (this.seconds = t, this.nanoseconds = e, e < 0) throw new W(H.INVALID_ARGUMENT, "Timestamp nanoseconds out of range: " + e);
        if (e >= 1e9) throw new W(H.INVALID_ARGUMENT, "Timestamp nanoseconds out of range: " + e);
        if (t < -62135596800) throw new W(H.INVALID_ARGUMENT, "Timestamp seconds out of range: " + t);
        // This will break in the year 10,000.
                if (t >= 253402300800) throw new W(H.INVALID_ARGUMENT, "Timestamp seconds out of range: " + t);
    }
    /**
 ...
 */ var dt = /** @class */ function() {
    ...
    n.fromString = function() {
        ...
        // for legacy reasons and should not be used frequently).
            ...
            var s = o[i];
            if (s.indexOf("//") >= 0) throw new W(H.INVALID_ARGUMENT, "Invalid segment (" + s + "). Paths must not contain // in them.");
...
}(dt), yt = /^[_a-zA-Z][_a-zA-Z0-9]*$/, vt = /** @class */ function(e) {
    function n() {
        return null !== e && e.apply(this, arguments) || this;
    }
    return t(n, e), n.prototype.construct = function(t, e, r) {
    ...
    n.fromServerFormat = function(t) {
        for (var e = [], r = "", i = 0, o = function() {
            if (0 === r.length) throw new W(H.INVALID_ARGUMENT, "Invalid field path (" + t + "). Paths must not be empty, begin with '.', end with '.', or contain '..'");
            e.push(r), r = "";
        }, s = !1; i < t.length; ) {
            var u = t[i];
            if ("\\" === u) {
                if (i + 1 === t.length) throw new W(H.INVALID_ARGUMENT, "Path has trailing escape character: " + t);
                var a = t[i + 1];
                if ("\\" !== a && "." !== a && "`" !== a) throw new W(H.INVALID_ARGUMENT, "Path has invalid escape sequence: " + t);
                r += a, i += 2;
            } else "`" === u ? (s = !s, i++) : "." !== u || s ? (r += u, i++) : (o(), i++);
        }
        if (o(), s) throw new W(H.INVALID_ARGUMENT, "Unterminated ` in path: " + t);
        return new n(e);
    }, n.emptyPath = function() {
        return new n([]);
    }, n;
...
function Ot(t, e) {
    ...
    switch (n) {
      ...
      case 8 /* GeoPointValue */ :
        return function(t, e) {
            var n = ot(Tt(t.latitude), Tt(e.latitude));
            return 0 !== n ? n : ot(Tt(t.longitude), Tt(e.longitude));
...
function Pt(t, e) {
    ...
    var n = It(t), r = It(e), i = ot(n.seconds, r.seconds);
...
/** Creates a deep copy of `source`. */ function zt(t) {
    ...
    if (t.mapValue) {
        ...
        return ft(t.mapValue.fields, (function(t, n) {
...
var Ht = /** @class */ function() {
    ...
    return t.newInvalidDocument = function(e) {
        return new t(e, 0 /* INVALID */ , ct.min(), Gt.empty(), 0 /* SYNCED */);
    }, 
    /**
    ...
    if (null === e.A) {
        ...
        null !== e.collectionGroup && (n += "|cg:" + e.collectionGroup), n += "|f:", n += e.filters.map((function(t) {
            return function(t) {
                ...
                return t.field.canonicalString() + t.op.toString() + Ft(t.value);
            }(t);
        ...
        n += ce(e.startAt)), e.endAt && (n += "|ub:", n += ce(e.endAt)), e.A = n;
    }
    return e.A;
}
...
function Xt(t, e) {
    ...
    i.op !== o.op || !i.field.isEqual(o.field) || !Lt(i.value, o.value)) return !1;
    var i, o;
...
var $t = /** @class */ function(e) {
     ...
     */    return t(n, e), n.create = function(t, e, r) {
        return t.isKeyField() ? "in" /* IN */ === e || "not-in" /* NOT_IN */ === e ? this.R(t, e, r) : new te(t, e, r) : "array-contains" /* ARRAY_CONTAINS */ === e ? new ie(t, r) : "in" /* IN */ === e ? new oe(t, r) : "not-in" /* NOT_IN */ === e ? new se(t, r) : "array-contains-any" /* ARRAY_CONTAINS_ANY */ === e ? new ue(t, r) : new n(t, e, r);
    }, n.R = function(t, e, n) {
        return "in" /* IN */ === e ? new ee(t, n) : new ne(t, n);
    }, n.prototype.matches = function(t) {
        var e = t.data.field(this.field);
        // Types do not have to match in NOT_EQUAL filters.
                return "!=" /* NOT_EQUAL */ === this.op ? null !== e && this.P(Ot(e, this.value)) : null !== e && xt(this.value) === xt(e) && this.P(Ot(e, this.value));
...
/** A Filter that implements the array-contains operator. */ var ie = /** @class */ function(e) {
    function n(t, n) {
    ...
    return t(n, e), n.prototype.matches = function(t) {
        ...
        return !(!Ut(n) || !n.arrayValue.values) && n.arrayValue.values.some((function(t) {
...
/** A Filter that implements the IN operator. */ function ce(t) {
    // TODO(b/29183165): Make this collision robust.
 ...
 */ function le(t, e, n) {
    for (var r = 0, i = 0; i < t.position.length; i++) {
        ...
        if (r = o.field.isKeyField() ? Ct.comparator(Ct.fromName(s.referenceValue), n.key) : Ot(s, n.data.field(o.field)), 
...
/** Creates a new Query instance with the options provided. */ function ye(t, e, n, r, i, o, s, u) {
    return new pe(t, e, n, r, i, o, s, u);
}
 ...
 */ function Ee(t) {
    var e = Q(t);
    if (!e.S) if ("F" /* First */ === e.limitType) e.S = Yt(e.path, e.collectionGroup, Te(e), e.filters, e.limit, e.startAt, e.endAt); else {
        for (
        // Flip the orderBy directions since we want the last results
        var n = [], r = 0, i = Te(e); r < i.length; r++) {
            var o = i[r], s = "desc" /* DESCENDING */ === o.dir ? "asc" /* ASCENDING */ : "desc" /* DESCENDING */;
            n.push(new he(o.field, s));
        }
        // We need to swap the cursors to match the now-flipped query ordering.
                var u = e.endAt ? new ae(e.endAt.position, !e.endAt.before) : null, a = e.startAt ? new ae(e.startAt.position, !e.startAt.before) : null;
        // Now return as a LimitType.First query.
                e.S = Yt(e.path, e.collectionGroup, n, e.filters, e.limit, u, a);
    }
    return e.S;
}
...
function Ne(t, e) {
    return Xt(Ee(t), Ee(e)) && t.limitType === e.limitType;
}
...
function De(t) {
    return "Query(target=" + function(t) {
        ...
        t.filters.length > 0 && (e += ", filters: [" + t.filters.map((function(t) {
            return (e = t).field.canonicalString() + " " + e.op + " " + Ft(e.value);
        ...
        })).join(", ") + "]"), t.startAt && (e += ", startAt: " + ce(t.startAt)), t.endAt && (e += ", endAt: " + ce(t.endAt)), 
        "Target(" + e + ")";
    }(Ee(t)) + "; limitType=" + t.limitType + ")";
}

/** Returns whether `doc` matches the constraints of `query`. */ function Ae(t, e) {
    return e.isFoundDocument() && function(t, e) {
        ...
        return !(t.startAt && !le(t.startAt, Te(t), e)) && (!t.endAt || !le(t.endAt, Te(t), e));
    }(t, e);
}
 ...
 */ function Pe(t, e, n) {
    return t instanceof Ve ? function(t, e) {
        ...
        var n = Me(t, e), r = ze(n) + ze(t.C);
        return qt(n) && qt(t.C) ? Le(r) : xe(t.N, r);
    }(t, e);
}
...
/** Transforms an array value via a union operation. */ function Ue(t, e) {
...
function Ge(t) {
    return Ut(t) && t.arrayValue.values ? t.arrayValue.values.slice() : [];
}
 ...
 * limitations under the License.
 */
/** A field path and the TransformOperation to perform upon it. */ var Qe = function(t, e) {
 ...
 */ function Xe(t, e, n) {
    t instanceof nn ? function(t, e, n) {
        ...
        // must have held.
        var r = t.value.clone(), i = sn(t.fieldTransforms, e, n.transformResults);
        ...
        if (Ye(t.precondition, e)) {
            var r = sn(t.fieldTransforms, e, n.transformResults), i = e.data;
            i.setAll(on(t)), i.setAll(r), e.convertToFoundDocument(n.version, i).setHasCommittedMutations();
 ...
 */ function Ze(t, e, n) {
    t instanceof nn ? function(t, e, n) {
        if (Ye(t.precondition, e)) {
            var r = t.value.clone(), i = un(t.fieldTransforms, n, e);
            r.setAll(i), e.convertToFoundDocument(en(e), r).setHasLocalMutations();
        }
    }(t, e, n) : t instanceof rn ? function(t, e, n) {
        if (Ye(t.precondition, e)) {
            var r = un(t.fieldTransforms, n, e), i = e.data;
            i.setAll(on(t)), i.setAll(r), e.convertToFoundDocument(en(e), i).setHasLocalMutations();
        }
    }(t, e, n) : function(t, e) {
        Ye(t.precondition, e) && 
 ...
 */ function $e(t, e) {
    for (var n = null, r = 0, i = t.fieldTransforms; r < i.length; r++) {
        var o = i[r], s = e.data.field(o.field), u = Me(o.transform, s || null);
...
/** A mutation that deletes the document at the given key. */ var an, cn, hn = /** @class */ function(e) {
    function n(t, n) {
        var r = this;
 ...
 */ function pn(t) {
    ...
    return U("GRPC error has no .code"), H.UNKNOWN;
    switch (t) {
      case an.OK:
        return H.OK;
      ...
      case an.ALREADY_EXISTS:
        return H.ALREADY_EXISTS;

      case an.PERMISSION_DENIED:
        return H.PERMISSION_DENIED;

      case an.FAILED_PRECONDITION:
        return H.FAILED_PRECONDITION;

      case an.ABORTED:
        return H.ABORTED;

      case an.OUT_OF_RANGE:
        return H.OUT_OF_RANGE;

      case an.UNIMPLEMENTED:
 ...
 *     Code.UNKNOWN.
 */ (cn = an || (an = {}))[cn.OK = 0] = "OK", cn[cn.CANCELLED = 1] = "CANCELLED", 
...
var yn = /** @class */ function() {
    ...
    // Returns a copy of the map, with the specified key/value added or replaced.
        ...
        return new t(this.comparator, this.root.insert(e, n, this.comparator).copy(null, null, mn.BLACK, null, null));
    }, 
    // Returns a copy of the map, with the specified key removed.
    t.prototype.remove = function(e) {
        return new t(this.comparator, this.root.remove(e, this.comparator).copy(null, null, mn.BLACK, null, null));
    }, 
    ...
    t.prototype.getIterator = function() {
        return new vn(this.root, null, this.comparator, !1);
    }, t.prototype.getIteratorFrom = function(t) {
        return new vn(this.root, t, this.comparator, !1);
    }, t.prototype.getReverseIterator = function() {
        return new vn(this.root, null, this.comparator, !0);
    }, t.prototype.getReverseIteratorFrom = function(t) {
        return new vn(this.root, t, this.comparator, !0);
    }, t;
}(), vn = /** @class */ function() {
    function t(t, e, n, r) {
...
var gn = /** @class */ function() {
    ...
    /** Finds the least element greater than or equal to `elem`. */ t.prototype.firstAfterOrEqual = function(t) {
        ...
        return new wn(this.data.getIterator());
    }, t.prototype.getIteratorFrom = function(t) {
        return new wn(this.data.getIteratorFrom(t));
    }, 
...
}(), bn = new yn(Ct.comparator);

function In() {
    return bn;
}

var Tn = new yn(Ct.comparator);

function En() {
    return Tn;
}

var Sn = new yn(Ct.comparator);

function Nn() {
    return Sn;
}

var _n = new gn(Ct.comparator);

function Dn() {
    for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
    for (var n = _n, r = 0, i = t; r < i.length; r++) {
        var o = i[r];
        n = n.add(o);
    }
    return n;
 ...
 */ var Cn = /** @class */ function() {
    ...
    // PORTING NOTE: Multi-tab only
        ...
        var r = new Map;
        return r.set(e, xn.createSynthesizedTargetChangeForCurrentChange(e, n)), new t(ct.min(), r, kn(), In(), Dn());
    }, t;
}(), xn = /** @class */ function() {
    function t(
    /**
    ...
    return t.createSynthesizedTargetChangeForCurrentChange = function(e, n) {
        return new t(wt.EMPTY_BYTE_STRING, n, Dn(), Dn(), Dn());
    }, t;
}(), Ln = function(
...
/** An RPC error indicating why the watch failed. */ , r) {
    void 0 === n && (n = wt.EMPTY_BYTE_STRING), void 0 === r && (r = null), this.state = t, 
    ...
    return t.prototype.rt = function(t) {
        for (var e = 0, n = t.k; e < n.length; e++) {
            var r = n[e];
            t.$ && t.$.isFoundDocument() ? this.ot(r, t.$) : this.ct(r, t.key, t.$);
        }
    ...
    /** Processes and adds the WatchTargetChange to the current set of changes. */ t.prototype.at = function(t) {
        var e = this;
    ...
    t.prototype.ft = function(t) {
        ...
        if (r) {
            ...
            if (Zt(i)) if (0 === n) {
                ...
                // queries.
                var o = new Ct(i.path);
                this.ct(e, o, Ht.newNoDocument(o, ct.min()));
            } else z(1 === n); else this.wt(e) !== n && (
    ...
    t.prototype._t = function(t) {
        ...
        this.et.forEach((function(r, i) {
            ...
            if (o) {
                if (r.current && Zt(o.target)) {
                    ...
                    null !== e.nt.get(s) || e.gt(i, s) || e.ct(i, s, Ht.newNoDocument(s, t));
                }
                r.K && (n.set(i, r.W()), r.G());
            }
        }));
        ...
        var i = new Cn(t, n, this.it, this.nt, r);
        return this.nt = In(), this.st = Mn(), this.it = new gn(ot), i;
    }, 
    /**
    ...
    t.prototype.Y = function(t) {
        ...
        var e = this.et.get(t);
        return e || (e = new Pn, this.et.set(t, e)), e;
    }, t.prototype.yt = function(t) {
        var e = this.st.get(t);
        return e || (e = new gn(ot), this.st = this.st.insert(t, e)), e;
    }, 
    /**
    ...
    t.prototype.lt = function(t) {
        var e = this;
        this.et.set(t, new Pn), this.tt.getRemoteKeysForTarget(t).forEach((function(n) {
...
function er(t, e, n) {
    var r = Yn(t, e.name), i = Gn(e.updateTime), o = new Gt({
        mapValue: {
            fields: e.fields
        }
    }), s = Ht.newFoundDocument(r, i, o);
...
function rr(t, e) {
    var n = e.currentDocument ? function(t) {
        return void 0 !== t.updateTime ? We.updateTime(Gn(t.updateTime)) : void 0 !== t.exists ? We.exists(t.exists) : We.none();
    }(e.currentDocument) : We.none(), r = e.updateTransforms ? e.updateTransforms.map((function(e) {
        return function(t, e) {
            var n = null;
            if ("setToServerValue" in e) z("REQUEST_TIME" === e.setToServerValue), n = new Ve; else if ("appendMissingElements" in e) {
    ...
    if (e.update) {
        e.update.name;
        var i = Yn(t, e.update.name), o = new Gt({
            mapValue: {
        ...
        if (e.updateMask) {
            var s = function(t) {
                var e = t.fieldPaths || [];
                return new mt(e.map((function(t) {
                    return vt.fromServerFormat(t);
                })));
            }(e.updateMask);
            return new rn(i, o, s, n, r);
        }
        return new nn(i, o, n, r);
    }
    if (e.delete) {
        var u = Yn(t, e.delete);
        return new hn(u, n);
...
function or(t, e) {
    ...
    null !== e.collectionGroup ? (n.parent = Jn(t, r), n.structuredQuery.from = [ {
        ...
        allDescendants: !0
    } ]) : (n.parent = Jn(t, r.popLast()), n.structuredQuery.from = [ {
    ...
    return null !== s && (n.structuredQuery.limit = s), e.startAt && (n.structuredQuery.startAt = ar(e.startAt)), 
    e.endAt && (n.structuredQuery.endAt = ar(e.endAt)), n;
}

function sr(t) {
    var e = Xn(t.parent), n = t.structuredQuery, r = n.from ? n.from.length : 0, i = null;
    if (r > 0) {
        z(1 === r);
        var o = n.from[0];
    ...
    var s = [];
    n.where && (s = ur(n.where));
    var u = [];
    n.orderBy && (u = n.orderBy.map((function(t) {
        return function(t) {
            return new he(dr(t.field), 
            // visible for testing
            function(t) {
                switch (t) {
                  case "ASCENDING":
    ...
    var c = null;
    n.startAt && (c = cr(n.startAt));
    var h = null;
    return n.endAt && (h = cr(n.endAt)), ye(e, i, u, s, a, "F" /* First */ , c, h);
}

function ur(t) {
    return t ? void 0 !== t.unaryFilter ? [ yr(t) ] : void 0 !== t.fieldFilter ? [ pr(t) ] : void 0 !== t.compositeFilter ? t.compositeFilter.filters.map((function(t) {
        return ur(t);
    })).reduce((function(t, e) {
        return t.concat(e);
    })) : K() : [];
...
function dr(t) {
    return vt.fromServerFormat(t.fieldPath);
}
 ...
 */ function gr(t) {
    for (var e = "", n = 0; n < t.length; n++) e.length > 0 && (e = br(e)), e = wr(t.get(n), e);
    return br(e);
}
...
/** Name of the IndexedDb object store.  */ Nr.store = "mutations", 
/** Keys are automatically assigned via the userId, batchId properties. */
Nr.keyPath = "batchId", 
/** The index name for lookup of mutations by user. */
Nr.userMutationsIndex = "userMutationsIndex", 
/** The user mutations index is keyed by [userId, batchId] pairs. */
Nr.userMutationsKeyPath = [ "userId", "batchId" ];
...
/**
     ...
     */
kr.readTimeIndex = "readTimeIndex", kr.readTimeIndexPath = "readTime", 
/**
     ...
     */
kr.collectionReadTimeIndex = "collectionReadTimeIndex", kr.collectionReadTimeIndexPath = [ "parentPath", "readTime" ];
...
xr.queryTargetsIndexName = "queryTargetsIndex", 
/**
     * The index of all canonicalIds to the targets that they match. This is not
     * a unique mapping because canonicalId does not promise a unique name for all
     * possible queries, so we append the targetId to make the mapping unique.
     */
xr.queryTargetsKeyPath = [ "canonicalId", "targetId" ];
...
/** Name of the IndexedDb object store. */ Or.store = "collectionParents", 
/** Keys are automatically assigned via the collectionId, parent properties. */
Or.keyPath = [ "collectionId", "parent" ];
...
/** Name of the IndexedDb object store. */ Mr.store = "namedQueries", Mr.keyPath = "name";

// Visible for testing
var Vr = e(e([], e(e([], e(e([], e(e([], [ Sr.store, Nr.store, _r.store, kr.store, xr.store, Er.store, Rr.store, Lr.store ]), [ Pr.store ])), [ Cr.store ])), [ Or.store ])), [ Fr.store, Mr.store ]), qr = "The current tab is not in the required state to perform this operation. It might be necessary to refresh the browser tab.", Ur = /** @class */ function() {
    function t() {
    ...
    function t(t, e) {
        ...
        /**
             ...
             */
        this.Et = new Y, this.transaction.oncomplete = function() {
            n.Et.resolve();
        }, this.transaction.onabort = function() {
            e.error ? n.Et.reject(new Gr(t, e.error)) : n.Et.resolve();
        }, this.transaction.onerror = function(e) {
            var r = Jr(e.target.error);
            n.Et.reject(new Gr(t, r));
        };
    }
    return t.open = function(e, n, r, i) {
        ...
        t && this.Et.reject(t), this.aborted || (q("SimpleDb", "Aborting transaction:", t ? t.message : "Client-initiated abort"), 
    ...
    function t(e, n, r) {
        ...
        // log on 12.2.
        12.2 === t.Rt(l()) && U("Firestore persistence suffers from a bug in iOS 12.2 Safari that may cause your app to stop working. See https://stackoverflow.com/q/56496296/110915 for details and a potential workaround.");
    }
    /** Deletes the specified database. */    return t.delete = function(t) {
        return q("SimpleDb", "Removing database:", t), Wr(window.indexedDB.deleteDatabase(t)).toPromise();
    }, 
                    ...
                    n = "readonly" === e, s = 0, u = function() {
                        ...
                        return r(this, (function(r) {
                            switch (r.label) {
                              ...
                              case 1:
                                return r.trys.push([ 1, 4, , 5 ]), [ 4 /*yield*/ , a.Dt(t) ];

                              case 2:
                                // Wait for the transaction to complete (i.e. IndexedDb's onsuccess event to
                                // fire), but still return the original transactionFnResult back to the
                                // caller.
                                return a.db = r.sent(), e = jr.open(a.db, t, n ? "readonly" : "readwrite", i), u = o(e).catch((function(t) {
                                    // Abort the transaction if there was an error.
                                    return e.abort(t), Br.reject(t);
                                })).toPromise(), c = {}, u.catch((function() {})), [ 4 /*yield*/ , e.It ];
 ...
 * on persistence.
 */
/** Verifies whether `e` is an IndexedDbTransactionError. */ function Qr(t) {
 ...
 */ var Hr = /** @class */ function() {
    ...
    t.prototype.add = function(t) {
        return q("SimpleDb", "ADD", this.store.name, t, t), Wr(this.store.add(t));
    }, 
    /**
    ...
    t.prototype.get = function(t) {
        ...
        return q("SimpleDb", "DELETE", this.store.name, t), Wr(this.store.delete(t));
    }, 
    /**
    ...
    t.prototype.count = function() {
        return q("SimpleDb", "COUNT", this.store.name), Wr(this.store.count());
    ...
    t.prototype.jt = function(t) {
        ...
        return new Br((function(r, i) {
            t.onerror = function(t) {
                ...
                if (i) {
                    var o = new zr(i), s = e(i.primaryKey, i.value, o);
                    if (s instanceof Br) {
...
function Jr(t) {
    ...
    if (e >= 12.2 && e < 13) {
        ...
        if (t.message.indexOf(n) >= 0) {
            ...
            var r = new W("internal", "IOS_INDEXEDDB_BUG1: IndexedDb has thrown '" + n + "'. This is likely due to an unavoidable bug in iOS. See https://stackoverflow.com/q/56496296/110915 for details and a potential workaround.");
            return Yr || (Yr = !0, 
 ...
 */ var $r = /** @class */ function() {
    ...
    return t.prototype.applyToRemoteDocument = function(t, e) {
        for (var n = e.mutationResults, r = 0; r < this.mutations.length; r++) {
            ...
            i.key.isEqual(t.key) && Xe(i, t, n[r]);
        }
    }, 
    /**
    ...
    t.prototype.applyToLocalDocumentSet = function(t) {
        ...
        // to O(n).
            ...
            // and we should remove this cast.
                        e.applyToLocalView(i), r.isValidDocument() || i.convertToNoDocument(ct.min());
        }));
        ...
        return this.batchId === t.batchId && st(this.mutations, t.mutations, (function(t, e) {
            return tn(t, e);
        })) && st(this.baseMutations, t.baseMutations, (function(t, e) {
            return tn(t, e);
        }));
    }, t;
}(), ti = /** @class */ function() {
     ...
     * time from which the server should resume sending results.
     */ , s) {
        void 0 === i && (i = ct.min()), void 0 === o && (o = ct.min()), void 0 === s && (s = wt.EMPTY_BYTE_STRING), 
...
/** Decodes a remote document from storage locally to a Document. */ function ri(t, e) {
    if (e.document) return er(t.Wt, e.document, !!e.hasCommittedMutations);
    if (e.noDocument) {
        var n = Ct.fromSegments(e.noDocument.path), r = ai(e.noDocument.readTime), i = Ht.newNoDocument(n, r);
        return e.hasCommittedMutations ? i.setHasCommittedMutations() : i;
    }
    if (e.unknownDocument) {
        var o = Ct.fromSegments(e.unknownDocument.path), s = ai(e.unknownDocument.version);
...
/** Encodes a document for storage locally. */ function ii(t, e, n) {
    var r = oi(n), i = e.key.path.popLast().toArray();
    ...
    if (e.isNoDocument()) {
        var u = e.key.path.toArray(), a = ui(e.version), c = e.hasCommittedMutations;
        return new kr(
        /* unknownDocument= */ null, new Dr(u, a), 
        /* document= */ null, c, r, i);
    }
    if (e.isUnknownDocument()) {
        var h = e.key.path.toArray(), f = ui(e.version);
        return new kr(new Ar(h, f), 
        /* noDocument= */ null, 
        /* document= */ null, 
...
/** Decodes a DbMutationBatch into a MutationBatch */ function ci(t, e) {
    ...
    var s = e.mutations.map((function(e) {
        return rr(t.Wt, e);
    })), u = at.fromMillis(e.localWriteTimeMs);
    return new $r(e.batchId, u, n, s);
}

/** Decodes a DbTarget into TargetData */ function hi(t) {
    var e, n, r = ai(t.readTime), i = void 0 !== t.lastLimboFreeSnapshotVersion ? ai(t.lastLimboFreeSnapshotVersion) : ct.min();
    return void 0 !== t.query.documents ? (z(1 === (n = t.query).documents.length), 
    e = Ee(ve(Xn(n.documents[0])))) : e = function(t) {
        return Ee(sr(t));
    }(t.query), new ei(e, t.targetId, 0 /* Listen */ , t.lastListenSequenceNumber, r, i, wt.fromBase64String(t.resumeToken))
    /** Encodes TargetData into a DbTarget for storage locally. */;
}

function fi(t, e) {
    var n, r = ui(e.snapshotVersion), i = ui(e.lastLimboFreeSnapshotVersion);
    n = Zt(e.target) ? ir(t.Wt, e.target) : or(t.Wt, e.target);
    // We can't store the resumeToken as a ByteString in IndexedDb, so we
    // convert it to a base64 string for storage.
    var o = e.resumeToken.toBase64();
    // lastListenSequenceNumber is always 0 until we do real GC.
        return new xr(e.targetId, Jt(e.target), r, o, e.sequenceNumber, i, n);
}
 ...
 */ var vi = /** @class */ function() {
    ...
    return t.prototype.addToCollectionParentIndex = function(t, e) {
        return this.Gt.add(e), Br.resolve();
    }, t.prototype.getCollectionParents = function(t, e) {
        return Br.resolve(this.Gt.getEntries(e));
    }, t;
}(), mi = /** @class */ function() {
    function t() {
        this.index = {};
    ...
    // Returns false if the entry already existed.
        ...
        var e = t.lastSegment(), n = t.popLast(), r = this.index[e] || new gn(pt.comparator), i = !r.has(n);
        return this.index[e] = r.add(n), i;
    }, t.prototype.has = function(t) {
        var e = t.lastSegment(), n = t.popLast(), r = this.index[e];
        return r && r.has(n);
    }, t.prototype.getEntries = function(t) {
        return (this.index[t] || new gn(pt.comparator)).toArray();
    }, t;
}(), gi = /** @class */ function() {
    function t() {
        /**
     ...
     */    return t.prototype.addToCollectionParentIndex = function(t, e) {
        ...
        /*lowerOpen=*/ !1, 
        /*upperOpen=*/ !0);
        return wi(t).Lt(r).next((function(t) {
 ...
 */
function Ti(t, e, n) {
    var r = t.store(Nr.store), i = t.store(_r.store), o = [], s = IDBKeyRange.only(n.batchId), u = 0, a = r.Kt({
        range: s
    }, (function(t, e, n) {
        return u++, n.delete();
    }));
    ...
    for (var c = [], h = 0, f = n.mutations; h < f.length; h++) {
        var l = f[h], d = _r.key(e, l.key.path, n.batchId);
...
var Si = /** @class */ function() {
    ...
    return t.Yt = function(e, n, r, i) {
        ...
        return s.add({}).next((function(u) {
            z("number" == typeof u);
            for (var a = new $r(u, e, n, r), c = function(t, e, n) {
                var r = n.baseMutations.map((function(e) {
                    return nr(t.Wt, e);
                })), i = n.mutations.map((function(e) {
                    return nr(t.Wt, e);
                }));
                return new Nr(e, n.batchId, n.localWriteTime.toMillis(), r, i);
            }(i.N, i.userId, a), h = [], f = new gn((function(t, e) {
                return ot(t.canonicalString(), e.canonicalString());
            })), l = 0, d = r; l < d.length; l++) {
                var p = d[l], y = _r.key(i.userId, p.key.path, u);
                f = f.add(p.key.path.popLast()), h.push(s.put(c)), h.push(o.put(y, _r.PLACEHOLDER));
            }
        ...
        return _i(t).get(e).next((function(t) {
            return t ? (z(t.userId === n.userId), ci(n.N, t)) : null;
        }));
    }, 
    /**
    ...
    t.prototype.Xt = function(t, e) {
        var n = this;
        return this.Jt[e] ? Br.resolve(this.Jt[e]) : this.lookupMutationBatch(t, e).next((function(t) {
            if (t) {
                var r = t.keys();
                return n.Jt[e] = r, r;
            }
        ...
        return _i(t).Kt({
            ...
            e.userId === n.userId && (z(e.batchId >= r), o = ci(n.N, e)), i.done();
        })).next((function() {
            return o;
        }));
        ...
        return _i(t).Lt(Nr.userMutationsIndex, n).next((function(t) {
            return t.map((function(t) {
                return ci(e.N, t);
            }));
        }));
    }, t.prototype.getAllMutationBatchesAffectingDocumentKey = function(t, e) {
        var n = this, r = _r.prefixForPath(this.userId, e.path), i = IDBKeyRange.lowerBound(r), o = [];
        ...
        var n = this, r = new gn(ot), i = [];
        return e.forEach((function(e) {
            var o = _r.prefixForPath(n.userId, e.path), s = IDBKeyRange.lowerBound(o), u = Di(t).Kt({
                range: s
            }, (function(t, i, o) {
        ...
        var n = this, r = e.path, i = r.length + 1, o = _r.prefixForPath(this.userId, r), s = IDBKeyRange.lowerBound(o), u = new gn(ot);
        return Di(t).Kt({
            range: s
        }, (function(t, e, o) {
        ...
        var n = this;
        return Ti(t.Qt, this.userId, e).next((function(r) {
    ...
    t.prototype.te = function(t) {
        ...
        return this.checkEmpty(t).next((function(n) {
            ...
            // the queue is empty.
                        var r = IDBKeyRange.lowerBound(_r.prefixForUser(e.userId)), i = [];
            return Di(t).Kt({
                range: r
            }, (function(t, n, r) {
                if (t[0] === e.userId) {
 ...
 */ function Ni(t, e, n) {
    var r = _r.prefixForPath(e, n.path), i = r[1], o = IDBKeyRange.lowerBound(r), s = !1;
    return Di(t).Kt({
        range: o,
        qt: !0
    }, (function(t, n, r) {
 ...
 */ var ki = /** @class */ function() {
    ...
    // out to have a meaningful performance impact.
        ...
        return this.re(t).next((function(t) {
            return ct.fromTimestamp(new at(t.lastRemoteSnapshotVersion.seconds, t.lastRemoteSnapshotVersion.nanoseconds));
        }));
        ...
        return this.ce(t, e).next((function() {
            return n.re(t).next((function(r) {
                return r.targetCount += 1, n.ae(e, r), n.oe(t, r);
            }));
        }));
        ...
        return this.removeMatchingKeysForTargetId(t, e.targetId).next((function() {
            ...
            return z(e.targetCount > 0), e.targetCount -= 1, n.oe(t, e);
        }));
    }, 
    /**
     ...
     */
    t.prototype.forEachTarget = function(t, e) {
        return xi(t).Kt((function(t, n) {
            var r = hi(n);
            e(r);
        }));
    }, t.prototype.re = function(t) {
        return Li(t).get(Rr.key).next((function(t) {
            return z(null !== t), t;
        }));
    }, t.prototype.oe = function(t, e) {
        return Li(t).put(Rr.key, e);
    }, t.prototype.ce = function(t, e) {
        return xi(t).put(fi(this.N, e));
    }, 
    /**
    ...
    t.prototype.ae = function(t, e) {
        ...
        var n = Jt(e), r = IDBKeyRange.bound([ n, Number.NEGATIVE_INFINITY ], [ n, Number.POSITIVE_INFINITY ]), i = null;
        return xi(t).Kt({
            range: r,
            index: xr.queryTargetsIndexName
        }, (function(t, n, r) {
            var o = hi(n);
            // After finding a potential match, check that the target is
            // actually equal to the requested target.
                        Xt(e, o.target) && (i = o, r.done());
        })).next((function() {
            return i;
        }));
        ...
        /*lowerOpen=*/ !1, 
        /*upperOpen=*/ !0), r = Ri(t), i = Dn();
        return r.Kt({
            range: n,
            qt: !0
        }, (function(t, e, n) {
            var r = Ir(t[1]), o = new Ct(r);
            i = i.add(o);
        })).next((function() {
            return i;
        }));
    }, t.prototype.containsKey = function(t, e) {
        var n = gr(e.path), r = IDBKeyRange.bound([ n ], [ ut(n) ], 
        /*lowerOpen=*/ !1, 
        /*upperOpen=*/ !0), i = 0;
        return Ri(t).Kt({
 ...
 */ function Oi(t) {
    return n(this, void 0, void 0, (function() {
        return r(this, (function(e) {
            if (t.code !== H.FAILED_PRECONDITION || t.message !== qr) throw t;
 ...
 * limitations under the License.
 */ function Pi(t, e) {
    var n = t[0], r = t[1], i = e[0], o = e[1], s = ot(n, i);
    return 0 === s ? ot(r, o) : s;
}
 ...
 */ var Fi = /** @class */ function() {
    function t(t) {
        this.ue = t, this.buffer = new gn(Pi), this.he = 0;
    }
    ...
    return t.prototype.start = function(t) {
        ...
        q("LruGarbageCollector", "Garbage collection scheduled in " + i + "ms"), this.we = this.asyncQueue.enqueueAfterDelay("lru_garbage_collection" /* LruGarbageCollection */ , i, (function() {
            return n(e, void 0, void 0, (function() {
                ...
                return r(this, (function(n) {
                    switch (n.label) {
                      ...
                      case 3:
                        return Qr(e = n.sent()) ? (q("LruGarbageCollector", "Ignoring IndexedDB error during garbage collection: ", e), 
                        [ 3 /*break*/ , 6 ]) : [ 3 /*break*/ , 4 ];
    ...
    return t.prototype.calculateTargetCount = function(t, e) {
        ...
        Br.resolve(bi)) : this.getCacheSize(t).next((function(r) {
        ...
        return this.calculateTargetCount(t, this.params.percentileToCollect).next((function(e) {
            ...
            return a = Date.now(), M() <= f.DEBUG && q("LruGarbageCollector", "LRU Garbage Collection\n\tCounted targets in " + (o - h) + "ms\n\tDetermined least recently used " + r + " in " + (s - o) + "ms\n\tRemoved " + i + " targets in " + (u - s) + "ms\n\tRemoved " + t + " documents in " + (a - u) + "ms\nTotal Duration: " + (a - h) + "ms"), 
            Br.resolve({
                didRun: !0,
    ...
    t.prototype.Ie = function(t, e) {
        ...
        return this.Ee(t, (function(s, u) {
            if (u <= e) {
                var a = n.Ie(t, s).next((function(e) {
                    if (!e) 
                    // Our size accounting requires us to read all documents before
                    // removing them.
                    return o++, r.getEntry(t, s).next((function() {
                        return r.removeEntry(s), Ri(t).delete([ 0, gr(s.path) ]);
                    }));
                }));
                i.push(a);
            }
 ...
 */ var Bi = /** @class */ function() {
    ...
    t.prototype.removeEntry = function(t, e) {
        void 0 === e && (e = null), this.assertNotApplied(), this.changes.set(t, {
            document: Ht.newInvalidDocument(t),
            readTime: e
        });
    }, 
    /**
    ...
    t.prototype.updateMetadata = function(t, e) {
        ...
        var n = this;
        return Qi(t).get(Hi(e)).next((function(t) {
            return n.Re(e, t);
        }));
    }, 
    /**
    ...
    t.prototype.ve = function(t, e) {
        var n = this, r = In(), i = new yn(Ct.comparator);
        return this.Pe(t, e, (function(t, e) {
            var o = n.Re(t, e);
            r = r.insert(t, o), i = i.insert(t, Ei(e));
        })).next((function() {
            return {
                documents: r,
                Ve: i
        ...
        var r = this, i = In(), o = e.path.length + 1, s = {};
        if (n.isEqual(ct.min())) {
            ...
            var a = e.path.toArray(), c = oi(n);
            s.range = IDBKeyRange.lowerBound([ a, c ], 
            /* open= */ !0), s.index = kr.collectionReadTimeIndex;
        }
        return Qi(t).Kt(s, (function(t, n, s) {
            ...
            if (t.length === o) {
                var u = ri(r.N, n);
                e.path.isPrefixOf(u.key.path) ? Ae(e, u) && (i = i.insert(u.key, u)) : s.done();
            }
        })).next((function() {
            return i;
        }));
    }, t.prototype.newChangeBuffer = function(t) {
        return new zi(this, !!t && t.trackRemovals);
    }, t.prototype.getSize = function(t) {
        return this.getMetadata(t).next((function(t) {
            return t.byteSize;
        }));
    }, t.prototype.getMetadata = function(t) {
        return Gi(t).get(Cr.key).next((function(t) {
            return z(!!t), t;
        }));
    }, t.prototype.Ae = function(t, e) {
        return Gi(t).put(Cr.key, e);
    }, 
    /**
    ...
    t.prototype.Re = function(t, e) {
        ...
        return Ht.newInvalidDocument(t);
    }, t;
}(), zi = /** @class */ function(e) {
    /**
 ...
 * limitations under the License.
 */
/** Performs database creation and schema upgrades. */ var Wi = /** @class */ function() {
    function t(t) {
        this.N = t;
    }
    /**
     ...
     */    return t.prototype.Ct = function(t, e, n, r) {
        ...
        n < 1 && r >= 1 && (function(t) {
            ...
            t.createObjectStore(Sr.store, {
                ...
                keyPath: Nr.keyPath,
                autoIncrement: !0
            }).createIndex(Nr.userMutationsIndex, Nr.userMutationsKeyPath, {
                unique: !0
        ...
        0 !== n && (function(t) {
            t.deleteObjectStore(Lr.store), t.deleteObjectStore(xr.store), t.deleteObjectStore(Rr.store);
     ...
     */
            return function(t) {
                var e = t.store(Rr.store), n = new Rr(
                /*highestTargetId=*/ 0, 
        ...
        s = s.next((function() {
            return function(t, e) {
                return e.store(Nr.store).Lt().next((function(n) {
                    t.deleteObjectStore(Nr.store), t.createObjectStore(Nr.store, {
                        keyPath: Nr.keyPath,
                        autoIncrement: !0
                    }).createIndex(Nr.userMutationsIndex, Nr.userMutationsKeyPath, {
                        unique: !0
                    });
                    var r = e.store(Nr.store), i = n.map((function(t) {
                        return r.put(t);
                    }));
                    return Br.waitFor(i);
                }));
            ...
            !function(t) {
                ...
                e.createIndex(kr.readTimeIndex, kr.readTimeIndexPath, {
                    unique: !1
                }), e.createIndex(kr.collectionReadTimeIndex, kr.collectionReadTimeIndexPath, {
                    unique: !1
                });
            }(e);
        ...
        var e = 0;
        return t.store(kr.store).Kt((function(t, n) {
            e += Ei(n);
        })).next((function() {
            var n = new Cr(e);
        ...
        var e = this, n = t.store(Sr.store), r = t.store(Nr.store);
        return n.Lt().next((function(n) {
            return Br.forEach(n, (function(n) {
                var i = IDBKeyRange.bound([ n.userId, -1 ], [ n.userId, n.lastAcknowledgedBatchId ]);
                return r.Lt(Nr.userMutationsIndex, i).next((function(r) {
    ...
    t.prototype.xe = function(t) {
        var e = t.store(Lr.store), n = t.store(kr.store);
        return t.store(Rr.store).get(Rr.key).next((function(t) {
            var r = [];
            return n.Kt((function(n, i) {
                var o = new pt(n), s = function(t) {
                    return [ 0, gr(t) ];
                }(o);
                r.push(e.get(s).next((function(n) {
                    return n ? Br.resolve() : function(n) {
                        return e.put(new Lr(0, gr(n), t.highestListenSequenceNumber));
                    }(o);
                })));
            })).next((function() {
                return Br.waitFor(r);
        ...
        var n = e.store(Or.store), r = new mi, i = function(t) {
            if (r.add(t)) {
        ...
        // Index existing remote documents.
                return e.store(kr.store).Kt({
            qt: !0
        }, (function(t, e) {
            var n = new pt(t);
            return i(n.popLast());
        })).next((function() {
            return e.store(_r.store).Kt({
                qt: !0
            }, (function(t, e) {
                t[0];
                var n = t[1];
        ...
        var e = this, n = t.store(xr.store);
        return n.Kt((function(t, r) {
            var i = hi(r), o = fi(e.N, i);
            return n.put(o);
        }));
    }, t;
}();
...
function Yi(t) {
    ...
    t.createObjectStore(xr.store, {
        keyPath: xr.keyPath
    }).createIndex(xr.queryTargetsIndexName, xr.queryTargetsKeyPath, {
        unique: !0
    }), t.createObjectStore(Rr.store);
}

var Ji = "Failed to obtain exclusive access to the persistence layer. To allow shared access, multi-tab synchronization has to be enabled in all tabs. If you are using `experimentalForceOwningTab:true`, make sure that only one tab has persistence enabled at any given time.", Xi = /** @class */ function() {
    function t(
    /**
    ...
    h) {
        ...
        this.Oe = o, this.window = s, this.document = u, this.Fe = c, this.Me = h, this.Le = null, 
        ...
        this.referenceDelegate = new qi(this, i), this.We = n + "main", this.N = new ni(a), 
     ...
     */    return t.prototype.start = function() {
        ...
        // do.
            ...
            throw new W(H.FAILED_PRECONDITION, Ji);
    ...
    /** Checks whether `client` is the local client. */ t.prototype.an = function(t) {
    ...
    t.prototype.rn = function(t) {
        ...
        return this.Me ? Br.resolve(!0) : Zi(t).get(Er.key).next((function(n) {
            ...
            if (null !== n && e.ln(n.leaseTimestampMs, 5e3) && !e.wn(n.ownerId)) {
                if (e.an(n) && e.networkEnabled) return !0;
                if (!e.an(n)) {
            ...
            return r(this, (function(e) {
                switch (e.label) {
                  case 0:
                    ...
                    this.gn(), [ 4 /*yield*/ , this.Ge.runTransaction("shutdown", "readwrite", [ Er.store, Pr.store ], (function(e) {
                        var n = new Xr(e, nt.T);
    ...
    t.prototype.pn = function() {
        ...
        return Si.Yt(t, this.N, this.Ht, this.referenceDelegate);
        ...
        return this.Ge.runTransaction(t, o, Vr, (function(o) {
            return i = new Xr(o, r.Le ? r.Le.next() : nt.T), "readwrite-primary" === e ? r.sn(i).next((function(t) {
                return !!t || r.rn(i);
            })).next((function(e) {
                if (!e) throw U("Failed to obtain primary lease for action '" + t + "'."), r.isPrimary = !1, 
                r.Oe.enqueueRetryable((function() {
                    return r.Qe(!1);
                })), new W(H.FAILED_PRECONDITION, qr);
                return n(i);
            })).next((function(t) {
                return r.cn(i).next((function() {
                    return t;
                }));
            })) : r.Tn(i).next((function() {
                return n(i);
            }));
        })).then((function(t) {
    ...
    t.prototype.Tn = function(t) {
        var e = this;
        return Zi(t).get(Er.key).next((function(t) {
            if (null !== t && e.ln(t.leaseTimestampMs, 5e3) && !e.wn(t.ownerId) && !e.an(t) && !(e.Me || e.allowTabSynchronization && t.allowTabSynchronization)) throw new W(H.FAILED_PRECONDITION, Ji);
        }));
    }, 
    /**
    ...
    /** Checks the primary lease and removes it if we are the current primary. */ t.prototype.on = function(t) {
        ...
        return n.get(Er.key).next((function(t) {
            return e.an(t) ? (q("IndexedDbPersistence", "Releasing primary lease."), n.delete(Er.key)) : Br.resolve();
        }));
    }, 
 ...
 */
        return function(t) {
            return Ct.isDocumentKey(t.path) && null === t.collectionGroup && 0 === t.filters.length;
        }(e) ? this.Vn(t, e.path) : Ie(e) ? this.Sn(t, e, n) : this.Dn(t, e, n);
    }, t.prototype.Vn = function(t, e) {
        // Just do a simple document lookup.
        return this.An(t, new Ct(e)).next((function(t) {
            var e = En();
        ...
        return this.Ht.getCollectionParents(t, i).next((function(s) {
            return Br.forEach(s, (function(s) {
                ...
                return r.Dn(t, u, n).next((function(t) {
                    t.forEach((function(t, e) {
                        o = o.insert(t, e);
                    }));
                }));
        ...
        // Query the remote documents and overlay mutations.
            ...
            return i = e, o.Cn(t, i, r).next((function(t) {
                ...
                for (var e = 0, n = i; e < n.length; e++) for (var o = n[e], s = 0, u = o.mutations; s < u.length; s++) {
                    ...
                    h = Ht.newInvalidDocument(c), r = r.insert(c, h)), Ze(a, h, o.localWriteTime), h.isFoundDocument() || (r = r.remove(c));
                }
            }));
        })).next((function() {
        ...
        for (var r = Dn(), i = 0, o = e; i < o.length; i++) for (var s = 0, u = o[i].mutations; s < u.length; s++) {
            var a = u[s];
    ...
    return t.kn = function(e, n) {
        for (var r = Dn(), i = Dn(), o = 0, s = n.docChanges; o < s.length; o++) {
            var u = s[o];
            switch (u.type) {
              case 0 /* Added */ :
                r = r.add(u.doc.key);
    ...
    /** Returns all local documents matching the specified query. */ t.prototype.getDocumentsMatchingQuery = function(t, e, n, r) {
        ...
        }(e) || n.isEqual(ct.min()) ? this.Fn(t, e) : this.On.Pn(t, r).next((function(o) {
            var s = i.Mn(e, o);
            return (me(e) || ge(e)) && i.Ln(e.limitType, s, r, n) ? i.Fn(t, e) : (M() <= f.DEBUG && q("QueryEngine", "Re-using previous result from %s to execute query: %s", n.toString(), De(e)), 
    ...
    t.prototype.Ln = function(t, e, n, r) {
        ...
        return M() <= f.DEBUG && q("QueryEngine", "Using full collection scan to execute query:", De(e)), 
    ...
    t, e, n, r) {
        ...
        /**
             ...
             */
        this.Kn = ct.min(), this.In = t.getMutationQueue(n), this.jn = t.getRemoteDocumentCache(), 
        this.ze = t.getTargetCache(), this.Qn = new no(this.jn, this.In, this.persistence.getIndexManager()), 
...
function uo(t, e) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                return n = Q(t), i = n.In, o = n.Qn, [ 4 /*yield*/ , n.persistence.runTransaction("Handle user change", "readonly", (function(t) {
                    ...
                    return n.In.getAllMutationBatches(t).next((function(s) {
                        ...
                        // MutationQueue.
                        o = new no(n.jn, i, n.persistence.getIndexManager()), i.getAllMutationBatches(t);
                    })).next((function(e) {
                        for (var n = [], i = [], s = Dn(), u = 0, a = r
 ...
 * queue.
 */ function ho(t, e) {
    var n = Q(t), r = e.snapshotVersion, i = n.Un;
     ...
     */
                    function(t, e, n) {
                        ...
                        return z(e.resumeToken.approximateByteSize() > 0), 0 === t.resumeToken.approximateByteSize() || (
                    ...
                    }(u, c, e) && s.push(n.ze.updateTargetData(t, c));
                }
            }
        }));
        var u = In();
        ...
        s.push(fo(t, o, e.documentUpdates, r, void 0).next((function(t) {
            u = t;
        }))), !r.isEqual(ct.min())) {
            var a = n.ze.getLastRemoteSnapshotVersion(t).next((function(e) {
...
i) {
    ...
    return n.forEach((function(t) {
        ...
        return n.forEach((function(n, s) {
            ...
            // cache.
                        s.isNoDocument() && s.version.isEqual(ct.min()) ? (
 ...
 */ function po(t, e) {
    ...
    return n.persistence.runTransaction("Allocate target", "readwrite", (function(t) {
        ...
        return n.ze.getTargetData(t, e).next((function(i) {
            ...
            r = i, Br.resolve(r)) : n.ze.allocateTargetId(t).next((function(i) {
                return r = new ei(e, i, 0 /* Listen */ , t.currentSequenceNumber), n.ze.addTargetData(t, r).next((function() {
                    return r;
                }));
            }));
        }));
...
function yo(t, e, i) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                n = Q(t), o = n.Un.get(e), s = i ? "readwrite" : "readwrite-primary", r.label = 1;
 ...
 */ function vo(t, e, n) {
    var r = Q(t), i = ct.min(), o = Dn();
    return r.persistence.runTransaction("Execute query", "readonly", (function(t) {
        return function(t, e, n) {
            var r = Q(t), i = r.qn.get(n);
            return void 0 !== i ? Br.resolve(r.Un.get(i)) : r.ze.getTargetData(e, n);
            ...
            return r.Bn.getDocumentsMatchingQuery(t, e, n ? i : ct.min(), n ? o : Dn());
        })).next((function(t) {
            return {
                documents: t,
                Gn: o
...
// PORTING NOTE: Multi-Tab only.
function mo(t, e) {
    var n = Q(t), r = Q(n.ze), i = n.Un.get(e);
    return i ? Promise.resolve(i.target) : n.persistence.runTransaction("Get target data", "readonly", (function(t) {
        return r.Tt(t, e).next((function(t) {
...
function go(t) {
    ...
    return e.persistence.runTransaction("Get new document changes", "readonly", (function(t) {
        return function(t, e, n) {
            var r = Q(t), i = In(), o = oi(n), s = Qi(e), u = IDBKeyRange.lowerBound(o, !0);
            return s.Kt({
                index: kr.readTimeIndex,
                range: u
            }, (function(t, e) {
            ...
            return [ 2 /*return*/ , (e = Q(t)).persistence.runTransaction("Synchronize last document change read time", "readonly", (function(t) {
                return function(t) {
                    ...
                    // If there are no existing entries, we return SnapshotVersion.min().
                        ...
                        e.readTime && (n = si(e.readTime)), r.done();
                    })).next((function() {
                        return n;
                    }));
                }(t);
 ...
 */ function bo(t, e, i, o) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                for (n = Q(t), s = Dn(), u = In(), a = Nn(), c = 0, h = i; c < h.length; c++) f = h[c], 
                l = e.zn(f.metadata.name), f.document && (s = s.add(l)), u = u.insert(l, e.Hn(f)), 
                a = a.insert(l, e.Jn(f.metadata.readTime));
                return d = n.jn.newChangeBuffer({
                    trackRemovals: !0
                }), [ 4 /*yield*/ , po(n, function(t) {
                    // It is OK that the path used for the query is not valid, because this will
                    // not be read and queried.
                    return Ee(ve(pt.fromString("__bundle__/docs/" + t)));
                }(o)) ];
              ...
              case 1:
                ...
                return p = r.sent(), [ 2 /*return*/ , n.persistence.runTransaction("Apply bundle documents", "readwrite", (function(t) {
                    return fo(t, d, u, ct.min(), a).next((function(e) {
                        return d.apply(t), e;
                    })).next((function(e) {
 ...
 */ function Io(t, e, i) {
    return void 0 === i && (i = Dn()), n(this, void 0, void 0, (function() {
        var n, o;
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                return [ 4 /*yield*/ , po(t, Ee(li(e.bundledQuery))) ];
              ...
              case 1:
                return n = r.sent(), [ 2 /*return*/ , (o = Q(t)).persistence.runTransaction("Save named query", "readwrite", (function(t) {
                    ...
                    // Update existing target data because the query from the bundle is newer.
                                        var s = n.withResumeToken(wt.EMPTY_BYTE_STRING, r);
 ...
 */ var To = /** @class */ function() {
    ...
    return t.prototype.getBundleMetadata = function(t, e) {
        return Br.resolve(this.Yn.get(e));
    }, t.prototype.saveBundleMetadata = function(t, e) {
        ...
        return Br.resolve(this.Xn.get(e));
    }, t.prototype.saveNamedQuery = function(t, e) {
    ...
    function t() {
        ...
        this.Zn = new gn(So.ts), 
        // A set of outstanding references to a document sorted by target id.
        this.es = new gn(So.ns)
    ...
    t.prototype.cs = function(t) {
        var e = this, n = new Ct(new pt([])), r = new So(n, t), i = new So(n, t + 1), o = [];
        ...
        var e = new Ct(new pt([])), n = new So(e, t), r = new So(e, t + 1), i = Dn();
        return this.es.forEachInRange([ n, r ], (function(t) {
            i = i.add(t.key);
        })), i;
    }, t.prototype.containsKey = function(t) {
        var e = new So(t, 0), n = this.Zn.firstAfterOrEqual(e);
    ...
    return t.ts = function(t, e) {
        return Ct.comparator(t.key, e.key) || ot(t.ls, e.ls);
    }, 
    /** Compare by ID then by key */ t.ns = function(t, e) {
        return ot(t.ls, e.ls) || Ct.comparator(t.key, e.key);
    }, t;
}(), No = /** @class */ function() {
    function t(t, e) {
        ...
        this.ds = new gn(So.ts);
    }
    return t.prototype.checkEmpty = function(t) {
        return Br.resolve(0 === this.In.length);
    }, t.prototype.addMutationBatch = function(t, e, n, r) {
        var i = this.fs;
        ...
        for (var s = 0, u = r; s < u.length; s++) {
            var a = u[s];
            this.ds = this.ds.add(new So(a.key, i)), this.Ht.addToCollectionParentIndex(t, a.key.path.popLast());
        }
        return Br.resolve(o);
    }, t.prototype.lookupMutationBatch = function(t, e) {
        return Br.resolve(this.ws(e));
    }, t.prototype.getNextMutationBatchAfterBatchId = function(t, e) {
        var n = e + 1, r = this._s(n), i = r < 0 ? 0 : r;
        // The requested batchId may still be out of range so normalize it to the
        // start of the queue.
                return Br.resolve(this.In.length > i ? this.In[i] : null);
    }, t.prototype.getHighestUnacknowledgedBatchId = function() {
        return Br.resolve(0 === this.In.length ? -1 : this.fs - 1);
    }, t.prototype.getAllMutationBatches = function(t) {
        return Br.resolve(this.In.slice());
    }, t.prototype.getAllMutationBatchesAffectingDocumentKey = function(t, e) {
        var n = this, r = new So(e, 0), i = new So(e, Number.POSITIVE_INFINITY), o = [];
        return this.ds.forEachInRange([ r, i ], (function(t) {
            var e = n.ws(t.ls);
            o.push(e);
        })), Br.resolve(o);
    }, t.prototype.getAllMutationBatchesAffectingDocumentKeys = function(t, e) {
        var n = this, r = new gn(ot);
        return e.forEach((function(t) {
            var e = new So(t, 0), i = new So(t, Number.POSITIVE_INFINITY);
            n.ds.forEachInRange([ e, i ], (function(t) {
                r = r.add(t.ls);
            }));
        })), Br.resolve(this.gs(r));
    }, t.prototype.getAllMutationBatchesAffectingQuery = function(t, e) {
        ...
        var o = new So(new Ct(i), 0), s = new gn(ot);
        ...
        var n = this;
        z(0 === this.ys(e.batchId, "removed")), this.In.shift();
        var r = this.ds;
        ...
        var n = new So(e, 0), r = this.ds.firstAfterOrEqual(n);
        return Br.resolve(e.isEqual(r && r.key));
    }, t.prototype.performConsistencyCheck = function(t) {
        return this.In.length, Br.resolve();
    }, 
    /**
    ...
    function t(t, e) {
        ...
        this.docs = new yn(Ct.comparator), 
    ...
    t.prototype.removeEntry = function(t) {
        ...
        return Br.resolve(n ? n.document.clone() : Ht.newInvalidDocument(e));
    }, t.prototype.getEntries = function(t, e) {
        var n = this, r = In();
        return e.forEach((function(t) {
            var e = n.docs.get(t);
            r = r.insert(t, e ? e.document.clone() : Ht.newInvalidDocument(t));
        })), Br.resolve(r);
    }, t.prototype.getDocumentsMatchingQuery = function(t, e, n) {
        for (var r = In(), i = new Ct(e.path.child("")), o = this.docs.getIteratorFrom(i)
        // Documents are ordered by key, so we can use a prefix scan to narrow down
        // the documents we need to match the query against.
        ; o.hasNext(); ) {
            var s = o.getNext(), u = s.key, a = s.value, c = a.document, h = a.readTime;
            if (!e.path.isPrefixOf(u.path)) break;
            h.compareTo(n) <= 0 || Ae(e, c) && (r = r.insert(c.key, c.clone()));
        }
        return Br.resolve(r);
    ...
    function t(t) {
        ...
        /**
             ...
             * IDs.
             */
        this.As = new Eo, this.targetCount = 0, this.Rs = ki.se();
    }
    return t.prototype.forEachTarget = function(t, e) {
        ...
        return Br.resolve(this.Is);
    }, t.prototype.allocateTargetId = function(t) {
        return this.highestTargetId = this.Rs.next(), Br.resolve(this.highestTargetId);
    }, t.prototype.setTargetsMetadata = function(t, e, n) {
        ...
        var e = t.targetId;
        e > this.highestTargetId && (this.Rs = new ki(e), this.highestTargetId = e), t.sequenceNumber > this.Is && (this.Is = t.sequenceNumber);
    }, t.prototype.addTargetData = function(t, e) {
        return this.ce(e), this.targetCount += 1, Br.resolve();
    }, t.prototype.updateTargetData = function(t, e) {
        return this.ce(e), Br.resolve();
    }, t.prototype.removeTargetData = function(t, e) {
        ...
        return this.Es.forEach((function(s, u) {
            u.sequenceNumber <= e && null === n.get(u.targetId) && (r.Es.delete(s), o.push(r.removeMatchingKeysForTargetId(t, u.targetId)), 
            i++);
        ...
        return this.As.ss(e, n), Br.resolve();
    }, t.prototype.removeMatchingKeys = function(t, e, n) {
        this.As.os(e, n);
        ...
        return this.As.cs(e), Br.resolve();
    }, t.prototype.getMatchingKeysForTargetId = function(t, e) {
        var n = this.As.hs(e);
        return Br.resolve(n);
    }, t.prototype.containsKey = function(t, e) {
        return Br.resolve(this.As.containsKey(e));
    }, t;
}(), ko = /** @class */ function() {
    /**
    ...
    function t(t, e) {
        var n = this;
        this.bs = {}, this.Le = new nt(0), this.Be = !1, this.Be = !0, this.referenceDelegate = t(this), 
        this.ze = new Ao(this), this.Ht = new vi, this.He = function(t, e) {
            return new _o(t, (function(t) {
                return n.referenceDelegate.Ps(t);
            }));
        }(this.Ht), this.N = new ni(e), this.Je = new To(this.N);
    }
    return t.prototype.start = function() {
        return Promise.resolve();
    }, t.prototype.shutdown = function() {
        ...
        return e || (e = new No(this.Ht, this.referenceDelegate), this.bs[t.toKey()] = e), 
        e;
    }, t.prototype.getTargetCache = function() {
        return this.ze;
    }, t.prototype.getRemoteDocumentCache = function() {
        ...
        return Br.or(Object.values(this.bs).map((function(n) {
            return function() {
    ...
    return t.Ns = function(e) {
        ...
        return this.Ds.addReference(n, e), this.xs.delete(n.toString()), Br.resolve();
    }, t.prototype.removeReference = function(t, e, n) {
        return this.Ds.removeReference(n, e), this.xs.add(n.toString()), Br.resolve();
    }, t.prototype.markPotentiallyOrphaned = function(t, e) {
        return this.xs.add(e.toString()), Br.resolve();
    }, t.prototype.removeTarget = function(t, e) {
        var n = this;
        ...
        // Remove newly orphaned documents.
                return Br.forEach(this.xs, (function(r) {
            var i = Ct.fromPath(r);
        ...
        return Br.or([ function() {
            return Br.resolve(n.Ds.containsKey(e));
        }, function() {
...
/** Assembles the key for a query state in WebStorage */ function Oo(t, e) {
...
var Po = /** @class */ function() {
    ...
    return t.$s = function(e, n, r) {
        ...
        return s && o.error && ((s = "string" == typeof o.error.message && "string" == typeof o.error.code) && (i = new W(o.error.code, o.error.message))), 
    ...
    return t.$s = function(e, n) {
        ...
        return o && i.error && ((o = "string" == typeof i.error.message && "string" == typeof i.error.code) && (r = new W(i.error.code, i.error.message))), 
    ...
    return t.$s = function(e, n) {
        for (var r = JSON.parse(n), i = "object" == typeof r && r.activeTargetIds instanceof Array, o = kn(), s = 0; i && s < r.activeTargetIds.length; ++s) i = kt(r.activeTargetIds[s]), 
    ...
    function t(t, e, n, r, i) {
        ...
        this.qs = new yn(ot), this.started = !1, 
        /**
        ...
        var o = n.replace(/[.*+?^${}()|[\]\\]/g, "\\$&");
        this.storage = this.window.localStorage, this.currentUser = i, this.js = Lo(this.persistenceKey, this.Ls), 
        this.Qs = 
        /** Assembles the key for the current sequence number. */
        function(t) {
            return "firestore_sequence_number_" + t;
        }(this.persistenceKey), this.qs = this.qs.insert(this.Ls, new qo), this.Ws = new RegExp("^firestore_clients_" + o + "_([^_]*)$"), 
    ...
    /** Returns 'true' if WebStorage is available in the current environment. */    return t.bt = function(t) {
        ...
        return n(this, void 0, void 0, (function() {
            ...
            return r(this, (function(r) {
                switch (r.label) {
                  ...
                  case 1:
                    for (t = r.sent(), e = 0, n = t; e < n.length; e++) (i = n[e]) !== this.Ls && (o = this.getItem(Lo(this.persistenceKey, i))) && (s = Mo.$s(i, o)) && (this.qs = this.qs.insert(s.clientId, s));
                    for (this.Ys(), (u = this.storage.getItem(this.Hs)) && (a = this.Xs(u)) && this.Zs(a), 
        ...
        // by another tab
            ...
            var n = this.storage.getItem(Oo(this.persistenceKey, t));
            if (n) {
                var r = Fo.$s(t, n);
                r && (e = r.state);
            }
        ...
        this.removeItem(Oo(this.persistenceKey, t));
        ...
        // `Window.addEventListener`.
            ...
            if (q("SharedClientState", "EVENT", i.key, i.newValue), i.key === this.js) return void U("Received WebStorage notification for local change. Another client might have garbage-collected our state");
                    ...
                    return r(this, (function(r) {
                        if (this.started) {
                            if (null !== i.key) if (this.Ws.test(i.key)) {
                                if (null == i.newValue) return t = this.ci(i.key), [ 2 /*return*/ , this.ai(t, null) ];
                                if (e = this.ui(i.key, i.newValue)) return [ 2 /*return*/ , this.ai(e.clientId, e) ];
                            ...
                            } else if (i.key === this.Qs) u = function(t) {
                                var e = nt.T;
                                if (null != t) try {
                                    var n = JSON.parse(t);
                                ...
                                return e;
                            }(i.newValue), u !== nt.T && this.sequenceNumberHandler(u); else if (i.key === this.Js) return [ 2 /*return*/ , this.syncEngine.wi() ];
                        } else this.Ks.push(i);
                        return [ 2 /*return*/ ];
                    }));
                }));
        ...
        var r = new Po(this.currentUser, t, e, n), i = Ro(this.persistenceKey, this.currentUser, t);
        this.setItem(i, r.Os());
        ...
        var r = Oo(this.persistenceKey, t), i = new Fo(t, e, n);
        this.setItem(r, i.Os());
    ...
    t.prototype.Xs = function(t) {
        ...
        return n(this, void 0, void 0, (function() {
            return r(this, (function(e) {
                return t.user.uid === this.currentUser.uid ? [ 2 /*return*/ , this.syncEngine._i(t.batchId, t.state, t.error) ] : (q("SharedClientState", "Ignoring mutation for non-active user " + t.user.uid), 
                [ 2 /*return*/ ]);
            }));
        }));
        ...
        var n = this, r = e ? this.qs.insert(t, e) : this.qs.remove(t), i = this.ti(this.qs), o = this.ti(r), s = [], u = [];
        return o.forEach((function(t) {
            i.has(t) || s.push(t);
        })), i.forEach((function(t) {
            o.has(t) || u.push(t);
        })), this.syncEngine.gi(s, u).then((function() {
            n.qs = r;
        }));
    ...
    function t() {
        this.yi = new qo, this.pi = {}, this.onlineStateHandler = null, this.sequenceNumberHandler = null;
    }
    return t.prototype.addPendingMutation = function(t) {
        ...
        return this.yi = new qo, Promise.resolve();
    }, t.prototype.handleUserChange = function(t, e, n) {
        // No op.
    }, t.prototype.setOnlineState = function(t) {
        // No op.
    ...
    return t(n, e), n.prototype.qi = function(t, e, n, r) {
        return new Promise((function(i, o) {
            var s = new S;
            s.listenOnce(N.COMPLETE, (function() {
                try {
                    switch (s.getLastErrorCode()) {
                      ...
                      case _.TIMEOUT:
                        q("Connection", 'RPC "' + t + '" timed out'), o(new W(H.DEADLINE_EXCEEDED, "Request time out"));
                        break;
                      ...
                      case _.HTTP_ERROR:
                        ...
                        n > 0) {
                            ...
                            if (r && r.status && r.message) {
                                ...
                                o(new W(u, r.message));
                            } else o(new W(H.UNKNOWN, "Server responded with status " + s.getStatus()));
                        } else 
                        // If we received an HTTP_ERROR but there's no status code,
                        // it's most probably a connection issue
                        o(new W(H.UNAVAILABLE, "Connection failed."));
                        break;
        ...
        var n = [ this.Fi, "/", "google.firestore.v1.Firestore", "/", t, "/channel" ], r = D(), i = A(), o = {
        ...
        this.useFetchStreams && (o.xmlHttpFactory = new k({})), this.Ui(o.initMessageHeaders, e), 
        ...
        var u = r.createWebChannel(s, o), a = !1, c = !1, h = new Go({
            vi: function(t) {
        ...
        return f(u, C.EventType.OPEN, (function() {
            c || q("Connection", "WebChannel transport opened.");
        })), f(u, C.EventType.CLOSE, (function() {
            c || (c = !0, q("Connection", "WebChannel transport closed"), h.$i());
        })), f(u, C.EventType.ERROR, (function(t) {
            c || (c = !0, B("Connection", "WebChannel transport errored:", t), h.$i(new W(H.UNAVAILABLE, "The operation could not be completed")));
        })), f(u, C.EventType.MESSAGE, (function(t) {
            var e;
            if (!c) {
                var n = t.data[0];
                z(!!n);
 ...
 */
                    function(t) {
                        ...
                        // eslint-disable-next-line @typescript-eslint/no-explicit-any
                        var e = an[t];
                        if (void 0 !== e) return pn(e);
                    }(o), a = i.message;
                    void 0 === s && (s = H.INTERNAL, a = "Unknown error status: " + o + " with message " + i.message), 
                    // Mark closed so no further events are propagated
                    c = !0, h.$i(new W(s, a)), u.close();
                } else q("Connection", "WebChannel received:", n), h.Oi(n);
            }
        })), f(i, x.STAT_EVENT, (function(t) {
            t.stat === L.PROXY ? q("Connection", "Detected buffering proxy") : t.stat === L.NOPROXY && q("Connection", "Detected no buffering proxy");
        })), setTimeout((function() {
     ...
     */
    t.prototype.Ui = function(t, e) {
        if (t["X-Goog-Api-Client"] = "gl-js/ fire/" + P, 
...
/** The Platform's 'document' implementation or null if not available. */ function Wo() {
 ...
 */ var Jo = /** @class */ function() {
    ...
    t.prototype.Xi = function(t) {
        ...
        // Guard against lastAttemptTime being in the future due to a clock change.
                i > 0 && q("ExponentialBackoff", "Backing off for " + i + " ms (base delay: " + this.zi + " ms, delay with jitter: " + n + " ms, last attempt: " + r + " ms ago)"), 
    ...
    function t(t, e, n, r, i, o, s) {
        ...
        /**
             ...
             * close.
             */
        this.ir = 0, this.rr = null, this.cr = null, this.stream = null, this.ar = new Jo(t, e)
        /**
            ...
            return r(this, (function(n) {
                switch (n.label) {
                  case 0:
                    ...
                    return this.gr(), this.yr(), this.ar.cancel(), 
                    // Invalidates any stream-related callbacks (e.g. from auth or the
                    // underlying stream), guaranteeing they won't execute.
                    this.ir++, 4 /* Error */ !== t ? 
                    // If this is an intentional close ensure we don't delay our next connection attempt.
                    this.ar.reset() : e && e.code === H.RESOURCE_EXHAUSTED ? (
                    // Log the error. (Probably either 'quota exceeded' or 'max queue length reached'.)
                    U(e.toString()), U("Using maximum backoff delay to prevent overloading the backend."), 
                    this.ar.Yi()) : e && e.code === H.UNAUTHENTICATED && 3 /* Healthy */ !== this.state && 
    ...
    t.prototype.pr = function() {}, t.prototype.auth = function() {
        ...
        this.stream = this.Ar(t), this.stream.Si((function() {
            n((function() {
                return e.state = 2 /* Open */ , e.cr = e.Oe.enqueueAfterDelay(e.nr, 1e4, (function() {
        ...
        var t = this;
        this.state = 5 /* Backoff */ , this.ar.Xi((function() {
        ...
        var e = function(t, e) {
            ...
            if ("targetChange" in e) {
                ...
                var r = function(t) {
                    ...
                    var e = void 0 === t.code ? H.UNKNOWN : pn(t.code);
                ...
                var c = Yn(t, a.document.name), h = Gn(a.document.updateTime), f = new Gt({
                    mapValue: {
                        fields: a.document.fields
                    }
                }), l = Ht.newFoundDocument(c, h, f), d = a.targetIds || [], p = a.removedTargetIds || [];
                n = new Ln(d, p, l.key, l);
            } else if ("documentDelete" in e) {
                e.documentDelete;
                var y = e.documentDelete;
                y.document;
                var v = Yn(t, y.document), m = y.readTime ? Gn(y.readTime) : ct.min(), g = Ht.newNoDocument(v, m), w = y.removedTargetIds || [];
                n = new Ln([], w, g.key, g);
                ...
                var E = e.filter;
                E.targetId;
                var S = E.count || 0, N = new ln(S), _ = E.targetId;
                n = new Rn(_, N);
            }
            return n;
            ...
            var e = function(t, e) {
                return t && t.length > 0 ? (z(void 0 !== e), t.map((function(t) {
                    return function(t, e) {
                        ...
                        var n = t.updateTime ? Gn(t.updateTime) : Gn(e);
        ...
        i.enqueueAndForget((function() {
            return n(u, void 0, void 0, (function() {
                return r(this, (function(t) {
                    switch (t.label) {
                      case 0:
                        return fs(this) ? (q("RemoteStore", "Restarting streams for network reachability change."), 
                        [ 4 /*yield*/ , function(t) {
                            return n(this, void 0, void 0, (function() {
                                var e;
                                return r(this, (function(n) {
 ...
 */ function ss(t, e) {
    var n = Q(t), r = _s(n);
    n.Qr.delete(e), r.hr() && as(n, e), 0 === n.Qr.size && (r.hr() ? r.wr() : fs(n) && 
    ...
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(a) {
            switch (a.label) {
              ...
              case 6:
                if (e instanceof Ln ? t.Jr.rt(e) : e instanceof Rn ? t.Jr.ft(e) : t.Jr.at(e), i.isEqual(ct.min())) return [ 3 /*break*/ , 13 ];
                a.label = 7;

              case 7:
                return a.trys.push([ 7, 11, , 13 ]), [ 4 /*yield*/ , co(t.localStore) ];
                ...
                function(t, e) {
                    ...
                    n.targetMismatches.forEach((function(e) {
                        ...
                        if (n) {
                            ...
                            var r = new ei(n.target, e, 1 /* ExistenceFilterMismatch */ , n.sequenceNumber);
                            us(t, r);
                        }
              ...
              case 11:
                return q("RemoteStore", "Failed to raise snapshot:", u = a.sent()), [ 4 /*yield*/ , vs(t, u) ];
 ...
 */ (e)) return [ 3 /*break*/ , 7 ];
              ...
              case 4:
                return s = r.sent(), [ 4 /*yield*/ , vs(e, s) ];
...
var As = /** @class */ function() {
    ...
    t.prototype.cancel = function(t) {
        null !== this.timerHandle && (this.clearTimeout(), this.deferred.reject(new W(H.CANCELLED, "Operation cancelled" + (t ? ": " + t : ""))));
 ...
 */ function ks(t, e) {
    if (U("AsyncQueue", e + ": " + t), Qr(t)) return new W(H.UNAVAILABLE, e + ": " + t);
    throw t;
}
 ...
 */ var Cs = /** @class */ function() {
    ...
    function t(t) {
        ...
        }, this.keyedMap = En(), this.sortedSet = new yn(this.comparator)
        /**
 ...
 */ function Ps(t, e) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                if (n = Q(t), i = e.query, o = !1, (s = n.queries.get(i)) || (o = !0, s = new Rs), 
                !o) return [ 3 /*break*/ , 4 ];
                r.label = 1;
              ...
              case 2:
                return u.no = r.sent(), [ 3 /*break*/ , 4 ];

              case 3:
                return a = r.sent(), c = ks(a, "Initialization of query '" + De(e.query) + "' failed"), 
...
function Fs(t, e) {
    return n(this, void 0, void 0, (function() {
        var n, i, o, s, u;
        return r(this, (function(r) {
            return n = Q(t), i = e.query, o = !1, (s = n.queries.get(i)) && (u = s.listeners.indexOf(e)) >= 0 && (s.listeners.splice(u, 1), 
 ...
 */ var Us = /** @class */ function() {
    ...
    return t.prototype.ro = function(t) {
        ...
        var o = !1;
        return this.co ? this.uo(t) && (this.oo.next(t), o = !0) : this.ho(t, this.onlineState) && (this.lo(t), 
        o = !0), this.ao = t, o;
    ...
    /** Returns whether a snapshot was raised. */ t.prototype.io = function(t) {
        ...
        t = Ls.fromInitialDocuments(t.query, t.docs, t.mutatedKeys, t.fromCache), this.co = !0, 
        this.oo.next(t);
    }, t;
}(), Bs = /** @class */ function() {
    function t(t, 
    ...
    t.prototype.Hn = function(t) {
        return t.metadata.exists ? er(this.N, t.document, !1) : Ht.newNoDocument(this.zn(t.metadata.name), this.Jn(t.metadata.readTime));
    ...
    function t(t, e, n) {
        ...
        this.documents = [], this.progress = zs(t)
        /**
    ...
    return t.prototype.mo = function(t) {
        ...
        for (var e = new Map, n = new js(this.N), r = 0, i = t; r < i.length; r++) {
            var o = i[r];
            if (o.metadata.queries) for (var s = n.zn(o.metadata.name), u = 0, a = o.metadata.queries; u < a.length; u++) {
                var c = a[u], h = (e.get(c) || Dn()).add(s);
                e.set(c, h);
            }
        }
        return e;
        ...
        return n(this, void 0, void 0, (function() {
            ...
            return r(this, (function(r) {
                switch (r.label) {
                  ...
                  case 5:
                    return [ 2 /*return*/ , (this.progress.taskState = "Success", new eo(Object.assign({}, this.progress), t)) ];
                }
            }));
        }));
    }, t;
 ...
 */ var Gs = function(t) {
    ...
    t.prototype.bo = function(t, e) {
        var n = this, r = e ? e.Po : new xs, i = e ? e.Ao : this.Ao, o = e ? e.mutatedKeys : this.mutatedKeys, s = i, u = !1, a = me(this.query) && i.size === this.query.limit ? i.last() : null, c = ge(this.query) && i.size === this.query.limit ? i.first() : null;
        ...
        if (t.inorderTraversal((function(t, e) {
            ...
            o = o.delete(t)));
        })), me(this.query) || ge(this.query)) for (;s.size > this.query.limit; ) {
            var h = me(this.query) ? s.last() : s.first();
    ...
    t.prototype.applyChanges = function(t, e, n) {
        ...
        var s = e ? this.So() : [], u = 0 === this.Eo.size && this.current ? 1 /* Synced */ : 0 /* Local */ , a = u !== this.To;
        return this.To = u, 0 !== o.length || a ? {
            snapshot: new Ls(this.query, t.Ao, i, o, t.mutatedKeys, 0 /* Local */ === u, a, 
            /* excludesMetadataChanges= */ !1),
            Do: s
        } : {
            Do: s
        ...
        return r(this, (function(r) {
            switch (r.label) {
              ...
              case 2:
                ...
                [ 4 /*yield*/ , Zs(n, e, i, "current" === a) ];

              case 3:
                o = r.sent(), n.isPrimaryClient && os(n.remoteStore, u), r.label = 4;
                            ...
                            return r(this, (function(r) {
                                switch (r.label) {
                                  ...
                                  case 2:
                                    ...
                                    /* updateLimboDocuments= */ t.isPrimaryClient, s), [ 2 /*return*/ , (fu(t, e.targetId, u.Do), 
                                    u.snapshot) ];
                                }
                            }));
                        }));
                    }(t, e, i, o);
                }, [ 4 /*yield*/ , vo(t.localStore, e, 
                /* usePreviousResults= */ !0) ];

              case 1:
                return s = l.sent(), u = new Hs(e, s.Gn), a = u.bo(s.documents), c = xn.createSynthesizedTargetChangeForCurrentChange(i, o && "Offline" /* Offline */ !== t.onlineState), 
                h = u.applyChanges(a, 
                /* updateLimboDocuments= */ t.isPrimaryClient, c), fu(t, i, h.Do), f = new Ws(e, i, u), 
            ...
            switch (r.label) {
              case 0:
                ...
                /*keepPersistedTargetData=*/ !1).then((function() {
                    n.sharedClientState.clearQueryState(i.targetId), ss(n.remoteStore, i.targetId), 
                    cu(n, i.targetId);
                })).catch(Oi) ]) : [ 3 /*break*/ , 3 ];
              ...
              case 3:
                return cu(n, i.targetId), [ 4 /*yield*/ , yo(n.localStore, i.targetId, 
            ...
            switch (r.label) {
              ...
              case 1:
                return r.trys.push([ 1, 5, , 6 ]), [ 4 /*yield*/ , function(t, e) {
                    var n, r = Q(t), i = at.now(), o = e.reduce((function(t, e) {
                        return t.add(e.key);
                    }), Dn());
                    return r.persistence.runTransaction("Locally write mutations", "readwrite", (function(t) {
                        return r.Qn.Pn(t, o).next((function(o) {
                            ...
                            var s = [], u = 0, a = e; u < a.length; u++) {
                                ...
                                // exists=true
                                s.push(new rn(c.key, h, Qt(h.value.mapValue), We.exists(!0)));
                            }
              ...
              case 2:
                ...
                }(n, o.batchId, i), [ 4 /*yield*/ , pu(n, o.changes) ];

              case 3:
                return r.sent(), [ 4 /*yield*/ , gs(n.remoteStore) ];

              case 4:
                return r.sent(), [ 3 /*break*/ , 6 ];

              case 5:
                return s = r.sent(), u = ks(s, "Failed to persist write"), i.reject(u), [ 3 /*break*/ , 6 ];
    ...
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              ...
              case 1:
                return r.trys.push([ 1, 4, , 6 ]), [ 4 /*yield*/ , ho(n.localStore, e) ];
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                ...
                (s = o && o.key) ? (u = (u = new yn(Ct.comparator)).insert(s, Ht.newNoDocument(s, ct.min())), 
                a = Dn().add(s), c = new Cn(ct.min(), 
                /* targetChanges= */ new Map, 
                /* targetMismatches= */ new gn(ot), u, a), [ 4 /*yield*/ , eu(n, c) ]) : [ 3 /*break*/ , 2 ];
              ...
              case 1:
                ...
                n.Lo = n.Lo.remove(s), n.Bo.delete(e), du(n), [ 3 /*break*/ , 4 ];
    ...
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              ...
              case 1:
                return r.trys.push([ 1, 4, , 6 ]), [ 4 /*yield*/ , ao(n.localStore, e) ];
              ...
              case 2:
                ...
                au(n, i, /*error=*/ null), uu(n, i), n.sharedClientState.updateMutationState(i, "acknowledged"), 
                [ 4 /*yield*/ , pu(n, o) ];
        ...
        return r(this, (function(r) {
            switch (r.label) {
                ...
                return r.trys.push([ 1, 4, , 6 ]), [ 4 /*yield*/ , function(t, e) {
                    ...
                    return n.persistence.runTransaction("Reject batch", "readwrite-primary", (function(t) {
                        ...
                        return n.In.lookupMutationBatch(t, e).next((function(e) {
                            return z(null !== e), r = e.keys(), n.In.removeMutationBatch(t, e);
                        })).next((function() {
                            return n.In.performConsistencyCheck(t);
                        })).next((function() {
                            return n.Qn.Pn(t, r);
              ...
              case 2:
                ...
                // listen events.
                au(n, e, i), uu(n, e), n.sharedClientState.updateMutationState(e, "rejected", i), 
                [ 4 /*yield*/ , pu(n, o) ];
 ...
 */ function su(t, e) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                fs((n = Q(t)).remoteStore) || q("SyncEngine", "The network is disabled. The task returned by 'awaitPendingWrites()' will not complete until the network is enabled."), 
                r.label = 1;
              ...
              case 3:
                return s = r.sent(), u = ks(s, "Initialization of waitForPendingWrites() operation failed"), 
...
function hu(t, e) {
    ...
    var n = t.Lo.get(e);
    null !== n && (ss(t.remoteStore, n), t.Lo = t.Lo.remove(e), t.Bo.delete(n), du(t));
}

function fu(t, e, n) {
    for (var r = 0, i = n; r < i.length; r++) {
        var o = i[r];
        o instanceof Gs ? (t.Uo.addReference(o.key, e), lu(t, o)) : o instanceof Qs ? (q("SyncEngine", "Document no longer in limbo: " + o.key), 
...
function pu(t, e, i) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(c) {
            switch (c.label) {
              case 0:
                return o = Q(t), s = [], u = [], a = [], o.Oo.isEmpty() ? [ 3 /*break*/ , 3 ] : (o.Oo.forEach((function(t, n) {
                    a.push(o.Wo(n, e, i).then((function(t) {
                        if (t) {
                            o.isPrimaryClient && o.sharedClientState.updateQueryState(n.targetId, t.fromCache ? "not-current" : "current"), 
                            s.push(t);
                            var e = ro.kn(n.targetId, t);
                            u.push(e);
                        }
                    })));
                            ...
                            switch (r.label) {
                              ...
                              case 1:
                                return r.trys.push([ 1, 3, , 4 ]), [ 4 /*yield*/ , n.persistence.runTransaction("notifyLocalViewChanges", "readwrite", (function(t) {
                                    return Br.forEach(e, (function(e) {
                                        return Br.forEach(e.Nn, (function(r) {
                                            return n.persistence.referenceDelegate.addReference(t, e.targetId, r);
                                        })).next((function() {
                                            return Br.forEach(e.xn, (function(r) {
                              ...
                              case 4:
                                for (o = 0, s = e; o < s.length; o++) u = s[o], a = u.targetId, u.fromCache || (c = n.Un.get(a), 
                                h = c.snapshotVersion, f = c.withLastLimboFreeSnapshotVersion(h), 
                                // Advance the last limbo free snapshot version
                                n.Un = n.Un.insert(a, f));
                                return [ 2 /*return*/ ];
                            }
                        }));
                    }));
        ...
        return r(this, (function(r) {
            switch (r.label) {
              ...
              case 1:
                ...
                n.sharedClientState.handleUserChange(e, i.removedBatchIds, i.addedBatchIds), [ 4 /*yield*/ , pu(n, i.Wn) ];
 ...
 */ function mu(t, e) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                return [ 4 /*yield*/ , vo((n = Q(t)).localStore, e.query, 
                /* usePreviousResults= */ !0) ];

              case 1:
                return i = r.sent(), o = e.view.No(i), [ 2 /*return*/ , (n.isPrimaryClient && fu(n, e.targetId, o.Do), 
                o) ];
            }
        }));
    }));
...
function gu(t) {
    return n(this, void 0, void 0, (function() {
        var e;
        return r(this, (function(n) {
            return [ 2 /*return*/ , go((e = Q(t)).localStore).then((function(t) {
                return pu(e, t);
            })) ];
        }));
    }));
        ...
        return r(this, (function(r) {
            switch (r.label) {
                ...
                return [ 4 /*yield*/ , function(t, e) {
                    ...
                    return n.persistence.runTransaction("Lookup mutation documents", "readonly", (function(t) {
                        return r.Xt(t, e).next((function(e) {
                            return e ? n.Qn.Pn(t, e) : Br.resolve(null);
                        }));
                    }));
                }((n = Q(t)).localStore, e) ];

              case 1:
                return null === (s = r.sent()) ? [ 3 /*break*/ , 6 ] : "pending" !== i ? [ 3 /*break*/ , 3 ] : [ 4 /*yield*/ , gs(n.remoteStore) ];
              ...
              case 3:
                ...
                // other clients.
                au(n, e, o || null), uu(n, e), function(t, e) {
                    Q(Q(t).In).te(e);
                }(n.localStore, e)) : K(), r.label = 4;

              case 4:
                return [ 4 /*yield*/ , pu(n, s) ];
...
function bu(t, e) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                return _u(n = Q(t)), Du(n), !0 !== e || !0 === n.Qo ? [ 3 /*break*/ , 3 ] : (i = n.sharedClientState.getAllActiveQueryTargets(), 
                [ 4 /*yield*/ , Iu(n, i.toArray()) ]);

              case 1:
                return o = r.sent(), n.Qo = !0, [ 4 /*yield*/ , Ns(n.remoteStore, !0) ];

              case 2:
                for (r.sent(), s = 0, u = o; s < u.length; s++) a = u[s], os(n.remoteStore, a);
                return [ 3 /*break*/ , 7 ];
              ...
              case 3:
                ...
                n.Fo.forEach((function(t, e) {
                    n.sharedClientState.isLocalQueryTarget(e) ? c.push(e) : h = h.then((function() {
                        return cu(n, e), yo(n.localStore, e, 
                        /*keepPersistedTargetData=*/ !0);
                    })), ss(n.remoteStore, e);
                })), [ 4 /*yield*/ , h ]);

              case 4:
                return r.sent(), [ 4 /*yield*/ , Iu(n, c) ];
...
function Iu(t, e, i) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                n = Q(t), i = [], o = [], s = 0, u = e, r.label = 1;

              case 1:
                return s < u.length ? (a = u[s], c = void 0, (h = n.Fo.get(a)) && 0 !== h.length ? [ 4 /*yield*/ , po(n.localStore, Ee(h[0])) ] : [ 3 /*break*/ , 7 ]) : [ 3 /*break*/ , 13 ];
              ...
              case 3:
                return f < l.length ? (d = l[f], p = n.Oo.get(d), [ 4 /*yield*/ , mu(n, p) ]) : [ 3 /*break*/ , 6 ];
              ...
              case 7:
                return [ 4 /*yield*/ , mo(n.localStore, a) ];

              case 8:
                return v = r.sent(), [ 4 /*yield*/ , po(n.localStore, v) ];

              case 9:
                return c = r.sent(), [ 4 /*yield*/ , Zs(n, Tu(v), a, 
                /*current=*/ !1) ];
    ...
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              ...
              case 2:
                return [ 4 /*yield*/ , go(n.localStore) ];
              ...
              case 6:
                return r.sent(), cu(n, e, o), [ 3 /*break*/ , 8 ];
...
/** Adds or removes Watch targets for queries from different tabs. */ function Nu(t, e, i) {
    return n(this, void 0, void 0, (function() {
        var n, o, s, u, a, c, h, f, l, d;
        return r(this, (function(p) {
            switch (p.label) {
              case 0:
                if (!(n = _u(t)).Qo) return [ 3 /*break*/ , 10 ];
                o = 0, s = e, p.label = 1;

              case 1:
                return o < s.length ? (u = s[o], n.Fo.has(u) ? (
                // A target might have been added in a previous attempt
                q("SyncEngine", "Adding an already active target " + u), [ 3 /*break*/ , 5 ]) : [ 4 /*yield*/ , mo(n.localStore, u) ]) : [ 3 /*break*/ , 6 ];

              case 2:
                return a = p.sent(), [ 4 /*yield*/ , po(n.localStore, a) ];

              case 3:
                return c = p.sent(), [ 4 /*yield*/ , Zs(n, Tu(a), c.targetId, 
                /*current=*/ !1) ];

              case 4:
                p.sent(), os(n.remoteStore, c), p.label = 5;
...
function _u(t) {
    var e = Q(t);
    return e.remoteStore.remoteSyncer.applyRemoteEvent = eu.bind(null, e), e.remoteStore.remoteSyncer.getRemoteKeysForTarget = vu.bind(null, e), 
    e.remoteStore.remoteSyncer.rejectListen = ru.bind(null, e), e.$o.Rr = Ms.bind(null, e.eventManager), 
    e.$o.Go = Vs.bind(null, e.eventManager), e;
}

function Du(t) {
    var e = Q(t);
    return e.remoteStore.remoteSyncer.applySuccessfulWrite = iu.bind(null, e), e.remoteStore.remoteSyncer.rejectFailedWrite = ou.bind(null, e), 
    e
    /**
        ...
        return n(this, void 0, void 0, (function() {
            ...
            return r(this, (function(r) {
                switch (r.label) {
                  ...
                  case 7:
                    return (u = r.sent()) && i._updateProgress(u), [ 4 /*yield*/ , e.zo() ];
                  ...
                  case 11:
                    ...
                    // has newer version.
                    return a = r.sent(), [ 4 /*yield*/ , pu(t, a.En, 
                    /* remoteEvent */ void 0) ];
...
var ku = /** @class */ function() {
            ...
            return r(this, (function(r) {
                switch (r.label) {
                  ...
                  case 3:
                    ...
                    return r.sent(), [ 4 /*yield*/ , Du(this.Zo.syncEngine) ];
    ...
    return t(i, e), i.prototype.initialize = function(t) {
                    ...
                    return [ 4 /*yield*/ , this.persistence.nn((function(t) {
                        return n(o, void 0, void 0, (function() {
                            return r(this, (function(e) {
                                switch (e.label) {
                                  case 0:
                                    return [ 4 /*yield*/ , bu(this.Zo.syncEngine, t) ];
        ...
        return new Uo(e, t.asyncQueue, n, t.clientId, t.initialUser);
    }, i;
}(Cu), Lu = /** @class */ function() {
    function t() {}
    return t.prototype.initialize = function(t, e) {
                ...
                switch (r.label) {
                  case 0:
                    ...
                    /* startAsPrimary=*/ !t.synchronizeTabs), this.sharedClientState.onlineStateHandler = function(t) {
                        return nu(n.syncEngine, t, 1 /* SharedClientState */);
                    }, this.remoteStore.remoteSyncer.handleCredentialChange = yu.bind(null, this.syncEngine), 
        ...
        var e, n = Yo(t.databaseInfo.databaseId), r = (e = t.databaseInfo, new Qo(e));
 ...
 */ var Ou = /** @class */ function() {
            ...
            return r(this, (function(t) {
                switch (t.label) {
                  ...
                  case 1:
                    ...
                    return [ 2 /*return*/ , (t.sent(), this.ic()) ];
                }
            }));
        }));
    }, 
    ...
    t.prototype.ic = function() {
        return n(this, void 0, void 0, (function() {
            ...
            return r(this, (function(r) {
                switch (r.label) {
                  case 0:
                    return [ 4 /*yield*/ , this.rc() ];

                  case 1:
                    return null === (t = r.sent()) ? [ 2 /*return*/ , null ] : (e = this.sc.decode(t), 
                    n = Number(e), isNaN(n) && this.oc("length string (" + e + ") is not valid number"), 
                    [ 4 /*yield*/ , this.cc(n) ]);
    ...
    /** First index of '{' from the underlying buffer. */ t.prototype.ac = function() {
    ...
    t.prototype.rc = function() {
        return n(this, void 0, void 0, (function() {
            ...
            return r(this, (function(n) {
                switch (n.label) {
                  case 0:
                    return this.ac() < 0 ? [ 4 /*yield*/ , this.uc() ] : [ 3 /*break*/ , 3 ];
                  ...
                  case 3:
                    ...
                    (t = this.ac()) < 0 && this.oc("Reached the end of bundle when a length string is expected."), 
    ...
    t.prototype.cc = function(t) {
        return n(this, void 0, void 0, (function() {
            ...
            return r(this, (function(n) {
                switch (n.label) {
                  case 0:
                    return this.buffer.length < t ? [ 4 /*yield*/ , this.uc() ] : [ 3 /*break*/ , 3 ];

                  case 1:
                    n.sent() && this.oc("Reached the end of bundle when more is expected."), n.label = 2;
    ...
    return t.prototype.lookup = function(t) {
        return n(this, void 0, void 0, (function() {
            ...
            return r(this, (function(o) {
                switch (o.label) {
                  case 0:
                    if (this.ensureCommitNotCalled(), this.mutations.length > 0) throw new W(H.INVALID_ARGUMENT, "Firestore transactions require all reads to be executed before all writes.");
                    return [ 4 /*yield*/ , function(t, e) {
                        return n(this, void 0, void 0, (function() {
                            var n, i, o, s, u, a;
                            return r(this, (function(r) {
                                    ...
                                    return s = r.sent(), u = new Map, s.forEach((function(t) {
                                        var e = function(t, e) {
                                            return "found" in e ? function(t, e) {
                                                ...
                                                var n = Yn(t, e.found.name), r = Gn(e.found.updateTime), i = new Gt({
                                                    mapValue: {
                                                        fields: e.found.fields
                                                    }
                                                });
                                                return Ht.newFoundDocument(n, r, i);
            ...
            return r(this, (function(i) {
                switch (i.label) {
                  case 0:
                    ...
                    t.forEach((function(t, n) {
                        var r = Ct.fromPath(n);
                        e.mutations.push(new fn(r, e.precondition(r)));
        ...
        if (n) {
            ...
            throw new W(H.ABORTED, "Document version changed between two reads.");
    ...
    t.prototype.preconditionForUpdate = function(t) {
        ...
        // read time and existence
            ...
            // transaction.
            throw new W(H.INVALID_ARGUMENT, "Can't update a document that doesn't exist.");
    ...
    function t(t, e, n, r) {
        ...
        this.hc = 5, this.ar = new Jo(this.asyncQueue, "transaction_retry" /* TransactionRetry */)
    ...
    return t.prototype.run = function() {
        ...
        this.ar.Xi((function() {
            return n(t, void 0, void 0, (function() {
                var t, e, n = this;
                return r(this, (function(r) {
                    return t = new Fu(this.datastore), (e = this.fc(t)) && e.then((function(e) {
        ...
        if ("FirebaseError" === t.name) {
            ...
            var e = t.code;
            return "aborted" === e || "failed-precondition" === e || !dn(e);
        }
        return !1;
    }, t;
}(), Vu = /** @class */ function() {
    ...
    e, i) {
        var o = this;
        this.credentials = t, this.asyncQueue = e, this.databaseInfo = i, this.user = O.UNAUTHENTICATED, 
        this.clientId = it.I(), this.credentialListener = function() {
            return Promise.resolve();
    ...
    t.prototype.verifyNotTerminated = function() {
        if (this.asyncQueue.isShuttingDown) throw new W(H.FAILED_PRECONDITION, "The client has already been terminated.");
    }, t.prototype.terminate = function() {
        var t = this;
            ...
            return n(t, void 0, void 0, (function() {
                ...
                return r(this, (function(r) {
                    switch (r.label) {
                      ...
                      case 5:
                        return t = r.sent(), n = ks(t, "Failed to shutdown persistence"), e.reject(n), [ 3 /*break*/ , 6 ];
                ...
                return u.sent(), o = i.initialUser, t.setCredentialChangeListener((function(t) {
                    return n(s, void 0, void 0, (function() {
                        return r(this, (function(n) {
                            switch (n.label) {
                              case 0:
                                return o.isEqual(t) ? [ 3 /*break*/ , 2 ] : [ 4 /*yield*/ , uo(e.localStore, t) ];
...
function Uu(t, e) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(s) {
            switch (s.label) {
              case 0:
                return t.asyncQueue.verifyOperationInProgress(), [ 4 /*yield*/ , Bu(t) ];
...
/** Enables the network connection and re-enqueues all pending operations. */ function Wu(t, e, i) {
    var o = this;
    void 0 === i && (i = {});
    var s = new Y;
                    ...
                    return n = function(t, e, n, r, i) {
                        var o = new Ou({
                            next: function(n) {
                                ...
                                e.enqueueAndForget((function() {
                                    return Fs(t, s);
                                })), n.fromCache && "server" === r.source ? i.reject(new W(H.UNAVAILABLE, 'Failed to get documents from server. (However, these documents may exist in the local cache. Run again without setting source to "server" to retrieve the cached documents.)')) : i.resolve(n);
                            },
                            error: function(t) {
                                return i.reject(t);
                            }
 ...
 * @internal
 */ function ta(t, e, n, r) {
    if (!0 === e && !0 === r) throw new W(H.INVALID_ARGUMENT, t + " and " + n + " cannot be used together.");
}
 ...
 */ function ea(t) {
    if (!Ct.isDocumentKey(t)) throw new W(H.INVALID_ARGUMENT, "Invalid document reference. Document references must have an even number of segments, but " + t + " has " + t.length + ".");
}
 ...
 */ function na(t) {
    if (Ct.isDocumentKey(t)) throw new W(H.INVALID_ARGUMENT, "Invalid collection reference. Collection references must have an odd number of segments, but " + t + " has " + t.length + ".");
}
 ...
 */
/** Returns a string describing the type / value of the provided input. */ function ra(t) {
...
e) {
    ...
    t = t._delegate), !(t instanceof e)) {
        if (e.name === t.constructor.name) throw new W(H.INVALID_ARGUMENT, "Type does not match the expected instance. Did you pass a reference from a different Firestore SDK?");
        var n = ra(t);
        throw new W(H.INVALID_ARGUMENT, "Expected type '" + e.name + "', but it was: " + n);
    }
    return t;
}

function oa(t, e) {
    if (e <= 0) throw new W(H.INVALID_ARGUMENT, "Function " + t + "() requires a positive number, but it was: " + e + ".");
}
 ...
 */ var sa = /** @class */ function() {
    function t(t) {
        var e;
        if (void 0 === t.host) {
            if (void 0 !== t.ssl) throw new W(H.INVALID_ARGUMENT, "Can't provide ssl option if host option is not set");
            this.host = "firestore.googleapis.com", this.ssl = !0;
        } else this.host = t.host, this.ssl = null === (e = t.ssl) || void 0 === e || e;
        if (this.credentials = t.credentials, this.ignoreUndefinedProperties = !!t.ignoreUndefinedProperties, 
        void 0 === t.cacheSizeBytes) this.cacheSizeBytes = 41943040; else {
            if (-1 !== t.cacheSizeBytes && t.cacheSizeBytes < 1048576) throw new W(H.INVALID_ARGUMENT, "cacheSizeBytes must be at least 1048576");
    ...
    function t(t, e) {
        ...
        /**
             ...
             */
        this.type = "firestore-lite", this._persistenceKey = "(lite)", this._settings = new sa({}), 
        this._settingsFrozen = !1, t instanceof Xu ? this._databaseId = t : (this._app = t, 
        this._databaseId = function(t) {
            if (!Object.prototype.hasOwnProperty.apply(t.options, [ "projectId" ])) throw new W(H.INVALID_ARGUMENT, '"projectId" not provided in firebase.initializeApp.');
    ...
    return Object.defineProperty(t.prototype, "app", {
         ...
         */
        get: function() {
            if (!this._app) throw new W(H.FAILED_PRECONDITION, "Firestore was not initialized using the Firebase SDK. 'app' is not available");
            return this._app;
        },
        enumerable: !1,
        configurable: !0
        ...
        if (this._settingsFrozen) throw new W(H.FAILED_PRECONDITION, "Firestore has already been started and its settings can no longer be changed. You can only modify settings before calling any other methods on a Firestore object.");
        this._settings = new sa(t), void 0 !== t.credentials && (this._credentials = function(t) {
            if (!t) return new X;
            switch (t.type) {
              case "gapi":
                var e = t.client;
              ...
              default:
                throw new W(H.INVALID_ARGUMENT, "makeCredentialsProvider failed due to invalid credential type");
            }
        }(t.credentials));
 ...
 */
        return t = this, (e = Zu.get(t)) && (q("ComponentProvider", "Removing Datastore"), 
        Zu.delete(t), e.terminate()), Promise.resolve();
        var t, e;
    }, t;
}();
 ...
 */ function aa(t, e, n, r) {
    ...
    t._setSettings(Object.assign(Object.assign({}, o), {
        ...
        var s, u;
        if ("string" == typeof r.mockUserToken) s = r.mockUserToken, u = O.MOCK_USER; else {
            ...
            if (!a) throw new W(H.INVALID_ARGUMENT, "mockUserToken must contain 'sub' or 'user_id' field!");
            u = new O(a);
        }
        t._credentials = new Z(new J(s, u));
    }
}
 ...
 */ var ca = /** @class */ function() {
    ...
    return Object.defineProperty(t.prototype, "_path", {
         ...
         */
        get: function() {
            return new fa(this.firestore, this.converter, this._key.path.popLast());
        },
        enumerable: !1,
        configurable: !0
    ...
    function n(t, n, r) {
        var i = this;
        return (i = e.call(this, t, n, ve(r)) || this)._path = r, 
        /** The type of this Firestore reference. */
        i.type = "collection", i;
    }
    return t(n, e), Object.defineProperty(n.prototype, "id", {
        ...
        get: function() {
            ...
            return t.isEmpty() ? null : new ca(this.firestore, 
 ...
 */ function la(t, n) {
    ...
    if (t = b(t), $u("collection", "path", n), t instanceof ua) {
        var o = pt.fromString.apply(pt, e([ n ], r));
        return na(o), new fa(t, /* converter= */ null, o);
    }
    if (!(t instanceof ca || t instanceof fa)) throw new W(H.INVALID_ARGUMENT, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
    var s = t._path.child(pt.fromString.apply(pt, e([ n ], r)));
    return na(s), new fa(t.firestore, 
    /* converter= */ null, s);
}
 ...
 */ function da(t, e) {
    if (t = ia(t, ua), $u("collectionGroup", "collection id", e), e.indexOf("/") >= 0) throw new W(H.INVALID_ARGUMENT, "Invalid collection ID '" + e + "' passed to function collectionGroup(). Collection IDs must not contain '/'.");
    return new ha(t, 
    /* converter= */ null, 
    /**
...
function pa(t, n) {
    ...
    // 'undefined' and 'null'.
    1 === arguments.length && (n = it.I()), $u("doc", "path", n), t instanceof ua) {
        var o = pt.fromString.apply(pt, e([ n ], r));
        return ea(o), new ca(t, 
        /* converter= */ null, new Ct(o));
    }
    if (!(t instanceof ca || t instanceof fa)) throw new W(H.INVALID_ARGUMENT, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
    var s = t._path.child(pt.fromString.apply(pt, e([ n ], r)));
    return ea(s), new ca(t.firestore, t instanceof fa ? t.converter : null, new Ct(s));
}
 ...
 * Firestore database.
 */ function ya(t, e) {
    return t = b(t), e = b(e), (t instanceof ca || t instanceof fa) && (e instanceof ca || e instanceof fa) && t.firestore === e.firestore && t.path === e.path && t.converter === e.converter
    /**
...
function va(t, e) {
    return t = b(t), e = b(e), t instanceof ha && e instanceof ha && t.firestore === e.firestore && Ne(t._query, e._query) && t.converter === e.converter
    /**
 * @license
 * Copyright 2020 Google LLC
 *
...
var ma = /** @class */ function() {
    function t() {
        ...
        this.ar = new Jo(this, "async_queue_retry" /* AsyncQueueRetry */), 
        // Visibility handler that triggers an immediate retry of all retryable
        // operations. Meant to speed up recovery when we regain file system access
        // after page comes into foreground.
        this.Rc = function() {
            var e = Wo();
            e && q("AsyncQueue", "Visibility state changed to " + e.visibilityState), t.ar.tr();
        };
        var e = Wo();
    ...
    t.prototype.enqueueAndForget = function(t) {
        ...
        return this.Pc((function() {
            return e.gc && e.Ic ? Promise.resolve() : (t().then(n.resolve, n.reject), n.promise);
        })).then((function() {
            return n.promise;
        }));
    ...
    t.prototype.vc = function() {
        return n(this, void 0, void 0, (function() {
            ...
            return r(this, (function(n) {
                switch (n.label) {
                  ...
                  case 2:
                    return n.sent(), this.mc.shift(), this.ar.reset(), [ 3 /*break*/ , 4 ];
        ...
        var e = this, n = this._c.then((function() {
            return e.Ec = !0, t().catch((function(t) {
                e.Tc = t, e.Ec = !1;
                var n = 
                /**
 ...
 */
     ...
     */
    t.prototype.Dc = function(t) {
        for (var e = 0, n = this.yc; e < n.length; e++) {
    ...
    t.prototype.Cc = function(t) {
        ...
        // Note that draining may generate more delayed ops, so we do that first.
            ...
            e.yc.sort((function(t, e) {
                return t.targetTimeMs - e.targetTimeMs;
            }));
            for (var n = 0, r = e.yc; n < r.length; n++) {
                var i = r[n];
...
var wa = /** @class */ function() {
    ...
    function n(t, n) {
        ...
        /**
             ...
             */
        return (r = e.call(this, t, n) || this).type = "firestore", r._queue = new ma, r._persistenceKey = "name" in t ? t.name : "[DEFAULT]", 
        r;
    }
    return t(n, e), n.prototype._terminate = function() {
        ...
        Na(this), this._firestoreClient.terminate();
    }, n;
}(ua);
...
function Ta(t, e) {
    ...
    if (n.isInitialized()) {
        ...
        if (T(i, e)) return r;
        throw new W(H.FAILED_PRECONDITION, "initializeFirestore() has already been called with different options. To avoid this error, call initializeFirestore() with the same options as when it was originally called, or call getFirestore() to return the already initialized instance.");
    }
    if (void 0 !== e.cacheSizeBytes && -1 !== e.cacheSizeBytes && e.cacheSizeBytes < 1048576) throw new W(H.INVALID_ARGUMENT, "cacheSizeBytes must be at least 1048576");
    return n.initialize({
        options: e
    });
}
 ...
 * @internal
 */ function Sa(t) {
    return t._firestoreClient || Na(t), t._firestoreClient.verifyNotTerminated(), t._firestoreClient;
}

function Na(t) {
    var e, n = t._freezeSettings(), r = function(t, e, n, r) {
        return new Ju(t, e, n, r.host, r.ssl, r.experimentalForceLongPolling, r.experimentalAutoDetectLongPolling, r.useFetchStreams);
 ...
 */ function _a(t, e) {
    Fa(t = ia(t, Ia));
    var n = Sa(t), r = t._freezeSettings(), i = new Lu;
    return Aa(n, i, new Cu(i, r.cacheSizeBytes, null == e ? void 0 : e.forceOwnership));
}
 ...
 */ function Da(t) {
    Fa(t = ia(t, Ia));
    var e = Sa(t), n = t._freezeSettings(), r = new Lu;
    return Aa(e, r, new xu(r, n.cacheSizeBytes));
}
    ...
    return t.asyncQueue.enqueue((function() {
        return n(o, void 0, void 0, (function() {
            ...
            return r(this, (function(r) {
                switch (r.label) {
                  case 0:
                    return r.trys.push([ 0, 3, , 4 ]), [ 4 /*yield*/ , qu(t, i) ];

                  case 1:
                    return r.sent(), [ 4 /*yield*/ , Uu(t, e) ];
...
function ka(t) {
    var e = this;
    if (t._initialized && !t._terminated) throw new W(H.FAILED_PRECONDITION, "Persistence can only be cleared before a Firestore instance is initialized or after it is terminated.");
    var i = new Y;
            ...
            return r(this, (function(o) {
                switch (o.label) {
                  case 0:
                    ...
                    }(to(t._databaseId, t._persistenceKey)) ];
 ...
 */ function xa(t) {
    ...
    /** Disables the network connection. Pending operations will not complete. */ (Sa(t = ia(t, Ia)));
}
...
function Oa(t, e) {
    var i = Sa(t = ia(t, Ia)), o = new wa;
    return function(t, e, i, o) {
        var s = this, u = function(t, e) {
            return function(t, e) {
                return new Pu(t, e);
            }(function(t, e) {
                if (t instanceof Uint8Array) return Ru(t, e);
                if (t instanceof ArrayBuffer) return Ru(new Uint8Array(t), e);
...
function Pa(t, e) {
    ...
    }(Sa(t = ia(t, Ia)), e).then((function(e) {
        return e ? new ha(t, null, e.query) : null;
    }));
}

function Fa(t) {
    if (t._initialized || t._terminated) throw new W(H.FAILED_PRECONDITION, "Firestore has already been started and persistence can no longer be enabled. You can only enable persistence before calling any other methods on a Firestore object.");
}
 ...
 */ var Ma = /** @class */ function() {
    ...
    function t() {
        for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
        for (var n = 0; n < t.length; ++n) if (0 === t[n].length) throw new W(H.INVALID_ARGUMENT, "Invalid field name at argument $(i + 1). Field names must not be empty.");
        this._internalPath = new vt(t);
    }
    /**
 ...
 */ var qa = /** @class */ function() {
     ...
     */    return t.fromBase64String = function(e) {
        try {
            return new t(wt.fromBase64String(e));
        } catch (e) {
            throw new W(H.INVALID_ARGUMENT, "Failed to construct data from Base64 string: " + e);
        }
    }, 
    /**
     ...
     */
    t.fromUint8Array = function(e) {
        return new t(wt.fromUint8Array(e));
    }, 
    /**
...
function(t) {
     ...
     */
    function t(t, e) {
        if (!isFinite(t) || t < -90 || t > 90) throw new W(H.INVALID_ARGUMENT, "Latitude must be a number between -90 and 90, but was: " + t);
        if (!isFinite(e) || e < -180 || e > 180) throw new W(H.INVALID_ARGUMENT, "Longitude must be a number between -180 and 180, but was: " + e);
...
}(), ja = /^__.*__$/, Ka = /** @class */ function() {
    function t(t, e, n) {
        this.data = t, this.fieldMask = e, this.fieldTransforms = n;
    }
    return t.prototype.toMutation = function(t, e) {
        return null !== this.fieldMask ? new rn(t, this.data, this.fieldMask, e, this.fieldTransforms) : new nn(t, this.data, e, this.fieldTransforms);
    }, t;
}(), za = /** @class */ function() {
    function t(t, 
...
/** A "context" object passed around while parsing user data. */ var Qa = /** @class */ function() {
    /**
    ...
    /** Returns a new context with the specified settings overwritten. */ t.prototype.$c = function(e) {
        ...
        var e, n = null === (e = this.path) || void 0 === e ? void 0 : e.child(t), r = this.$c({
            path: n,
            Fc: !1
        });
        return r.Mc(t), r;
        ...
        return lc(t, this.settings.methodName, this.settings.qc || !1, this.path, this.settings.Kc);
    }, 
    /** Returns 'true' if 'fieldPath' was traversed when creating this context. */ t.prototype.contains = function(t) {
        ...
        // within arrays.
        if (this.path) for (var t = 0; t < this.path.length; t++) this.Mc(this.path.get(t));
    }, t.prototype.Mc = function(t) {
        if (0 === t.length) throw this.Uc("Document fields must not be empty");
        if (Ga(this.kc) && ja.test(t)) throw this.Uc('Document fields cannot begin and end with "__"');
    }, t;
}(), Ha = /** @class */ function() {
    function t(t, e, n) {
    ...
    return t.prototype.jc = function(t, e, n, r) {
        return void 0 === r && (r = !1), new Qa({
            kc: t,
            methodName: e,
            Kc: n,
            path: vt.emptyPath(),
 ...
 * classes.
 */ function Wa(t) {
    var e = t._freezeSettings(), n = Yo(t._databaseId);
    return new Ha(t._databaseId, !!e.ignoreUndefinedProperties, n);
}

/** Parse document data from a set() call. */ function Ya(t, e, n, r, i, o) {
    void 0 === o && (o = {});
    var s = t.jc(o.merge || o.mergeFields ? 2 /* MergeSet */ : 0 /* Set */ , e, n, i);
    ac("Data must be an object, but it was:", s, r);
    var u, a, c = sc(r, s);
    if (o.merge) u = new mt(s.fieldMask), a = s.fieldTransforms; else if (o.mergeFields) {
        for (var h = [], f = 0, l = o.mergeFields; f < l.length; f++) {
            var d = cc(e, l[f], n);
            if (!s.contains(d)) throw new W(H.INVALID_ARGUMENT, "Field '" + d + "' is specified in your field mask but missing from your input data.");
            dc(h, d) || h.push(d);
        }
        u = new mt(h), a = s.fieldTransforms.filter((function(t) {
            return u.covers(t.field);
        }));
    } else u = null, a = s.fieldTransforms;
    return new Ka(new Gt(c), u, a);
}

var Ja = /** @class */ function(e) {
    function n() {
        return null !== e && e.apply(this, arguments) || this;
    }
...
}(Ua), ec = /** @class */ function(e) {
    function n(t, n) {
        var r = this;
        return (r = e.call(this, t) || this).Wc = n, r;
    }
    return t(n, e), n.prototype._toFieldTransform = function(t) {
        var e = new Ke(t.N, Re(t.N, this.Wc));
...
/** Parse update data from an update() call. */ function nc(t, e, n, r) {
    var i = t.jc(1 /* Update */ , e, n);
    ac("Data must be an object, but it was:", i, r);
    var o = [], s = Gt.empty();
    ft(r, (function(t, r) {
        var u = fc(e, t, n);
...
/** Parse update data from a list of field/value arguments. */ function rc(t, e, n, r, i, o) {
    ...
    for (var c = 0; c < o.length; c += 2) u.push(cc(e, o[c])), a.push(o[c + 1]);
    // We iterate in reverse order to pick the last value for a field if the
    // user specified the field multiple times.
    for (var h = [], f = Gt.empty(), l = u.length - 1; l >= 0; --l) if (!dc(h, u[l])) {
        var d = u[l], p = a[l];
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
        p = b(p);
    ...
    var m = new mt(h);
    return new za(f, m, s.fieldTransforms);
}
 ...
 */ function ic(t, e, n, r) {
    return void 0 === r && (r = !1), oc(n, t.jc(r ? 4 /* ArrayArgument */ : 3 /* Argument */ , e));
}
 ...
 */ function oc(t, e) {
    ...
    // from firestore-exp.
    t = b(t))) return ac("Unsupported field value:", e, t), sc(t, e);
    if (t instanceof Ua) 
    ...
    return function(t, e) {
        ...
        if (!Ga(e.kc)) throw e.Uc(t._methodName + "() can only be used with update() and set()");
    ...
    return function(t, e) {
        ...
        if ("number" == typeof t) return Re(e.N, t);
        ...
        if (t instanceof ca) {
            ...
            if (!o.isEqual(i)) throw e.Uc("Document reference is for database " + o.projectId + "/" + o.database + " but should be for database " + i.projectId + "/" + i.database);
            return {
                referenceValue: Qn(t.firestore._databaseId || e.databaseId, t._key.path)
            };
        }
        throw e.Uc("Unsupported field value: " + ra(t));
    }(t, e);
}
...
function uc(t) {
    return !("object" != typeof t || null === t || t instanceof Array || t instanceof Date || t instanceof at || t instanceof Ba || t instanceof qa || t instanceof ca || t instanceof Ua);
}
 ...
 */ function cc(t, e, n) {
    ...
    // FieldPath.
    (e = b(e)) instanceof Ma) return e._internalPath;
    if ("string" == typeof e) return fc(t, e);
    throw lc("Field path arguments must be of type string or FieldPath.", t, 
    /* hasConverter= */ !1, 
    /* path= */ void 0, n);
}
 ...
 * evaluated.
 */ function fc(t, n, r) {
    if (n.search(hc) >= 0) throw lc("Invalid field path (" + n + "). Paths must not contain '~', '*', '/', '[', or ']'", t, 
    /* hasConverter= */ !1, 
    /* path= */ void 0, r);
    try {
        return (new (Ma.bind.apply(Ma, e([ void 0 ], n.split(".")))))._internalPath;
    } catch (e) {
        throw lc("Invalid field path (" + n + "). Paths must not be empty, begin with '.', end with '.', or contain '..'", t, 
        /* hasConverter= */ !1, 
        /* path= */ void 0, r);
    }
}
...
function lc(t, e, n, r, i) {
    ...
    a += ")"), new W(H.INVALID_ARGUMENT, (u += ". ") + t + a)
 ...
 */ var pc = /** @class */ function() {
    ...
    return Object.defineProperty(t.prototype, "id", {
         ...
         */
        get: function() {
            return new ca(this._firestore, this._converter, this._key);
        },
        enumerable: !1,
        configurable: !0
    }), 
    ...
    t.prototype.data = function() {
        if (this._document) {
            if (this._converter) {
                ...
                var t = new yc(this._firestore, this._userDataWriter, this._key, this._document, 
                /* converter= */ null);
    ...
    t.prototype.get = function(t) {
        if (this._document) {
            var e = this._document.data.field(vc("DocumentSnapshot.get", t));
 ...
 */
function vc(t, e) {
    return "string" == typeof e ? fc(t, e) : e instanceof Ma ? e._internalPath : e._delegate._internalPath;
}
 ...
 */ var mc = /** @class */ function() {
    ...
    n.prototype.data = function(t) {
        if (void 0 === t && (t = {}), this._document) {
            if (this._converter) {
                // We only want to use the converter and create a new DocumentSnapshot
                // if a converter has been provided.
                var e = new wc(this._firestore, this._userDataWriter, this._key, this._document, this.metadata, 
                /* converter= */ null);
    ...
    n.prototype.get = function(t, e) {
        if (void 0 === e && (e = {}), this._document) {
            var n = this._document.data.field(vc("DocumentSnapshot.get", t));
            if (null !== n) return this._userDataWriter.convertValue(n, e.serverTimestamps);
        }
    }, n;
}(pc), wc = /** @class */ function(e) {
    function n() {
        return null !== e && e.apply(this, arguments) || this;
    }
    /**
    ...
    /** @hideconstructor */
    function t(t, e, n, r) {
        this._firestore = t, this._userDataWriter = e, this._snapshot = r, this.metadata = new mc(r.hasPendingWrites, r.fromCache), 
        this.query = n;
    }
    ...
    t.prototype.forEach = function(t, e) {
        ...
        this._snapshot.docs.forEach((function(r) {
            t.call(e, new wc(n._firestore, n._userDataWriter, r.key, r, new mc(n._snapshot.mutatedKeys.has(r.key), n._snapshot.fromCache), n.query.converter));
        }));
    }, 
    /**
    ...
    t.prototype.docChanges = function(t) {
        ...
        if (e && this._snapshot.excludesMetadataChanges) throw new W(H.INVALID_ARGUMENT, "To include metadata changes with your document changes, you must also pass { includeMetadataChanges:true } to onSnapshot().");
        ...
        function(t, e) {
            if (t._snapshot.oldDocs.isEmpty()) {
                ...
                return t._snapshot.docChanges.map((function(e) {
                    return {
                        type: "added",
                        doc: new wc(t._firestore, t._userDataWriter, e.doc.key, e.doc, new mc(t._snapshot.mutatedKeys.has(e.doc.key), t._snapshot.fromCache), t.query.converter),
                        oldIndex: -1,
                        newIndex: n++
                    };
                }));
            ...
            return t._snapshot.docChanges.filter((function(t) {
                ...
                var n = new wc(t._firestore, t._userDataWriter, e.doc.key, e.doc, new mc(t._snapshot.mutatedKeys.has(e.doc.key), t._snapshot.fromCache), t.query.converter), i = -1, o = -1;
 ...
 */ function Tc(t, e) {
    return t instanceof gc && e instanceof gc ? t._firestore === e._firestore && t._key.isEqual(e._key) && (null === t._document ? null === e._document : t._document.isEqual(e._document)) && t._converter === e._converter : t instanceof bc && e instanceof bc && t._firestore === e._firestore && va(t.query, e.query) && t.metadata.isEqual(e.metadata) && t._snapshot.isEqual(e._snapshot);
}
 ...
 * limitations under the License.
 */ function Ec(t) {
    if (ge(t) && 0 === t.explicitOrderBy.length) throw new W(H.UNIMPLEMENTED, "limitToLast() queries require specifying at least one orderBy() clause");
}
...
var _c = /** @class */ function(e) {
    function n(t, n, r) {
        var i = this;
        return (i = e.call(this) || this).Gc = t, i.zc = n, i.Hc = r, i.type = "where", 
        i;
    }
    return t(n, e), n.prototype._apply = function(t) {
        var e = Wa(t.firestore), n = function(t, e, n, r, i, o, s) {
            var u;
            if (i.isKeyField()) {
                if ("array-contains" /* ARRAY_CONTAINS */ === o || "array-contains-any" /* ARRAY_CONTAINS_ANY */ === o) throw new W(H.INVALID_ARGUMENT, "Invalid Query. You can't perform '" + o + "' queries on FieldPath.documentId().");
 ...
 */
        ...
        }(t._query, 0, e, t.firestore._databaseId, this.Gc, this.zc, this.Hc);
        return new ha(t.firestore, t.converter, function(t, e) {
...
var Ac = /** @class */ function(e) {
    function n(t, n) {
        var r = this;
        return (r = e.call(this) || this).Gc = t, r.Jc = n, r.type = "orderBy", r;
    }
    return t(n, e), n.prototype._apply = function(t) {
        var e = function(t, e, n) {
            if (null !== t.startAt) throw new W(H.INVALID_ARGUMENT, "Invalid query. You must not call startAt() or startAfter() before calling orderBy().");
            if (null !== t.endAt) throw new W(H.INVALID_ARGUMENT, "Invalid query. You must not call endAt() or endBefore() before calling orderBy().");
            var r = new he(e, n);
            return function(t, e) {
                if (null === we(t)) {
...
var Cc = /** @class */ function(e) {
    ...
    return t(n, e), n.prototype._apply = function(t) {
        return new ha(t.firestore, t.converter, Se(t._query, this.Yc, this.Xc));
    }, n;
}(Sc);
 ...
 * @returns The created {@link Query}.
 */ function xc(t) {
    return oa("limit", t), new Cc("limit", t, "F" /* First */)
    /**
...
function Lc(t) {
    return oa("limitToLast", t), new Cc("limitToLast", t, "L" /* Last */);
}

var Rc = /** @class */ function(e) {
    function n(t, n, r) {
        var i = this;
        return (i = e.call(this) || this).type = t, i.Zc = n, i.ta = r, i;
    }
    return t(n, e), n.prototype._apply = function(t) {
        var e = qc(t, this.type, this.Zc, this.ta);
        return new ha(t.firestore, t.converter, function(t, e) {
...
function Mc() {
    for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
    return new Fc("endBefore", t, /*before=*/ !0);
}

function Vc() {
    for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
    return new Fc("endAt", t, /*before=*/ !1);
}

/** Helper function to create a bound from a document or fields */ function qc(t, e, n, r) {
    if (n[0] = b(n[0]), n[0] instanceof pc) return function(t, e, n, r, i) {
        if (!r) throw new W(H.NOT_FOUND, "Can't use a DocumentSnapshot that doesn't exist for " + n + "().");
        ...
        for (var o = [], s = 0, u = Te(t); s < u.length; s++) {
            ...
            if (a.field.isKeyField()) o.push(Vt(e, r.key)); else {
                ...
                if (St(c)) throw new W(H.INVALID_ARGUMENT, 'Invalid query. You are trying to start or end a query using a document for which the field "' + a.field + '" is an uncommitted server timestamp. (Since the value of this field is unknown, you cannot start/end a query with it.)');
                if (null === c) {
                    var h = a.field.canonicalString();
                    throw new W(H.INVALID_ARGUMENT, "Invalid query. You are trying to start or end a query using a document for which the field '" + h + "' (used as the orderBy) does not exist.");
                }
                o.push(c);
            }
        }
    ...
    return function(t, e, n, r, i, o) {
        ...
        if (i.length > s.length) throw new W(H.INVALID_ARGUMENT, "Too many arguments provided to " + r + "(). The number of arguments must be less than or equal to the number of orderBy() clauses");
        for (var u = [], a = 0; a < i.length; a++) {
            var c = i[a];
            if (s[a].field.isKeyField()) {
                if ("string" != typeof c) throw new W(H.INVALID_ARGUMENT, "Invalid query. Expected a string for document ID in " + r + "(), but got a " + typeof c);
                if (!Ie(t) && -1 !== c.indexOf("/")) throw new W(H.INVALID_ARGUMENT, "Invalid query. When querying a collection and ordering by FieldPath.documentId(), the value passed to " + r + "() must be a plain document ID, but '" + c + "' contains a slash.");
                var h = t.path.child(pt.fromString(c));
                if (!Ct.isDocumentKey(h)) throw new W(H.INVALID_ARGUMENT, "Invalid query. When querying a collection group and ordering by FieldPath.documentId(), the value passed to " + r + "() must result in a valid document path, but '" + h + "' is not because it contains an odd number of segments.");
                var f = new Ct(h);
                u.push(Vt(e, f));
            } else {
                var l = ic(n, r, c);
...
function Uc(t, e, n) {
    if ("string" == typeof (n = b(n))) {
        if ("" === n) throw new W(H.INVALID_ARGUMENT, "Invalid query. When querying with FieldPath.documentId(), you must provide a valid document ID, but it was an empty string.");
        if (!Ie(e) && -1 !== n.indexOf("/")) throw new W(H.INVALID_ARGUMENT, "Invalid query. When querying a collection by FieldPath.documentId(), you must provide a plain document ID, but '" + n + "' contains a '/' character.");
        var r = e.path.child(pt.fromString(n));
        if (!Ct.isDocumentKey(r)) throw new W(H.INVALID_ARGUMENT, "Invalid query. When querying a collection group by FieldPath.documentId(), the value provided must result in a valid document path, but '" + r + "' is not because it has an odd number of segments (" + r.length + ").");
        return Vt(t, new Ct(r));
    }
    if (n instanceof ca) return Vt(t, n._key);
    throw new W(H.INVALID_ARGUMENT, "Invalid query. When querying with FieldPath.documentId(), you must provide a valid string or a DocumentReference, but it was: " + ra(n) + ".");
}
 ...
 * array requirements.
 */ function Bc(t, e) {
    if (!Array.isArray(t) || 0 === t.length) throw new W(H.INVALID_ARGUMENT, "Invalid Query. A non-empty array is required for '" + e.toString() + "' filters.");
 ...
 */ var Kc = /** @class */ function() {
    ...
    return t.prototype.convertValue = function(t, e) {
        ...
        var n = this, r = {};
        return ft(t.fields, (function(t, i) {
            r[t] = n.convertValue(i, e);
        })), r;
    }, t.prototype.convertGeoPoint = function(t) {
        return new Ba(Tt(t.latitude), Tt(t.longitude));
        ...
        switch (e) {
          ...
          case "estimate":
            return this.convertTimestamp(_t(t));
        ...
        z(mr(n));
        var r = new Xu(n.get(1), n.get(3)), i = new Ct(n.popFirst(5));
        return r.isEqual(e) || 
...
var Gc = /** @class */ function(e) {
    ...
    return t(n, e), n.prototype.convertBytes = function(t) {
        ...
        return new ca(this.firestore, /* converter= */ null, e);
    }, n;
    ...
    return t.prototype.set = function(t, e, n) {
        ...
        var r = Hc(t, this._firestore), i = zc(r.converter, e, n), o = Ya(this._dataReader, "WriteBatch.set", r._key, i, null !== r.converter, n);
        ...
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
                return o = "string" == typeof (e = b(e)) || e instanceof Ma ? rc(this._dataReader, "WriteBatch.update", s._key, e, n, r) : nc(this._dataReader, "WriteBatch.update", s._key, e), 
        this._mutations.push(o.toMutation(s._key, We.exists(!0))), this;
    }, 
    /**
    ...
    t.prototype.delete = function(t) {
        ...
        return this._mutations = this._mutations.concat(new hn(e._key, We.none())), this;
    }, 
    /**
    ...
    t.prototype.commit = function() {
        ...
        if (this._committed) throw new W(H.FAILED_PRECONDITION, "A write batch can no longer be used after commit() has been called.");
    }, t;
}();
 ...
 * called.
 */ function Hc(t, e) {
    if ((t = b(t)).firestore !== e) throw new W(H.INVALID_ARGUMENT, "Provided document reference is from a different Firestore instance.");
    return t;
}
 ...
 */ function Wc(t) {
    t = ia(t, ca);
    var e = ia(t.firestore, Ia);
    return Wu(Sa(e), t._key).then((function(n) {
        return ah(e, t, n);
    }));
}

var Yc = /** @class */ function(e) {
    function n(t) {
        var n = this;
        return (n = e.call(this) || this).firestore = t, n;
    }
 ...
 */ function Jc(t) {
    t = ia(t, ca);
    var e = ia(t.firestore, Ia), i = Sa(e), o = new Yc(e);
    return function(t, e) {
        var i = this, o = new Y;
        return t.asyncQueue.enqueueAndForget((function() {
            return n(i, void 0, void 0, (function() {
                            ...
                            return n(this, void 0, void 0, (function() {
                                ...
                                return r(this, (function(r) {
                                    switch (r.label) {
                                      ...
                                      case 1:
                                        return (n = r.sent()).isFoundDocument() ? i.resolve(n) : n.isNoDocument() ? i.resolve(null) : i.reject(new W(H.UNAVAILABLE, "Failed to get document from cache. (However, this document may exist on the server. Run again without setting 'source' in the GetOptions to attempt to retrieve the document from the server.)")), 
                                        [ 3 /*break*/ , 3 ];

                                      case 2:
                                        return o = r.sent(), s = ks(o, "Failed to get document '" + e + " from cache"), 
        ...
        return new gc(e, o, t._key, n, new mc(null !== n && n.hasLocalMutations, 
 ...
 */ function Zc(t) {
    t = ia(t, ha);
    var e = ia(t.firestore, Ia), n = Sa(e), r = new Yc(e);
    return Ec(t._query), Yu(n, t._query).then((function(n) {
        return new bc(e, r, t, n);
    }))
    /**
                        ...
                        return i = function(t, e, i) {
                            return n(this, void 0, void 0, (function() {
                                ...
                                return r(this, (function(r) {
                                    switch (r.label) {
                                      case 0:
                                        return r.trys.push([ 0, 2, , 3 ]), [ 4 /*yield*/ , vo(t, e, 
                                        /* usePreviousResults= */ !0) ];

                                      case 1:
                                        return n = r.sent(), o = new Hs(e, n.Gn), s = o.bo(n.documents), u = o.applyChanges(s, 
                                        /* updateLimboDocuments= */ !1), i.resolve(u.snapshot), [ 3 /*break*/ , 3 ];

                                      case 2:
                                        return a = r.sent(), c = ks(a, "Failed to execute query '" + e + " against cache"), 
...
function eh(t, e, n) {
    t = ia(t, ca);
    var r = ia(t.firestore, Ia), i = zc(t.converter, e, n);
    return uh(r, [ Ya(Wa(r), "setDoc", t._key, i, null !== t.converter, n).toMutation(t._key, We.none()) ]);
}

function nh(t, e, n) {
    for (var r = [], i = 3; i < arguments.length; i++) r[i - 3] = arguments[i];
    t = ia(t, ca);
    var o = ia(t.firestore, Ia), s = Wa(o);
    return uh(o, [ ("string" == typeof (
    // For Compat types, we have to "extract" the underlying types before
    // performing validation.
    e = b(e)) || e instanceof Ma ? rc(s, "updateDoc", t._key, e, n, r) : nc(s, "updateDoc", t._key, e)).toMutation(t._key, We.exists(!0)) ]);
}
 ...
 */ function rh(t) {
    return uh(ia(t.firestore, Ia), [ new hn(t._key, We.none()) ]);
}
 ...
 */ function ih(t, e) {
    var n = ia(t.firestore, Ia), r = pa(t), i = zc(t.converter, e);
    return uh(n, [ Ya(Wa(t.firestore), "addDoc", r._key, i, null !== t.converter, {}).toMutation(r._key, We.exists(!1)) ]).then((function() {
        return r;
    }));
}
...
function oh(t) {
    ...
    "object" != typeof s[c] || ga(s[c]) || (a = s[c], c++);
    var h, f, l, d = {
    ...
    if (t instanceof ca) f = ia(t.firestore, Ia), l = ve(t._key.path), h = {
        next: function(e) {
            s[c] && s[c](ah(f, t, e));
        },
        error: s[c + 1],
        ...
        var y = ia(t, ha);
        f = ia(y.firestore, Ia), l = y._query;
        var v = new Yc(f);
        h = {
            next: function(t) {
                s[c] && s[c](new bc(f, v, y, t));
            },
            error: s[c + 1],
            complete: s[c + 2]
        }, Ec(t._query);
    ...
    return function(t, e, i, o) {
        var s = this, u = new Ou(o), a = new Us(e, u, i);
        return t.asyncQueue.enqueueAndForget((function() {
            return n(s, void 0, void 0, (function() {
                var e;
                return r(this, (function(n) {
            ...
            u.ec(), t.asyncQueue.enqueueAndForget((function() {
                return n(s, void 0, void 0, (function() {
                    var e;
                    return r(this, (function(n) {
                        switch (n.label) {
                          case 0:
                            return e = Fs, [ 4 /*yield*/ , Hu(t) ];
...
function sh(t, e) {
    return function(t, e) {
        ...
        return t.asyncQueue.enqueueAndForget((function() {
            ...
            o.ec(), t.asyncQueue.enqueueAndForget((function() {
                return n(i, void 0, void 0, (function() {
                    var e;
                    return r(this, (function(n) {
                        switch (n.label) {
 ...
 */ function ah(t, e, n) {
    var r = n.docs.get(e._key), i = new Yc(t);
    return new gc(t, i, e._key, r, new mc(n.hasPendingWrites, n.fromCache), e.converter);
}
 ...
 */ var ch, hh = /** @class */ function(e) {
     ...
     */    return t(n, e), n.prototype.get = function(t) {
        var n = this, r = Hc(t, this._firestore), i = new Yc(this._firestore);
        return e.prototype.get.call(this, t).then((function(t) {
            return new gc(n._firestore, i, r._key, t._document, new mc(
            /* hasPendingWrites= */ !1, 
    ...
    return t.prototype.get = function(t) {
        ...
        var r = Hc(t, this._firestore), i = zc(r.converter, e, n), o = Ya(this._dataReader, "Transaction.set", r._key, i, null !== r.converter, n);
        ...
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
                return o = "string" == typeof (e = b(e)) || e instanceof Ma ? rc(this._dataReader, "Transaction.update", s._key, e, n, r) : nc(this._dataReader, "Transaction.update", s._key, e), 
 ...
 * writes.
 */ function mh(t) {
    return Sa(t = ia(t, Ia)), new Qc(t, (function(e) {
        return uh(t, e);
    }))
    /**
 * Cloud Firestore
...
void 0 === ch && (ch = !0), P = i, o(new c("firestore", (function(t, e) {
    var n = e.options, r = t.getProvider("app").getImmediate(), i = new Ia(r, new $(t.getProvider("auth-internal")));
    return n = Object.assign({
        useFetchStreams: ch
    }, n), i._setSettings(n), i;
}), "PUBLIC" /* PUBLIC */)), s(R, "3.3.0", void 0), 
